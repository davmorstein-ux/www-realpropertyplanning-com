...
const faqs = [
  ...
  },
  {
    ...
    answer:
      `Reach out directly — ${FEATURED_BROKER.Role} tracks Marysville and broader Snohomish County AFH inventory closely and can notify you as soon as a matching property comes to market.`,
  },
];
