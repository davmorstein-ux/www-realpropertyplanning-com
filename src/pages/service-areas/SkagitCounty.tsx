...
const SkagitCountyServiceArea = () => (
  <div className="min-h-screen bg-background">
    <SEOHead
      title="Probate, Estate & Senior Transition Real Estate in Skagit County, WA | Real Property Planning"
      description="Serving families, executors, and seniors throughout Skagit County — Mount Vernon, Burlington, Anacortes, Sedro-Woolley, La Conner, and surrounding areas. Probate sales, certified appraisals, and senior transitions."
      jsonLd={jsonLd}
    />
      ...
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h1 className="font-serif text-4xl md:text-5xl text-primary-foreground font-semibold leading-tight mb-6">
            Probate, Estate & Senior Transition Real Estate in Skagit County, Washington
          </h1>
          <p className="text-xl md:text-[22px] text-primary-foreground/80 leading-[1.75] mb-5">
            Real Property Planning serves families, executors, attorneys, and seniors throughout Skagit County with certified appraisals, probate real estate sales, and senior housing transition guidance.
          </p>
    ...
    <section className={`${sectionBase} bg-secondary`}>
      <div className={contentWrap}>
        <div className={proseWrap}>
          ...
          <p className={pClass}>Skagit County families managing inherited property or probate real estate need a professional who understands both Washington State probate law and the local Skagit Valley market.</p>
          <p className={pClass}>We provide certified appraisals and experienced real estate brokerage — giving families and attorneys a reliable single resource for the entire process.</p>
        </div>
      </div>
    </section>
    ...
    <section className={sectionBase}>
      <div className={contentWrap}>
        <div className={proseWrap}>
          ...
          <p className={pClass}>We provide Washington State certified residential appraisals throughout Skagit County for probate proceedings, estate settlements, trust administration, and senior transition planning.</p>
    ...
    <section className={sectionBase}>
      <div className={contentWrap}>
        <div className={proseWrap}>
          <h2 className={h2Class}>Serving Executors and Attorneys in Skagit County</h2>
          <p className={pClass}>We work with probate and elder law attorneys throughout Skagit County, providing certified appraisal reports and real estate expertise that legal proceedings require.</p>
          <p className={pClass}>Professional, reliable, and easy to work with.</p>
        </div>
      </div>
    </section>
