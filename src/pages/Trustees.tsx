      ...
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <div className="flex justify-center mb-1.5 md:mb-2">
            <img src={iconTrustees} alt="Real estate guidance for trustees managing trust property in Washington State" className="block w-full max-w-[15rem] h-auto object-contain"  loading="lazy" sizes="100vw" decoding="async"/>
          </div>
