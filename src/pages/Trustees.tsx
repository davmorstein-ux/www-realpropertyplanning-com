      ...
      <section className="bg-primary pt-16 pb-14 md:pt-[84px] md:pb-[72px] lg:pt-[112px] lg:pb-24">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl" id="trustees-hero-section">
            ...
            <p className="text-lg md:text-xl text-primary-foreground leading-relaxed mb-4 motion-safe:animate-[text-emphasis-a_18s_ease-in-out_infinite]" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.25)' }}>
            ...
            <p className="text-lg md:text-xl text-primary-foreground leading-relaxed mb-8 motion-safe:animate-[text-emphasis-b_18s_ease-in-out_infinite]" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.25)' }}>
