...
<div class="clipboard2">
  ...
  <button style="width:100%;padding:16px;border-radius:8px;background:#ffffff;color:#004d1a;border:2px solid #004d1a;font-size:18px;font-weight:700;letter-spacing:.2em;text-transform:uppercase;cursor:pointer;margin-top:4px;font-family:'Raleway',sans-serif;transition:background 0.2s,color 0.2s,border-color 0.2s" onmouseenter="this.style.background='#004d1a';this.style.color='#ffffff';this.style.borderColor='#ffffff'" onmouseleave="this.style.background='#ffffff';this.style.color='#004d1a';this.style.borderColor='#004d1a'" onclick="calcVal()">Calculate Estimated Value</button>
