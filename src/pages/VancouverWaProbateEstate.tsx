...
const faqs = [
  {
    ...
    answer:
      "Selling an inherited home in Vancouver requires confirming legal authority (through probate or trust administration), evaluating the property's condition, and developing a pricing and preparation strategy. David Stein coordinates the entire process — from initial assessment through closing — keeping all parties informed and the timeline on track.",
  },
  {
  ...
  {
    question: "Can David Stein help coordinate a sale alongside a senior transition or relocation?",
    answer:
      "Yes. Many Vancouver families are managing a property sale at the same time as a move to senior living, a relocation to be closer to family, or a transition between Washington and Oregon. David Stein coordinates the sale timeline with the broader transition — working with moving companies, family members, and other professionals to keep everything aligned.",
  },
  {
    question: "Should I prepare the home before selling?",
    answer:
      "It depends on the property's condition, your timeline, and the transition situation. David Stein evaluates which improvements are likely to increase the sale price enough to justify the cost and delay — and which aren't. When timing is tight due to a move or transition, David Stein helps prioritize what matters most.",
  },
  {
    question: "How long does it take to sell an estate property in Vancouver?",
    answer:
      "Timelines vary based on the probate or trust process, property condition, and market conditions. Once the property is ready and authority is established, well-priced Vancouver homes typically sell within a few weeks. David Stein helps set realistic expectations and coordinates the sale timeline with any broader transition plans.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <MidPageCTA
        ...
        body="David Stein provides confidential consultations for executors, trustees, and families managing inherited property, estate sales, or transition-related decisions in Vancouver and Clark County."
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">
              David Stein serves as a central point of coordination — managing property access, working with cleanout crews, contractors, moving companies, and other vendors, communicating with attorneys and family members, and keeping the timeline aligned with the broader transition.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed">
