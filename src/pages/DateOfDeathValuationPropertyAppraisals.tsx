            ...
            <div className="max-w-6xl mx-auto" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px" }}>
              {pathways.map((p) => (
                <Link
                  key={p.letter}
                  to={p.href}
                  className="marquee-hover group bg-white border-2 border-gold/25 rounded-2xl p-6 shadow-[0_6px_18px_-10px_rgba(27,43,75,0.2)] hover:border-gold/55 hover:-translate-y-1 hover:shadow-[0_4px_12px_-4px_rgba(27,43,75,0.14)] transition-all flex flex-col items-center justify-center text-center"
                >
