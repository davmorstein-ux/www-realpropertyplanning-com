...
const steps = [
  {
    ...
    details:
      "There is no cost or obligation for this initial discussion. The goal is to determine whether Real Property Planning is the right fit and to outline a practical path forward.",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    text: "When offers arrive, Real Property Planning reviews each one thoroughly — evaluating not just the price, but the terms, contingencies, financing strength, and closing timeline. The options are presented clearly, and Real Property Planning negotiates on your behalf to protect the estate's interests. In multi-offer situations, Real Property Planning helps you navigate competing bids with a strategy focused on certainty of closing and net proceeds.",
    details:
      "For probate and trust transactions, Real Property Planning pays particular attention to terms that affect fiduciary obligations — ensuring that the transaction structure supports the legal requirements of the sale.",
  },
  {
    number: "06",
    ...
    details:
      "Real Property Planning provides regular status updates so you always know where things stand. If complications arise — and in estate transactions, they sometimes do — they are addressed promptly, with solutions communicated rather than just problems.",
  },
  {
    number: "07",
    ...
    details:
      "Many clients return for help with additional properties, and many attorneys continue to refer clients based on the experience of working together on a previous matter.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "No. Many clients — especially executors and trustees — are managing property from out of state. Real Property Planning provides hands-on local coordination and keeps clients informed through regular updates so they can participate in decisions without needing to be physically present.",
  },
  {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main id="main-content">
        ...
        <section className="bg-primary pt-10 pb-14 md:pt-[56px] md:pb-[72px] lg:pt-[72px] lg:pb-[96px]">
          <div className="container px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              {/* WAS text-primary-foreground/80 — an 80% opacity on a navy
                background, which is the faded-text pattern being cleaned up
                site-wide. Full strength now. */}
              <p className="text-lg md:text-xl text-primary-foreground leading-relaxed">
                Real Property Planning follows a clear, seven-step process — from consultation through closing —
                designed for the unique complexity of estate, probate, and senior transition sales.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <Accordion type="single" collapsible className="space-y-3">
                {[
                  ...
                  {
                    value: "early",
                    q: "Why does Real Property Planning start earlier than most agents?",
        ...
        <MidPageCTA
          ...
          body="Whether you are an executor, attorney, trustee, or family member — Real Property Planning can walk you through the process and help you plan next steps."
          ...
          <div className="container px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-5 text-muted-foreground leading-relaxed">
                ...
                <p>
                  Real Property Planning understands these pressures from working through them with hundreds of clients,
                  helping{" "}
                ...
                <p>
                  ...
                  Silverdale in Kitsap County — face these same challenges. Real Property Planning's approach is the
                  same regardless of location: assess the property honestly, develop a preparation strategy based on
                  return on investment, price it correctly for its actual condition, and manage the sale with clear
          ...
          <div className="container px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-primary-foreground text-lg leading-relaxed mb-8">
                Whether you are an executor, trustee, attorney, or family member — Real Property Planning is available
                for a no-obligation conversation about your property and circumstances.
              </p>
