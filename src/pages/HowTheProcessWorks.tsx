...
const steps = [
  ...
  },
  {
    ...
    details: "Real Property Planning provides regular status updates so you always know where things stand. If complications arise — and in estate transactions, they sometimes do — they are addressed promptly, with solutions communicated rather than just problems.",
  },
  {
    number: "07",
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <Accordion type="single" collapsible className="space-y-3">
              {[
                ...
                { value: "early", q: "Why does Real Property Planning start earlier than most agents?", a: "Early planning prevents the most common and costly mistakes. Work often begins before the property is ready to list — assessing condition, coordinating with attorneys, and helping families align on strategy." },
                { value: "adapt", q: "How does the process adapt to each situation?", a: "Some clients need immediate sale guidance. Others need time, planning, family coordination, or valuation-related clarity. The process adapts — whether that means a compressed timeline for a court-ordered sale or a longer runway for family decision-making." },
              ].map((item) => (
        ...
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap gap-3">
              <Link to="/probate-estate-sales" className="text-accent hover:text-gold transition-colors underline underline-offset-4">Probate &amp; Estate Sales</Link>
              <span className="text-muted-foreground">·</span>
              <Link to="/executors" className="text-accent hover:text-gold transition-colors underline underline-offset-4">For Executors</Link>
              <span className="text-muted-foreground">·</span>
              <Link to="/for-attorneys" className="text-accent hover:text-gold transition-colors underline underline-offset-4">For Attorneys</Link>
              <span className="text-muted-foreground">·</span>
              <Link to="/why-valuation-matters" className="text-accent hover:text-gold transition-colors underline underline-offset-4">Why Valuation Matters</Link>
              <span className="text-muted-foreground">·</span>
              <Link to="/senior-transitions" className="text-accent hover:text-gold transition-colors underline underline-offset-4">Senior Transitions</Link>
              <span className="text-muted-foreground">·</span>
              <Link to="/faq" className="text-accent hover:text-gold transition-colors underline underline-offset-4">All FAQs</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-primary-foreground text-lg leading-relaxed mb-8">
              Whether you are an executor, trustee, attorney, or family member — Real Property Planning is available for a no-obligation conversation about your property and circumstances.
            </p>
