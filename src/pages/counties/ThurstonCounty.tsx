...
const ThurstonCounty = () => (
  <CountyPageTemplate
    ...
    whoIHelp="Our team works with executors managing estate property in Olympia and Lacey, trustees overseeing trust-owned homes in established Capitol-area neighborhoods, attorneys handling probate filings in Thurston County Superior Court, and retirees planning thoughtful transitions from longtime family residences. Many families in the South Sound region appreciate our team's measured, unhurried approach to property decisions."
    whyCredentialsMatter="Thurston County's mix of government housing, established neighborhoods, and rural acreage creates valuation challenges that benefit from our team's dual credentials. As a licensed broker and certified appraiser, he can assess properties based on actual condition and local buyer demand — not aspirational pricing that leads to months of unnecessary market time. For executors and trustees with fiduciary obligations, that discipline provides meaningful protection."
    marketOverview="Thurston County's real estate market balances affordability with quality of life, attracting retirees, government employees, and families seeking more space than the Puget Sound metro offers. Property types range from established Olympia neighborhoods near Capitol Lake to newer developments in Lacey and rural acreage around Yelm and Rainier. Estate properties often reflect decades of ownership — well-loved homes that may need updating or condition-based assessment to price accurately. Our team's appraisal discipline helps families set realistic expectations in a market where overpricing can mean months of unnecessary delay."
    localParagraph="Thurston County families often approach property transitions with care and deliberation. Whether it is a retiree downsizing from a longtime Olympia home, an executor managing a parent's property in Lacey, or a family coordinating from out of the area on inherited acreage near Tumwater, the process benefits from patience and local awareness. Our team's familiarity with Thurston County neighborhoods, buyer expectations, and seasonal market rhythms helps families move forward at a pace that feels right — without sacrificing outcome."
    clientTypes={[
