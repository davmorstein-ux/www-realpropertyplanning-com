    ...
    countySpecificFaqs={[
      {
        ...
        answer: `Retiree transitions in Olympia often involve emotional complexity, decades of accumulated belongings, and homes that reflect a lifetime of care but may need updating for today's buyers. ${FEATURED_BROKER.Role} approaches these situations with patience and sensitivity — helping families organize the process at a pace that feels manageable while ensuring the property is positioned to sell well when the time is right.`,
      },
      {
        question: "What should I expect when selling estate property through Thurston County probate court?",
        answer: `Thurston County probate sales require coordination between the personal representative, the estate attorney, and the court timeline. ${FEATURED_BROKER.Role} works within these structures, providing property assessments, pricing recommendations, and sale management that align with legal requirements. ${FEATURED_BROKER.pronoun.Subject} communicates clearly with all parties so there are no surprises as the process moves forward.`,
      },
      {
        question: "Is it worth investing in repairs before selling an inherited home in Lacey?",
        answer: `It depends on the property's condition and the local buyer expectations in Lacey. Some improvements — like fresh paint, carpet replacement, or addressing deferred maintenance — can improve the sale price meaningfully. Others may not justify the cost or delay. ${FEATURED_BROKER.Role}'s appraisal background helps ${FEATURED_BROKER.pronoun.object} evaluate which investments are likely to pay off in this specific market.`,
      },
      {
