...
const ThurstonCounty = () => (
  <CountyPageTemplate
    ...
    whoIHelp="David Stein works with executors managing estate property in Olympia and Lacey, trustees overseeing trust-owned homes in established Capitol-area neighborhoods, attorneys handling probate filings in Thurston County Superior Court, and retirees planning thoughtful transitions from longtime family residences. Many families in the South Sound region appreciate David Stein's measured, unhurried approach to property decisions."
