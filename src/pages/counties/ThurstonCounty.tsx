...
const ThurstonCounty = () => (
  <CountyPageTemplate
    ...
    whoIHelp="We work with executors managing estate property in Olympia and Lacey, trustees overseeing trust-owned homes in established Capitol-area neighborhoods, attorneys handling probate filings in Thurston County Superior Court, and retirees planning thoughtful transitions from longtime family residences. Many families in the South Sound region appreciate Our measured, unhurried approach to property decisions."
    whyCredentialsMatter="Thurston County's mix of government housing, established neighborhoods, and rural acreage creates valuation challenges that benefit from Real Property Planning's dual credentials. As a licensed broker and certified appraiser, Real Property Planning assesses properties based on actual condition and local buyer demand — not aspirational pricing that leads to months of unnecessary market time. For executors and trustees with fiduciary obligations, that discipline provides meaningful protection."
    marketOverview="Thurston County's real estate market balances affordability with quality of life, attracting retirees, government employees, and families seeking more space than the Puget Sound metro offers. Property types range from established Olympia neighborhoods near Capitol Lake to newer developments in Lacey and rural acreage around Yelm and Rainier. Estate properties often reflect decades of ownership — well-loved homes that may need updating or condition-based assessment to price accurately. Our appraisal discipline helps families set realistic expectations in a market where overpricing can mean months of unnecessary delay."
    localParagraph="Thurston County families often approach property transitions with care and deliberation. Whether it is a retiree downsizing from a longtime Olympia home, an executor managing a parent's property in Lacey, or a family coordinating from out of the area on inherited acreage near Tumwater, the process benefits from patience and local awareness. Our familiarity with Thurston County neighborhoods, buyer expectations, and seasonal market rhythms helps families move forward at a pace that feels right — without sacrificing outcome."
    clientTypes={[
    ...
    countySpecificFaqs={[
      ...
      },
      {
        ...
        answer: "Thurston County probate sales require coordination between the personal representative, the estate attorney, and the court timeline. We work within these structures, providing property assessments, pricing recommendations, and sale management that align with legal requirements. We communicate clearly with all parties so there are no surprises as the process moves forward.",
      },
      {
        question: "Is it worth investing in repairs before selling an inherited home in Lacey?",
        answer: "It depends on the property's condition and the local buyer expectations in Lacey. Some improvements — like fresh paint, carpet replacement, or addressing deferred maintenance — can improve the sale price meaningfully. Others may not justify the cost or delay. Our appraisal background helps us evaluate which investments are likely to pay off in this specific market.",
      },
      {
        question: "Can you get help with a rural property near Yelm or Rainier?",
        answer: "Yes. Rural and semi-rural properties in southern Thurston County present unique valuation considerations — acreage, well and septic systems, outbuildings, and access issues that suburban-focused agents may not be equipped to assess. Our certified appraiser credentials and experience with non-standard properties make us well-suited for these situations.",
      },
      {
