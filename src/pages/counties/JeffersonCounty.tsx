...
const JeffersonCounty = () => (
  <CountyPageTemplate
    ...
    closingCtaBody={[
      ...
      "We provide the locally informed guidance that Jefferson County's distinctive communities and property types require.",
    ]}
    countySpecificFaqs={[
      {
