...
const JeffersonCounty = () => (
  <CountyPageTemplate
    ...
    localExpertiseBody={[
      ...
      `For estate and inherited properties, this community diversity means that pricing and preparation strategy must be calibrated to the specific location — not to Jefferson County as a whole. A Port Townsend Victorian and a Sequim retirement rambler and a Quilcene acreage property require entirely different approaches. ${FEATURED_BROKER.name}'s appraisal background and Olympic Peninsula market knowledge ensure each property is evaluated on its own terms.`,
    ]}
    communitiesIntro={`${FEATURED_BROKER.name} serves families, executors, and professionals throughout Jefferson County, including:`}
    closingCtaBody={[
