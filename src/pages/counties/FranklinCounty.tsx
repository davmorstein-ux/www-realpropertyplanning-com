...
const FranklinCounty = () => (
  <CountyPageTemplate
    ...
    localParagraph="Estate work in Franklin County typically means coordinating preparation, vendor access, and a sale on behalf of family members who may not live nearby. David Stein handles that coordination directly — including for executors and heirs based on the West Side or out of state — so the property moves through preparation, listing, and closing without requiring repeated trips to the Tri-Cities."
    clientTypes={[
    ...
    countySpecificFaqs={[
      { question: "How does the Hanford employment base affect Pasco property values?", answer: "Hanford-related employment supports steady Tri-Cities demand, particularly in established Pasco neighborhoods within reasonable commute. David Stein factors that demand into pricing alongside the property's actual condition — neither overestimating it nor ignoring it." },
      { question: "Can David Stein handle a Franklin County sale from out of state?", answer: "Yes. He manages property access, preparation vendors, marketing, showings, and closing on behalf of out-of-state executors and heirs. Communication is structured so families stay informed without needing to travel to the Tri-Cities repeatedly." },
      { question: "What about rural Franklin County properties near Connell or Mesa?", answer: "Rural parcels with acreage, outbuildings, well and septic, or agricultural considerations need an appraiser's approach to valuation. David Stein's certified-appraisal background ensures these features are reflected in the price rather than ignored by residential algorithms." },
    ]}
