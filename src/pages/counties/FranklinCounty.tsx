...
const FranklinCounty = () => (
  <CountyPageTemplate
    ...
    whoIHelp="David works with executors managing inherited Pasco homes from out of state, trustees overseeing trust-owned property across Franklin County, attorneys handling probate matters in the Tri-Cities, and families weighing the realistic options for a parent's longtime home in the Columbia Basin."
    whyCredentialsMatter="Franklin County properties frequently include features automated valuation tools cannot read — acreage, outbuildings, agricultural adjacency, and condition variation that reflects decades of owner-completed work. David's certified-appraisal background allows him to evaluate these properties honestly and produce pricing that holds up for fiduciary purposes."
    ...
    localParagraph="Estate work in Franklin County typically means coordinating preparation, vendor access, and a sale on behalf of family members who may not live nearby. David handles that coordination directly — including for executors and heirs based on the West Side or out of state — so the property moves through preparation, listing, and closing without requiring repeated trips to the Tri-Cities."
    clientTypes={[
    ...
    countySpecificFaqs={[
      ...
      { question: "What about rural Franklin County properties near Connell or Mesa?", answer: "Rural parcels with acreage, outbuildings, well and septic, or agricultural considerations need an appraiser's approach to valuation. David's certified-appraisal background ensures these features are reflected in the price rather than ignored by residential algorithms." },
    ]}
    aeoQuestion="How are estate property sales handled in Franklin County?"
    aeoAnswer="Franklin County estate sales benefit from condition-based pricing, targeted preparation, and steady communication — especially when family is spread across multiple states. David Stein handles the on-the-ground coordination so executors and trustees can manage the estate without repeated travel to the Tri-Cities."
    aeoSupportBullets={[
