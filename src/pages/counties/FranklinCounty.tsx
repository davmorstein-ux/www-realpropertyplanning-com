...
const FranklinCounty = () => (
  <CountyPageTemplate
    ...
    countySpecificFaqs={[
      ...
      { question: "Can our team handle a Franklin County sale from out of state?", answer: "Yes. He manages property access, preparation vendors, marketing, showings, and closing on behalf of out-of-state executors and heirs. Communication is structured so families stay informed without needing to travel to the Tri-Cities repeatedly." },
