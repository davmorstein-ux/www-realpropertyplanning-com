...
const BentonCounty = () => (
  <CountyPageTemplate
    ...
    localInsight="Benton County anchors the southern end of the Tri-Cities region, where practical decision-making and realistic expectations define successful estate property sales. Families here often deal with inherited homes that have been in the family for decades, and the market rewards honest preparation and accurate pricing. Real Property Planning's dual credentials as a licensed broker and certified appraiser provide the grounded, condition-based approach that Benton County properties require."
    whoIHelp="David Stein works with executors managing inherited homes in Kennewick and Richland, trustees overseeing trust-owned property in West Richland and Prosser, attorneys handling Benton County probate cases, and families making practical decisions about a parent's longtime Tri-Cities home. Many of our clients here value straightforward communication and realistic expectations over aggressive sales tactics."
    whyCredentialsMatter="Benton County's moderate price points and wide range of property conditions make accurate, condition-based pricing essential for a timely sale. David Stein's dual credentials as a broker and certified appraiser allow him to evaluate deferred maintenance, functional updates, and neighborhood-specific demand patterns with a precision that protects executors and trustees from the financial consequences of mispricing in a practical, value-driven market."
    marketOverview="Benton County's real estate market is characterized by moderate price points, a wide range of property conditions, and buyer expectations shaped by practical value rather than speculative appreciation. Neighborhoods in Richland's established areas, newer Kennewick developments, and agricultural-adjacent properties near Prosser each attract different buyer pools with distinct priorities. Estate properties frequently need condition-based adjustments that automated tools miss entirely — deferred maintenance, outdated systems, and functional obsolescence that directly impact what buyers will pay. David Stein's appraisal discipline helps families set prices that reflect reality and attract qualified buyers without extended market time."
    localParagraph="Benton County families tend to approach property transitions with practical, grounded expectations. Whether it is a well-maintained Richland home near the Hanford corridor, an inherited property in Kennewick with years of deferred upkeep, or a family estate near Prosser with agricultural connections, these situations benefit from honest assessment and clear coordination. David Stein works with executors and families throughout Benton County, providing straightforward guidance on preparation, pricing, and timing — helping people move forward without unnecessary complexity."
    clientTypes={[
