...
const BentonCounty = () => (
  <CountyPageTemplate
    ...
    whoIHelp="We work with executors managing inherited homes in Kennewick and Richland, trustees overseeing trust-owned property in West Richland and Prosser, attorneys handling Benton County probate cases, and families making practical decisions about a parent's longtime Tri-Cities home. Many of our clients here value straightforward communication and realistic expectations over aggressive sales tactics."
    whyCredentialsMatter="Benton County's moderate price points and wide range of property conditions make accurate, condition-based pricing essential for a timely sale. Our dual credentials as a broker and certified appraiser allow us to evaluate deferred maintenance, functional updates, and neighborhood-specific demand patterns with a precision that protects executors and trustees from the financial consequences of mispricing in a practical, value-driven market."
    marketOverview="Benton County's real estate market is characterized by moderate price points, a wide range of property conditions, and buyer expectations shaped by practical value rather than speculative appreciation. Neighborhoods in Richland's established areas, newer Kennewick developments, and agricultural-adjacent properties near Prosser each attract different buyer pools with distinct priorities. Estate properties frequently need condition-based adjustments that automated tools miss entirely — deferred maintenance, outdated systems, and functional obsolescence that directly impact what buyers will pay. Our appraisal discipline helps families set prices that reflect reality and attract qualified buyers without extended market time."
    localParagraph="Benton County families tend to approach property transitions with practical, grounded expectations. Whether it is a well-maintained Richland home near the Hanford corridor, an inherited property in Kennewick with years of deferred upkeep, or a family estate near Prosser with agricultural connections, these situations benefit from honest assessment and clear coordination. We work with executors and families throughout Benton County, providing straightforward guidance on preparation, pricing, and timing — helping people move forward without unnecessary complexity."
    clientTypes={[
    ...
    countySpecificFaqs={[
      {
        ...
        answer: "Richland's proximity to Hanford creates a stable employment base that supports consistent housing demand — particularly in established neighborhoods where many homes have been owner-occupied for decades. our team understands how this employment dynamic, neighborhood stability, and the specific buyer expectations of Hanford-connected families influence estate property values in Richland and surrounding communities.",
      },
      {
      ...
      },
      {
        ...
        answer: "Yes. Properties near Prosser often involve larger lots, agricultural adjacency, and rural characteristics that attract a different buyer pool than urban Kennewick or Richland. Our appraiser credentials allow us to evaluate these non-standard features accurately — accounting for acreage, outbuildings, and rural market dynamics that standard residential valuation models miss.",
      },
      {
        question: "Can you get help with a Benton County estate sale if the heirs are scattered across multiple states?",
        answer: "Yes. our team frequently manages estate sales where family members are spread across Washington, Oregon, and other states. We handle all on-site coordination — property access, vendor management, preparation, and the sale process — while providing clear, consistent updates to all parties. This structured communication helps multi-heir families stay aligned without needing to travel to the Tri-Cities repeatedly.",
      },
      {
        question: "How do I decide the right time to list an inherited Tri-Cities property?",
        answer: "Timing depends on the property's condition, the estate administration timeline, and seasonal market patterns in the Tri-Cities area. We help executors balance these factors — identifying when the market is most favorable while respecting legal deadlines and family readiness. Our goal is a realistic plan that accounts for all the moving pieces, not pressure to list before the property is ready.",
      },
    ]}
