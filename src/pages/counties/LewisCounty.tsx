...
const LewisCounty = () => (
  <CountyPageTemplate
    ...
    localExpertiseBody={[
      ...
      `The rural communities — Toledo, Winlock, Vader, Pe Ell, and the foothills towns — operate in a different market entirely. Limited comparable sales, rural property characteristics, and a smaller buyer pool mean that pricing accuracy is especially important and automated estimates are especially unreliable. Estate and inherited properties in these communities benefit most from the kind of on-the-ground, condition-based evaluation that ${FEATURED_BROKER.name} provides.`,
    ]}
    communitiesIntro={`${FEATURED_BROKER.name} serves families, executors, and professionals throughout Lewis County, including:`}
    closingCtaBody={[
      ...
      `${FEATURED_BROKER.name} provides the locally informed, condition-based guidance that Lewis County's varied property types require.`,
    ]}
    countySpecificFaqs={[
      {
        question: "Does Real Property Planning handle Lewis County probate listings before Letters are issued?",
        answer: `No — the property cannot be marketed until Letters Testamentary or Letters of Administration have been issued by the Lewis County Superior Court in Chehalis. ${FEATURED_BROKER.name} uses that waiting period to conduct the valuation walk-through, secure the property, coordinate cleanout vendors, and prepare the marketing file — so you're ready to move the moment Letters arrive.`,
      },
      {
