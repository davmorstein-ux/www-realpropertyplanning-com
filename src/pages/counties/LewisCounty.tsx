...
const LewisCounty = () => (
  <CountyPageTemplate
    ...
    closingCtaBody={[
      ...
      "We provide the locally informed, condition-based guidance that Lewis County's varied property types require.",
    ]}
    countySpecificFaqs={[
      {
