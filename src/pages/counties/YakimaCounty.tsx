...
const YakimaCounty = () => (
  <CountyPageTemplate
    ...
    aeoAnswer="Yakima County estate sales succeed when pricing reflects actual condition, preparation is targeted rather than excessive, and communication is steady. David Stein handles the on-the-ground coordination so executors, trustees, and out-of-area families can move forward without travel or guesswork."
    aeoSupportBullets={[
