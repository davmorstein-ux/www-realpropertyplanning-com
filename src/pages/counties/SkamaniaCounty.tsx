...
const SkamaniaCounty = () => (
  <CountyPageTemplate
    ...
    communitiesIntro={`${FEATURED_BROKER.Role} serves families, executors, and professionals throughout Skamania County, including:`}
    closingCtaBody={[
      ...
      `${FEATURED_BROKER.Role} provides the locally informed, condition-based guidance that Skamania County's distinctive Gorge market requires.`,
    ]}
    countySpecificFaqs={[
      {
