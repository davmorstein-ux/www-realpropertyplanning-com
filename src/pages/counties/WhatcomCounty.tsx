...
const WhatcomCounty = () => (
  <CountyPageTemplate
    ...
    whoIHelp="David works with executors managing inherited second homes near Birch Bay and Blaine, families navigating senior transitions from longtime Bellingham residences, trustees overseeing trust-owned properties in Lynden and Ferndale, and attorneys handling probate cases in Whatcom County Superior Court. Many of his Whatcom County clients are managing from Seattle or out of state, and they rely on David for local coordination and honest assessment."
    whyCredentialsMatter="Whatcom County's smaller, more localized market means overpriced properties sit longer and condition issues carry more weight than in faster-paced metro areas. David's dual credentials as a broker and certified appraiser allow him to assess second homes, waterfront parcels, and rural properties with the kind of condition-based precision that protects executors and trustees from extended market time and avoidable financial missteps."
