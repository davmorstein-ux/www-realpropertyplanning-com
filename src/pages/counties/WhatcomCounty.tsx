...
const WhatcomCounty = () => (
  <CountyPageTemplate
    ...
    aeoSupportFaqs={[
      ...
      { question: "Can you get help with a Whatcom County property from out of state?", answer: `Yes. ${FEATURED_BROKER.Role} coordinates the full process locally and keep you informed throughout — from property assessment through closing.` },
    ]}
  />
);
