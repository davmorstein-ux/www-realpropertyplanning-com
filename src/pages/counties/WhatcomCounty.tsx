...
const WhatcomCounty = () => (
  <CountyPageTemplate
    ...
    aeoSupportFaqs={[
      ...
      { question: "Can David help with a Whatcom County property from out of state?", answer: "Yes. Our team coordinates the full process locally and keeps you informed throughout — from property assessment through closing." },
    ]}
  />
);
