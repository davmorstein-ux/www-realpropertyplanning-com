  ...
  <CountyPageTemplate
    ...
    aeoSupportFaqs={[
      ...
      },
      {
        ...
        answer: `Coastal exposure creates specific condition issues — moisture intrusion, weathering, salt air corrosion, and deferred maintenance on decks, roofing, and exterior finishes — that affect both value and buyer expectations. ${FEATURED_BROKER.Role}'s condition-based valuation approach accounts for these factors specifically, ensuring estate properties are priced based on their actual condition rather than coastal location alone.`,
      },
    ]}
    ...
    communitiesIntro={`${FEATURED_BROKER.Role} serves families, executors, and professionals throughout Pacific County, including:`}
    closingCtaBody={[
      ...
      `${FEATURED_BROKER.Role} provides the condition-based, locally informed guidance that Pacific County's coastal and rural property landscape requires.`,
    ]}
    countySpecificFaqs={[
      {
