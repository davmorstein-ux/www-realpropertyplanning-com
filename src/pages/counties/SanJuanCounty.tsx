...
const SanJuanCounty = () => (
  <CountyPageTemplate
    ...
    communitiesIntro={`${FEATURED_BROKER.Role} serves families, executors, and professionals throughout San Juan County, including:`}
    closingCtaBody={[
      ...
      `${FEATURED_BROKER.Role} coordinates the full process — including the island logistics that make San Juan County estate sales uniquely complex — so families managing from the mainland don't have to figure it out alone.`,
    ]}
    countySpecificFaqs={[
      {
