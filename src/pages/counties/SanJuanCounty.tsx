...
const SanJuanCounty = () => (
  <CountyPageTemplate
    ...
    closingCtaBody={[
      ...
      "We coordinate the full process — including the island logistics that make San Juan County estate sales uniquely complex — so families managing from the mainland don't have to figure it out alone.",
    ]}
    countySpecificFaqs={[
      {
      ...
      },
      {
        ...
        answer: "Yes — and mainland coordination is the norm for San Juan County estate sales, not the exception. Most island property owners have family based in King, Snohomish, or Pierce County, or out of state. We handle everything on the island — property assessment, vendor coordination, preparation, showings, and closing — with regular updates so families rarely need to take the ferry for any step of the process.",
      },
      {
