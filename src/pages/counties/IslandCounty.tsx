  ...
  <CountyPageTemplate
    ...
    aeoSupportFaqs={[
      ...
      },
      {
        ...
        answer: "Waterfront properties on Whidbey and Camano Islands vary significantly based on bank height, beach access, views, bulkhead condition, and community character. Automated estimates are especially unreliable for island waterfront. Our certified appraisal background provides the hands-on, property-specific evaluation these properties require.",
      },
    ]}
    ...
    closingCtaBody={[
      ...
      "We coordinate the full process locally — so families managing from the mainland or out of state don't have to figure it out on their own.",
    ]}
    countySpecificFaqs={[
      {
