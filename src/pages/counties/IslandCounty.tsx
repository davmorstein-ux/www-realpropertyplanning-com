...
const IslandCounty = () => (
  <CountyPageTemplate
    ...
    aeoSupportFaqs={[
      {
        ...
        answer: `Island properties involve logistics that mainland sales don't — ferry schedules, vendor access, and a buyer pool that is partly drawn from the mainland and partly from within the island communities themselves. Seasonal demand patterns also differ from Puget Sound suburban markets. ${FEATURED_BROKER.Role} coordinates all of this locally so families managing from Seattle or beyond don't have to.`,
      },
      {
        question: "How are waterfront properties on the islands valued for estate purposes?",
        answer: `Waterfront properties on Whidbey and Camano Islands vary significantly based on bank height, beach access, views, bulkhead condition, and community character. Automated estimates are especially unreliable for island waterfront. ${FEATURED_BROKER.Role}'s certified appraisal background provides the hands-on, property-specific evaluation these properties require.`,
      },
    ]}
    ...
    communitiesIntro={`${FEATURED_BROKER.Role} serves families, executors, and professionals throughout Island County, including:`}
    closingCtaBody={[
      ...
      `${FEATURED_BROKER.Role} coordinates the full process locally — so families managing from the mainland or out of state don't have to figure it out on their own.`,
    ]}
    countySpecificFaqs={[
      {
