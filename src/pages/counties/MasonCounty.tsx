...
const MasonCounty = () => (
  <CountyPageTemplate
    ...
    closingCtaBody={[
      ...
      "We provide the condition-based, locally informed guidance that Mason County's distinctive property landscape requires.",
    ]}
    countySpecificFaqs={[
      {
