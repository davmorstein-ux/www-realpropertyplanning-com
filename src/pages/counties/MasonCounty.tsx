...
const MasonCounty = () => (
  <CountyPageTemplate
    ...
    localExpertiseBody={[
      ...
      `Shelton's residential market functions differently — a practical, community-oriented market with steady local demand and pricing influenced by the county's timber and manufacturing employment base. Estate properties in Shelton's established neighborhoods require honest condition assessment and preparation guidance calibrated to local buyer expectations. Rural properties throughout the county's interior — acreage, forested parcels, properties with well and septic systems — require the kind of rural valuation expertise that ${FEATURED_BROKER.role}'s appraisal background provides.`,
    ]}
    communitiesIntro={`${FEATURED_BROKER.Role} serves families, executors, and professionals throughout Mason County, including:`}
    closingCtaBody={[
      ...
      `${FEATURED_BROKER.Role} provides the condition-based, locally informed guidance that Mason County's distinctive property landscape requires.`,
    ]}
    countySpecificFaqs={[
      {
