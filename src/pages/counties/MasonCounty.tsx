...
const MasonCounty = () => (
  <CountyPageTemplate
    ...
    localInsight={`Mason County occupies a distinctive position on the Olympic Peninsula — anchored by Shelton as its county seat and commercial center, and defined along its eastern edge by Hood Canal, one of the most scenic and ecologically unique waterways in the Pacific Northwest. The county attracts retirees, second-home buyers, and families seeking waterfront access, rural privacy, and a slower pace than the Puget Sound suburbs. Estate and inherited properties throughout Mason County reflect this character — waterfront cabins and homes along Hood Canal, rural acreage in the surrounding hills, and established properties in Shelton's residential neighborhoods. Each type requires a different valuation approach, and limited comparable sales in many parts of the county make professional, on-the-ground evaluation essential. ${FEATURED_BROKER.name} provides the locally informed guidance that Mason County's varied property landscape requires.`}
    ...
    localExpertiseBody={[
      ...
      `Shelton's residential market functions differently — a practical, community-oriented market with steady local demand and pricing influenced by the county's timber and manufacturing employment base. Estate properties in Shelton's established neighborhoods require honest condition assessment and preparation guidance calibrated to local buyer expectations. Rural properties throughout the county's interior — acreage, forested parcels, properties with well and septic systems — require the kind of rural valuation expertise that ${FEATURED_BROKER.name}'s appraisal background provides.`,
    ]}
    communitiesIntro={`${FEATURED_BROKER.name} serves families, executors, and professionals throughout Mason County, including:`}
    closingCtaBody={[
