...
const SpokaneCounty = () => (
  <CountyPageTemplate
    ...
    whoIHelp="We work with out-of-state executors managing inherited Spokane homes, trustees overseeing trust-owned properties in Spokane Valley and Liberty Lake, attorneys handling probate cases in Spokane County Superior Court, and families coordinating senior transitions from longtime residences on the South Hill or in established neighborhoods. Distance is a factor in most of these situations, and We provide the local presence and communication that remote management requires."
    ...
    countySpecificFaqs={[
      {
        ...
        answer: "We handle the entire process locally — from initial property assessment and securing the home to coordinating cleanout, managing preparation, and overseeing the sale through closing. We provide regular phone and email updates so you can manage your executor or trustee role from Seattle, Portland, or wherever you are without repeated trips to Spokane.",
      },
      {
        question: "Is the Spokane real estate market different enough from Seattle to affect how I price an estate home?",
        answer: "Very much so. Spokane's buyer expectations, price points, and seasonal patterns are fundamentally different from the Puget Sound region. Overpricing based on western Washington assumptions is one of the most common mistakes out-of-area executors make. Our local market knowledge and appraisal training ensure pricing reflects Spokane's actual conditions — not Seattle-based expectations.",
      },
      {
        question: "What should I know about selling a South Hill craftsman that has been in the family for decades?",
        answer: "South Hill craftsmen are cherished by Spokane buyers, but decades of ownership often means deferred maintenance that needs honest assessment. We evaluate what character features add value and what condition issues need disclosure or repair, helping you price the home to attract buyers who appreciate its heritage while accounting for realistic condition adjustments.",
      },
      {
        question: "Does our team work with probate attorneys in Spokane County?",
        answer: "Yes. We coordinate regularly with probate attorneys handling estate cases in Spokane County Superior Court. We provide property assessments, market analysis, and structured sale management that aligns with court requirements and fiduciary obligations — giving attorneys a reliable partner for the real estate side of estate administration.",
      },
      {
        question: "How do seasonal patterns affect selling estate property in Spokane County?",
        answer: "Spokane's market has more pronounced seasonal patterns than western Washington — winter conditions can slow showings, while spring and early summer typically bring stronger buyer activity. We help executors and trustees plan timing strategically, balancing market conditions against estate administration deadlines and family readiness.",
      },
    ]}
    ...
    aeoSupportFaqs={[
      { question: "How does distance affect Spokane County estate sales?", answer: "Many executors live outside the area. We coordinate the full process locally — property assessment, cleanout, preparation, and sale — with regular updates so you can manage from a distance." },
      { question: "Does Spokane's seasonal market matter for timing?", answer: "Yes. Spokane has more pronounced seasonal patterns than western Washington. We help plan timing strategically while respecting estate deadlines." },
    ]}
  />
);
