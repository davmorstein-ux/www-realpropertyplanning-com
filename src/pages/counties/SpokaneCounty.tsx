...
const SpokaneCounty = () => (
  <CountyPageTemplate
    ...
    whoIHelp="David works with out-of-state executors managing inherited Spokane homes, trustees overseeing trust-owned properties in Spokane Valley and Liberty Lake, attorneys handling probate cases in Spokane County Superior Court, and families coordinating senior transitions from longtime residences on the South Hill or in established neighborhoods. Distance is a factor in most of these situations, and David provides the local presence and communication that remote management requires."
    whyCredentialsMatter="Spokane County's more moderate price points and distinctive neighborhood-level markets make accurate, condition-based pricing essential. As a licensed broker and certified appraiser, David can assess deferred maintenance, functional obsolescence, and neighborhood-specific buyer expectations with the kind of precision that protects executors and trustees from the costly consequences of mispricing — whether that means sitting on the market for months or leaving value on the table."
