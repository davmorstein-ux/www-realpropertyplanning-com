...
const ClarkCounty = () => (
  <CountyPageTemplate
    ...
    localParagraph="Clark County's cross-state dynamics create unique considerations for estate property sales. Many families find themselves coordinating between Washington and Oregon legal frameworks, managing property from Portland or further away, and navigating a market where buyer expectations shift significantly between urban Vancouver, suburban Camas, and rural Battle Ground. David Stein's familiarity with these distinctions helps executors and families position properties effectively regardless of condition or location within the county."
    clientTypes={[
    ...
    countySpecificFaqs={[
      {
        ...
        answer: "Clark County benefits from strong cross-border buyer demand — many Portland-area residents are drawn by Washington's lack of state income tax. For estate sales, this can mean a larger buyer pool than the local population alone would suggest. However, pricing must account for how different Clark County neighborhoods compete with Portland-area alternatives. David Stein understands these cross-border dynamics and positions properties accordingly.",
      },
      {
        question: "What cross-state complications can arise when selling inherited property in Clark County?",
        answer: "When heirs live in Oregon or the estate involves cross-border legal considerations, families may need to coordinate between Washington and Oregon legal frameworks, tax obligations, and professional advisors. David Stein works alongside estate attorneys to manage the real estate side of these situations, ensuring the property sale aligns with the broader legal and financial picture.",
      },
      {
        question: "How has rapid growth in Ridgefield and Battle Ground changed estate property values?",
        answer: "Areas like Ridgefield and Battle Ground have seen significant appreciation as Clark County's population has grown. Estate properties in these communities may be worth substantially more than families expect based on older assessments. David Stein provides current, condition-based pricing analysis that accounts for recent market shifts — helping executors avoid both underpricing in appreciating areas and overpricing in neighborhoods where growth has been more moderate.",
      },
      {
        question: "Should I sell a Vancouver estate home as-is or invest in preparation?",
        answer: "It depends on the property's condition, location within Vancouver, and the current buyer expectations for that neighborhood. A home near downtown Vancouver's revitalized core may benefit from targeted preparation, while a property in a more established subdivision might sell well as-is. David Stein evaluates each situation individually, using our appraisal background to assess which investments are likely to improve the outcome.",
      },
      {
        question: "Can David Stein help if the executor lives in Portland and the property is in Clark County?",
        answer: "Yes. David Stein frequently works with executors and trustees who are based in the Portland area. While the property may be just across the river, managing an estate sale still requires on-site coordination — securing the property, supervising cleanout, managing vendors, and handling the listing and sale process. David Stein provides that local presence and keeps you informed throughout.",
      },
    ]}
    aeoQuestion="How do probate and inherited property sales work in Clark County?"
    aeoAnswer="Clark County families — many with ties to both sides of the Columbia River — often face unique coordination challenges during estate and probate property transitions. Real Property Planning provides clear cross-state communication, hands-on local presence, and full sale management for executors, trustees, and attorneys throughout Clark County."
    aeoSupportBullets={[
