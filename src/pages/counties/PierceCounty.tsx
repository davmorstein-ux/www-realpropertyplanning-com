...
const PierceCounty = () => (
  <CountyPageTemplate
    ...
    localExpertiseHeading="Our Pierce County Experience"
    localExpertiseBody={[
    ...
    countySpecificFaqs={[
      {
        ...
        answer: "Many Tacoma estate homes — especially in the North End and Stadium District — have character features combined with decades of deferred maintenance. We evaluate whether targeted repairs will improve the sale price enough to justify the cost and delay, or whether selling as-is to a buyer who values the home's character and location is the stronger strategy. Our appraisal background ensures this analysis is grounded in actual market data, not guesswork.",
      },
      {
        question: "Is pricing a Gig Harbor waterfront home different from pricing a home in Lakewood?",
        answer: "Significantly. Gig Harbor waterfront properties attract a premium buyer pool with different expectations than Lakewood's value-oriented market. Our dual credentials as a broker and appraiser allow us to assess waterfront premiums, view adjustments, and condition factors specific to each micro-market — ensuring each property is positioned for its actual buyer pool.",
      },
      {
