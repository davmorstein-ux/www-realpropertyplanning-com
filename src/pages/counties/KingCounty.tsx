...
const KingCounty = () => (
  <CountyPageTemplate
    ...
    closingCtaBody={[
      ...
      "We are based in Kirkland and serve the entire King County area — from Seattle neighborhoods to the Eastside communities we know best.",
    ]}
    countySpecificFaqs={[
      {
