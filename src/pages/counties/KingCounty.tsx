  ...
  <CountyPageTemplate
    ...
    countySpecificFaqs={[
      ...
      },
      {
        ...
        answer: "Yes — this is one of the most common situations Real Property Planning handles. David manages the full process locally, provides regular written and photo updates, handles all vendor coordination, and communicates with each heir consistently. Digital document signing means heirs rarely need to be physically present for any step of the process.",
      },
      {
        question: "Should I get a formal appraisal before selling an inherited King County home?",
        answer: "It depends on your situation. A formal USPAP-compliant appraisal is required in some probate and estate tax situations — your estate attorney can advise on whether it's legally required for your case. For most estate property sales, David's valuation-informed market analysis — grounded in certified appraisal methodology — provides the defensible pricing foundation that executors and fiduciaries need without the additional cost and timeline of a separate formal appraisal. David can help you understand which approach is right for your specific situation.",
      },
      {
        question: "What challenges do executors face when selling a Seattle or Eastside home?",
        answer: "King County executors face several challenges that aren't present in standard transactions: establishing legal authority before listing, managing properties that may have been vacant for months, coordinating among heirs who may live across the country, and navigating a market where neighborhood-level pricing dynamics matter enormously. Add the emotional weight of the situation and the fiduciary responsibility to document every decision — and it becomes clear why executors benefit from working with someone who has done this many times before.",
