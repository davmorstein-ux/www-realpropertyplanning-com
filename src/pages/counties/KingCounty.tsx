...
const KingCounty = () => (
  <CountyPageTemplate
    ...
    heroH1="King County, WA"
    heroSubheading="Estate, probate, and senior transition real estate — priced and prepared for the neighborhood it actually sits in."
    belowHeroHeading="Serving Every Corner of King County"
    ...
    localInsight={`King County is one of the most dynamic and varied real estate markets in the country — and that complexity doesn't disappear when a property is part of an estate, a probate case, or a senior housing transition. If anything, it increases. A condition-impaired home in Shoreline faces a very different buyer pool than a waterfront property in Mercer Island. A Capitol Hill condo involves different legal and logistical considerations than a Sammamish family home. ${FEATURED_BROKER.Role} brings the neighborhood-level market knowledge and the valuation methodology to navigate all of it — honestly, carefully, and at your pace. ${FEATURED_BROKER.Role} serves families, executors, trustees, and attorneys throughout King County with the dual perspective of a licensed real estate broker and a Washington State Certified Residential Appraiser.`}
    aeoQuestion="How does selling estate property work in King County's competitive market?"
    aeoAnswer={`King County's real estate market is active and competitive — but estate and probate properties don't always benefit from that competitiveness automatically. Homes with deferred maintenance, extended vacancy, or condition issues can sit if they're priced or presented incorrectly. ${FEATURED_BROKER.Role}'s approach starts with an honest, condition-adjusted valuation — not a number designed to win a listing — followed by a preparation strategy that's calibrated to the property's specific situation and neighborhood. The result is a pricing position that attracts the right buyers for that property, in that market, at that time.`}
    aeoSupportFaqs={[
      {
        question: "What challenges do executors face when selling a Seattle or Eastside home?",
        answer: "King County executors face several challenges that aren't present in standard transactions: establishing legal authority before listing, managing properties that may have been vacant for months, coordinating among heirs who may live across the country, and navigating a market where neighborhood-level pricing dynamics matter enormously. Add the emotional weight of the situation and the fiduciary responsibility to document every decision — and it becomes clear why executors benefit from working with someone who has done this many times before.",
      },
      {
        question: "How is pricing an inherited condo in Bellevue different from pricing a house in Shoreline?",
        answer: `Significantly different. A Bellevue condo involves HOA considerations, building financials, and a buyer pool that skews toward tech-sector buyers with specific expectations about finishes and amenities. A Shoreline house involves lot value, neighborhood trajectory, and a buyer pool that may include developers as well as end-users. ${FEATURED_BROKER.Role}'s pricing analysis accounts for these distinctions — not just comparable sales, but the property type, buyer pool, and current demand dynamics specific to that submarket.`,
      },
    ]}
    ...
    closingCtaBody={[
      ...
      `${FEATURED_BROKER.Role} is based in Kirkland and serve the entire King County area — from Seattle neighborhoods to the Eastside communities ${FEATURED_BROKER.pronoun.subject} knows best.`,
    ]}
    countySpecificFaqs={[
      {
