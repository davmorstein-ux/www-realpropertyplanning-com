...
const KingCounty = () => (
  <CountyPageTemplate
    ...
    closingCtaBody={[
      ...
      "David Stein is based in Kirkland and serves the entire King County area — from Seattle neighborhoods to the Eastside communities we know best.",
    ]}
    countySpecificFaqs={[
      {
