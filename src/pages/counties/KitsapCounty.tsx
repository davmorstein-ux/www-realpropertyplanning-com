...
const KitsapCounty = () => (
  <CountyPageTemplate
    ...
    aeoAnswer="The process follows Washington State probate law, but Kitsap County has its own probate court, local title companies, and professional ecosystem that We are familiar with from years of working in the market. An estate property in Kitsap requires pricing calibrated to the peninsula's buyer pool — which includes Seattle commuters drawn by ferry access, military personnel, local buyers, and retirees seeking waterfront lifestyle at more accessible price points than King County. Our approach accounts for all of these factors in developing a realistic pricing and preparation strategy."
    aeoSupportFaqs={[
      {
        question: "How does the ferry connection to Seattle affect Kitsap property values?",
        answer: "Significantly — and the impact varies considerably depending on the property's proximity to ferry terminals and the commute experience it offers. Properties in Bainbridge Island, Kingston, and Bremerton that offer practical ferry commutes to Seattle command premiums that reflect that access. Properties further from ferry routes have their own buyer pool and pricing dynamics. Our location-specific analysis captures these distinctions accurately.",
      },
      {
    ...
    closingCtaBody={[
      "Whether you're just beginning to navigate an estate property in Kitsap County or are already in the middle of a probate sale, a short conversation with our team can help bring clarity and a practical next step.",
    ]}
    countySpecificFaqs={[
      {
        question: "How does the ferry affect selling an inherited home on Bainbridge Island?",
        answer: "Ferry access shapes everything about the Bainbridge Island buyer pool — commute patterns, showing logistics, and buyer expectations. our team understands how ferry proximity and schedule affect property value and marketing strategy. We coordinate showings and vendor access around ferry schedules so out-of-area executors do not need to manage these logistics themselves.",
      },
      {
        question: "What should a military family in Bremerton know about selling an inherited home?",
        answer: "Military families in Bremerton and Silverdale often face deployment timelines, relocations, and distance-related coordination challenges when managing inherited property. We provide the full-service local coordination these situations require — handling property access, preparation, and the sale process while keeping families informed regardless of where they are stationed.",
      },
      {
