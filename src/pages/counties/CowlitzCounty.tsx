...
const CowlitzCounty = () => (
  <CountyPageTemplate
    ...
    countyPath="/cowlitz-county"
    countySlug="cowlitz-county"
    heroH1="Cowlitz County, WA"
    heroSubheading="Probate, estate, and senior transition real estate — guided with care in a county where community runs deep and every property has a story."
    belowHeroHeading="Serving Every Corner of Cowlitz County"
    seoTitle="Probate & Estate Real Estate in Cowlitz County, WA | Real Property Planning"
    seoDescription="Experienced probate real estate, inherited home sales, and senior transition guidance throughout Cowlitz County, Washington. Serving Longview, Kelso, Castle Rock & surrounding communities."
    cities={[
      "Longview", "Kelso", "Castle Rock", "Woodland", "Kalama",
      "Cathlamet", "Ryderwood", "Silver Lake", "Toutle", "Ariel",
    ]}
    localInsight={`Cowlitz County sits at the confluence of the Cowlitz and Columbia Rivers, with a real estate market shaped by its industrial roots, natural landscape, and tight-knit communities. From the established neighborhoods of Longview — one of the first planned cities in the Pacific Northwest — to the rural properties along the Toutle River corridor, estate and probate properties here require someone who understands both the local market dynamics and the unique characteristics of each community. ${FEATURED_BROKER.name} brings the dual perspective of a licensed broker and certified appraiser to every Cowlitz County engagement, helping families, executors, and attorneys navigate inherited and estate property with clarity and confidence.`}
    ...
    aeoSupportFaqs={[
      ...
      },
      {
        ...
        answer: `This is one of the most common situations ${FEATURED_BROKER.name} handles in Cowlitz County. ${FEATURED_BROKER.pronoun.Subject} manages the entire process locally — property walk-throughs, vendor coordination, cleanout, photography, showings, and offer review — with regular written and photo updates to keep out-of-state heirs informed at every step.`,
      },
    ]}
    ...
    localExpertiseBody={[
      ...
      `For estate properties, condition matters enormously. Homes that have been lived in for 30 or 40 years require honest, condition-adjusted pricing and a preparation plan that matches what local buyers actually expect. Overpricing or underpreparing a Cowlitz County estate home can mean months on market and eventual price reductions. ${FEATURED_BROKER.name}'s appraisal background ensures that every property is priced on its actual condition and neighborhood — not on wishful thinking.`,
    ]}
    communitiesIntro={`${FEATURED_BROKER.name} serves families, executors, and professionals throughout Cowlitz County, including:`}
    closingCtaBody={[
      ...
      `${FEATURED_BROKER.name} serves Cowlitz County families and professionals with the same care and expertise ${FEATURED_BROKER.pronoun.subject} brings to every engagement across Western Washington.`,
    ]}
    countySpecificFaqs={[
      {
        question: "Does Real Property Planning handle probate listings in Cowlitz County before Letters are issued?",
        answer: `No — the property cannot be listed until the personal representative has received Letters Testamentary or Letters of Administration from the Cowlitz County Superior Court. However, ${FEATURED_BROKER.name} uses that waiting period productively: conducting the date-of-death valuation walk-through, securing the property, coordinating cleanout vendors, and preparing the marketing file so you're ready to move the moment Letters arrive.`,
      },
      {
        question: "What should I know about selling a rural property in Cowlitz County as part of an estate?",
        answer: `Rural Cowlitz County properties — acreage, river-corridor parcels, properties near Silver Lake or the Toutle Valley — require careful attention to access, utilities, and land use. Buyer pools for rural properties are different from urban neighborhoods, and pricing must reflect the specific characteristics of the land, not just comparable sales. ${FEATURED_BROKER.name}'s appraisal background is especially valuable for rural estate properties where automated estimates are often significantly off.`,
      },
      {
        question: "How long does it typically take to sell an estate property in Cowlitz County?",
        answer: `Timeline varies by property type, condition, and preparation. A well-prepared home in Longview or Kelso can move in a few weeks in active market conditions. Rural properties or homes needing significant cleanout and preparation may take longer. ${FEATURED_BROKER.name} provides honest timeline expectations from the first conversation — not projections designed to win a listing.`,
      },
      {
        question: "Can Real Property Planning coordinate cleanout and repairs for a Cowlitz County estate property?",
        answer: `Yes. ${FEATURED_BROKER.name} maintains relationships with trusted local vendors for estate cleanout, basic repairs, and property preparation throughout Cowlitz County. Coordinating these services locally is part of what ${FEATURED_BROKER.pronoun.subject} does — so executors and out-of-state heirs don't have to manage it themselves from a distance.`,
      },
    ]}
  />
);

export default CowlitzCounty;
