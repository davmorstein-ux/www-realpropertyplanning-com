...
const CowlitzCounty = () => (
  <CountyPageTemplate
    ...
    localExpertiseBody={[
      ...
      `For estate properties, condition matters enormously. Homes that have been lived in for 30 or 40 years require honest, condition-adjusted pricing and a preparation plan that matches what local buyers actually expect. Overpricing or underpreparing a Cowlitz County estate home can mean months on market and eventual price reductions. ${FEATURED_BROKER.Role}'s appraisal background ensures that every property is priced on its actual condition and neighborhood — not on wishful thinking.`,
    ]}
    communitiesIntro={`${FEATURED_BROKER.Role} serves families, executors, and professionals throughout Cowlitz County, including:`}
    closingCtaBody={[
      ...
      `${FEATURED_BROKER.Role} serves Cowlitz County families and professionals with the same care and expertise ${FEATURED_BROKER.pronoun.subject} brings to every engagement across Western Washington.`,
    ]}
    countySpecificFaqs={[
      {
      ...
      },
      {
        ...
        answer: `Rural Cowlitz County properties — acreage, river-corridor parcels, properties near Silver Lake or the Toutle Valley — require careful attention to access, utilities, and land use. Buyer pools for rural properties are different from urban neighborhoods, and pricing must reflect the specific characteristics of the land, not just comparable sales. ${FEATURED_BROKER.Role}'s appraisal background is especially valuable for rural estate properties where automated estimates are often significantly off.`,
      },
      {
        question: "How long does it typically take to sell an estate property in Cowlitz County?",
        answer: `Timeline varies by property type, condition, and preparation. A well-prepared home in Longview or Kelso can move in a few weeks in active market conditions. Rural properties or homes needing significant cleanout and preparation may take longer. ${FEATURED_BROKER.Role} provides honest timeline expectations from the first conversation — not projections designed to win a listing.`,
      },
      {
