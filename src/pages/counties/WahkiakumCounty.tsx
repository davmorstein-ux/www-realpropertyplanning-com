...
const WahkiakumCounty = () => (
  <CountyPageTemplate
    ...
    communitiesIntro={`${FEATURED_BROKER.Role} serves families, executors, and professionals throughout Wahkiakum County, including:`}
    closingCtaBody={[
      ...
      `${FEATURED_BROKER.Role} brings genuine engagement and locally informed guidance to Washington's most rural county — because every estate situation deserves to be taken seriously, regardless of the county's size.`,
    ]}
    countySpecificFaqs={[
      {
      ...
      },
      {
        ...
        answer: `Scale and specificity. Wahkiakum County is Washington's smallest county by population, which means the buyer pool for any given property is genuinely small — and getting the pricing and presentation right matters more, not less, than in larger markets. There is very little room for error when the pool of motivated buyers is limited. ${FEATURED_BROKER.Role}'s approach — honest condition assessment, realistic pricing, and targeted marketing to the buyers most likely to value what the property offers — is especially well suited to Wahkiakum County's distinctive market.`,
      },
    ]}
  />
);
