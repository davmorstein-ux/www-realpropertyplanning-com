  ...
  <CountyPageTemplate
    ...
    countySpecificFaqs={[
      ...
      },
      {
        ...
        answer: "Yes. our team regularly coordinates with probate attorneys on Snohomish County estate sales, providing property assessments, market analysis, and coordinated sale management that aligns with court timelines and fiduciary requirements. Attorneys refer clients to our team because We communicate clearly, follows through, and understands the legal context surrounding estate property sales.",
      },
      {
        question: "How do I manage an inherited Snohomish County property from out of state?",
        answer: "We handle the full process locally — securing the property, coordinating cleanout, managing preparation, listing, showing, negotiating, and closing. We provide regular updates via phone and email so you can fulfill your executor or trustee responsibilities without needing to fly in repeatedly. Many of our Snohomish County clients manage the entire process from a distance.",
      },
    ]}
  />
);
