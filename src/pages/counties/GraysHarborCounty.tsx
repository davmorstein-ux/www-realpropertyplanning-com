...
const GraysHarborCounty = () => (
  <CountyPageTemplate
    ...
    localExpertiseBody={[
      ...
      `For estate properties, this diversity means that a one-size-fits-all approach simply doesn't work. A Hoquiam craftsman bungalow and an Ocean Shores beach cottage require entirely different marketing strategies, pricing methodologies, and preparation plans. ${FEATURED_BROKER.Role} brings the local knowledge and valuation expertise to get each property positioned correctly from the start.`,
    ]}
    communitiesIntro={`${FEATURED_BROKER.Role} serves families, executors, and professionals throughout Grays Harbor County, including:`}
    closingCtaBody={[
      ...
      `${FEATURED_BROKER.Role} brings the same careful, coordinated approach to Grays Harbor County that ${FEATURED_BROKER.pronoun.subject} brings to every engagement across Western Washington.`,
    ]}
    countySpecificFaqs={[
      {
