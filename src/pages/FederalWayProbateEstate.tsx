...
const faqs = [
  { question: "What should I do first with an inherited home in Federal Way?", answer: `Secure the property, confirm your legal authority, and get an honest assessment of condition and value. ${FEATURED_BROKER.Role} can walk through the home, identify what affects its marketability, and help you understand your options before making commitments.` },
  { question: "How does an appraisal background help in Federal Way?", answer: `As both a licensed Washington State real estate broker and a state-certified residential appraiser, ${FEATURED_BROKER.role} provides pricing based on actual property condition and local comparable data. In Federal Way, where homes range from well-maintained to significantly deferred, this dual expertise ensures pricing reflects reality.` },
  { question: "Is it better to sell quickly or take time to prepare?", answer: `It depends on the property's condition, your timeline, and the transition situation. ${FEATURED_BROKER.Role} evaluates the trade-offs honestly — sometimes targeted preparation yields a strong return; other times, pricing the home to sell in current condition is the smarter path. He'll help you weigh both options.` },
  { question: "Can the process be coordinated if I'm not local?", answer: `Yes. ${FEATURED_BROKER.Role} regularly works with executors and families managing Federal Way properties from other parts of Washington, out of state, or internationally — handling property access, vendor coordination, and communication so you can participate in decisions without managing logistics.` },
  { question: "What if the sale is tied to a parent's move to care?", answer: `This is common in Federal Way. ${FEATURED_BROKER.Role} coordinates sale timelines with care transitions, working with families, senior living communities, and other professionals to keep everything aligned. The goal is to reduce pressure during an already stressful time.` },
  { question: "How long does it take to sell an inherited home in Federal Way?", answer: `Timelines depend on the legal process, property condition, and preparation scope. Once the home is ready and authority is in place, well-priced Federal Way properties typically sell within a few weeks. ${FEATURED_BROKER.Role} helps set realistic expectations based on your specific situation.` },
];

const FederalWayProbateEstate = () => {
  useEffect(() => {
    const faqSchema = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: faqs.map((f) => ({ "@type": "Question", name: f.question, acceptedAnswer: { "@type": "Answer", text: f.answer } })) };
    const localSchema = { ...hubOrganizationSchema, "@context": "https://schema.org", areaServed: [{ "@type": "City", name: "Federal Way", containedInPlace: { "@type": "State", name: "Washington" } }, ...areaServed] };
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">As both a licensed Washington State real estate broker and a state-certified residential appraiser, {FEATURED_BROKER.role} evaluates Federal Way properties based on their actual condition, neighborhood positioning, and realistic buyer expectations. This means a pricing and preparation strategy that fits both the property and your timeline.</p>
          </div>
        </div>
      </section>
