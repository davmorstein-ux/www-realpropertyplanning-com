...
const FederalWayProbateEstate = () => {
  useEffect(() => {
    ...
    const localSchema = { ...realEstateAgentSchema, "@context": "https://schema.org", areaServed: [{ "@type": "City", name: "Federal Way", containedInPlace: { "@type": "State", name: "Washington" } }, ...areaServed] };
