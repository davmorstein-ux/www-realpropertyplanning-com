...
const faqs = [
  ...
  { question: "Can we team coordinate the process if I'm not local?", answer: "Yes. our team regularly works with executors and families managing Federal Way properties from other parts of Washington, out of state, or internationally. We handle property access, vendor coordination, and communication so you can participate in decisions without managing logistics." },
