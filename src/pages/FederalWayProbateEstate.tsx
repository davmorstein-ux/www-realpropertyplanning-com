...
const faqs = [
  ...
  { question: "What if the sale is tied to a parent's move to care?", answer: `This is common in Federal Way. ${FEATURED_BROKER.name} coordinates sale timelines with care transitions, working with families, senior living communities, and other professionals to keep everything aligned. The goal is to reduce pressure during an already stressful time.` },
  { question: "How long does it take to sell an inherited home in Federal Way?", answer: `Timelines depend on the legal process, property condition, and preparation scope. Once the home is ready and authority is in place, well-priced Federal Way properties typically sell within a few weeks. ${FEATURED_BROKER.name} helps set realistic expectations based on your specific situation.` },
];
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">As both a licensed Washington State real estate broker and a state-certified residential appraiser, {FEATURED_BROKER.name} evaluates Federal Way properties based on their actual condition, neighborhood positioning, and realistic buyer expectations. This means a pricing and preparation strategy that fits both the property and your timeline.</p>
          </div>
        </div>
      </section>
