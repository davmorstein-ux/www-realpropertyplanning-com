...
const faqs = [
  ...
  { question: "How does our team's appraisal background help in Federal Way?", answer: "As both a licensed Washington State real estate broker and a state-certified residential appraiser, David Stein provides pricing based on actual property condition and local comparable data. In Federal Way, where homes range from well-maintained to significantly deferred, this dual expertise ensures pricing reflects reality." },
