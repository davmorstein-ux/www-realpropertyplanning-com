...
const services = [
  {
    ...
    description: (
      <>
        David's <Link to="/real-estate-appraiser" className="text-accent hover:text-gold underline underline-offset-4">certified appraisal</Link> background produces a condition-adjusted, methodology-based market analysis — not a listing pitch. When both parties are working from the same objective foundation, valuation disputes resolve more efficiently. This analysis can also serve as a useful reference point in settlement negotiations.
      </>
    ),
  },
  {
    title: "Neutral Representation",
    description: "David does not represent either party's interests — he represents the property and the process. His role is to handle the sale fairly, transparently, and professionally, with consistent communication to both parties (or through their attorneys) and no advocacy for either side.",
  },
  {
    title: "Structured, Organized Sale Process",
    description: "David manages preparation, listing, marketing, showings, negotiation, and closing — providing both parties with regular updates in a format that is factual, clear, and professionally neutral. Neither party has to wonder what is happening or rely on the other for information.",
  },
  {
    title: "Market Expertise for the Puget Sound Region",
    description: (
      <>
        David brings deep knowledge of real estate conditions throughout{" "}
...
const faqs = [
  {
    ...
    answer: "David's role is defined from the beginning as neutral coordinator — his obligation is to the property transaction, not to either party. Communication protocols are established upfront: updates can be sent simultaneously to both parties, routed through respective counsel, or structured in whatever way the attorneys prefer. Pricing and preparation decisions are based on market data, not either party's preference.",
  },
  {
    question: "What if one party is living in the home during the sale?",
    answer: "This is one of the most common and most delicate situations in divorce real estate. David has worked with this dynamic regularly and approaches it with clear protocols: scheduled showings with appropriate notice, professional staging guidance that respects the occupant's daily life, and consistent communication that keeps both parties informed without requiring them to interact directly.",
  },
  {
    question: "Can the home be sold before the divorce is finalized?",
    answer: "In many cases, yes — though it depends on court orders and the specifics of the legal proceedings. David coordinates with both attorneys to ensure the real estate process aligns with the legal timeline and any court-imposed requirements.",
  },
];
    ...
    <section className="bg-primary pt-1.5 md:pt-2 pb-12 md:pb-14">
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <img src={iconDivorce} alt="Divorce attorney marital home sale neutral real estate Washington State" className="mx-auto max-w-[15rem] w-full h-auto object-contain mb-3" loading="lazy"/>
