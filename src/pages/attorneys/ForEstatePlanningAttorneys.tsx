    ...
    <section className="bg-primary pt-1.5 md:pt-2 pb-12 md:pb-14">
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <img src={iconEstatePlanning} alt="Estate planning attorney real estate support Washington State" className="mx-auto max-w-[15rem] w-full h-auto object-contain mb-3" loading="lazy"/>
