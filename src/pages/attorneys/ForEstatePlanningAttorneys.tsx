...
const services = [
  {
    ...
    description: (
      <>
        David Stein's background as a <Link to="/real-estate-appraiser" className="text-accent hover:text-gold underline underline-offset-4">Washington State Certified Residential Appraiser</Link> means clients receive a condition-adjusted, methodology-based market assessment — not just a listing agent's price opinion. This is especially valuable when valuation needs to support trust decisions, beneficiary conversations, or planning-related financial analysis.
      </>
    ),
  },
  {
    title: "Strategic Sale Planning",
    description: "David Stein advises on timing, preparation, and market positioning — always in alignment with the broader estate plan and the client's specific situation. Decisions about what to repair, when to list, and how to price are made with both market knowledge and fiduciary awareness.",
  },
  {
    title: "Coordination With Advisors",
    description: "David Stein works collaboratively with attorneys, CPAs, and financial planners — ensuring that everyone involved in the client's plan is working from the same real estate information. One consistent point of contact. Regular updates. No gaps in communication.",
  },
  {
    title: "Property Preparation Oversight",
    description: "When preparation is needed before a sale, David Stein coordinates vendors, manages the process, and keeps the client and their advisors informed — without adding to their administrative burden.",
  },
];
      ...
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-primary-foreground/70 text-lg leading-relaxed mb-4">
            If you work with clients who hold real property as part of their estate plan — and who will eventually need to sell, transfer, or make decisions about that property — David Stein welcomes the opportunity to be a resource for your practice.
          </p>
