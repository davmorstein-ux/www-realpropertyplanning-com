...
const services = [
  {
    ...
    description: (
      <>
        A shared, objective market value is often the most important tool for moving a family law property matter forward. We provide a condition-adjusted, comparable-supported market analysis — not a listing agent's pitch — that both parties can evaluate from the same factual foundation.
      </>
    ),
  },
  {
    title: "Neutral, Professional Coordination",
    description: "Our role is not to represent either party's interests — it's to handle the property professionally and move the process forward. We maintain clear, consistent communication with both parties (or through their respective counsel) and manage the sale with the goal of a fair outcome, not a fast commission.",
  },
  {
    title: "Structured Process Guidance",
    description: "Many clients navigating family law situations have never managed a home sale on their own. We explain each step clearly, manages the preparation and listing process, and provide regular updates so clients always know where things stand.",
  },
  {
    title: "Calm, Consistent Communication",
    description: "In situations where communication between parties is strained, our structured approach to updates — consistent, factual, and professionally neutral — reduces opportunities for misunderstanding and conflict.",
  },
];
...
const faqs = [
  {
    ...
    answer: "Yes — our role is explicitly neutral. We provide objective market analysis and manage the sale process professionally, without advocacy for either party. Communication protocols can be structured to route through respective counsel if that is preferred.",
  },
  {
    question: "How does valuation work when parties disagree on what the home is worth?",
    answer: "We provide a condition-adjusted, comparable-supported market analysis grounded in our certified appraisal training. Because the analysis is methodology-based rather than opinion-based, it gives both parties and their attorneys a shared factual foundation — which often resolves valuation disputes more efficiently than competing agent opinions.",
  },
  {
    question: "Can the home be sold during active legal proceedings?",
    answer: "In many cases, yes — though the specifics depend on court orders, agreements between parties, and the legal structure of the proceeding. We work in alignment with whatever legal requirements are in place and coordinate with both attorneys to ensure the real estate process supports rather than complicates the legal timeline.",
  },
];
      ...
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-primary-foreground/70 text-lg leading-relaxed mb-8">
            We work collaboratively with family law attorneys throughout the Puget Sound area — providing the neutral, structured real estate support that helps complex situations move forward.
          </p>
