    ...
    <section className="py-16 lg:py-24 bg-background">
      <div className="container px-6 lg:px-8">
        <div className="max-w-[900px] mx-auto">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-8">
            Real Property Planning does not provide legal advice. Instead, David Stein provides the real estate expertise that complements legal counsel — particularly in situations where property condition, market value, or sale logistics are part of a larger legal matter:
          </p>
          <ul className="space-y-4">
      ...
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-primary-foreground/70 text-lg leading-relaxed mb-8">
            David Stein serves clients throughout{" "}
