    ...
    <section className="py-16 lg:py-24 bg-background">
      <div className="container px-6 lg:px-8">
        <div className="max-w-[900px] mx-auto">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-8">
            Real Property Planning does not provide legal advice. Instead, we provide the real estate expertise that complements legal counsel — particularly in situations where property condition, market value, or sale logistics are part of a larger legal matter:
          </p>
          <ul className="space-y-4">
