...
/*
  ...
  No first-person plural anywhere on this page.
*/
...
const faqs = [
  {
    ...
    answer: `No. Neither Real Property Planning nor ${FEATURED_BROKER.role} provides legal advice. When legal questions arise, clients should consult a qualified real estate attorney. ${FEATURED_BROKER.Role} helps with the real estate, valuation, and practical property side of the situation.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Yes. ${FEATURED_BROKER.Role} can work alongside your attorney and other advisors to help with pricing, valuation insight, sale preparation, and practical coordination related to the property.`,
  },
  {
...
const ForRealEstateAttorneys = () => (
  <div className="min-h-screen bg-background">
    <SEOHead
      ...
      description={`${FEATURED_BROKER.Role} — a Washington State licensed real estate broker and certified residential appraiser — works alongside real estate attorneys to provide market analysis, property coordination, and sale management when clients need both legal and real estate expertise.`}
    />
    <BreadcrumbSchema
      items={[
    ...
    {/* Hero */}
    <HeroBandTitle as="h1">Real Estate Attorneys</HeroBandTitle>
      ...
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            {FEATURED_BROKER.Role} works alongside real estate attorneys to provide the property side of that equation — market analysis, valuation insight, preparation coordination, and sale management — while leaving the legal guidance where it belongs.
          </p>
        </div>
      </div>
    </section>
    ...
    <section className="py-16 lg:py-24 bg-background">
      <div className="container px-6 lg:px-8">
        <div className="max-w-[900px] mx-auto">
          <h2 className="font-serif text-3xl text-foreground font-semibold mb-4">
            How {FEATURED_BROKER.roleTitle} Works Alongside Real Estate Attorneys
          </h2>
          <p className="text-muted-foreground text-lg leading-relaxed mb-8">
            {FEATURED_BROKER.Role} does not provide legal advice. Instead, he provides the real estate expertise that complements legal counsel — particularly in situations where property condition, market value, or sale logistics are part of a larger legal matter:
          </p>
          <ul className="space-y-4">
    ...
    <section className="py-16 lg:py-24 bg-secondary">
      <div className="container px-6 lg:px-8">
        <div className="max-w-[900px] mx-auto">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-8">
            Real estate attorneys and their clients benefit from {FEATURED_BROKER.role}'s support in situations including:
          </p>
      ...
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-primary-foreground/70 text-lg leading-relaxed mb-4">
            When a client's legal matter involves real property in Washington State, {FEATURED_BROKER.role} provides a reliable, professional resource for the market and logistics side of the situation.
          </p>
          <p className="text-primary-foreground/70 text-lg leading-relaxed mb-8">
            {FEATURED_BROKER.Role} serves clients throughout{" "}
