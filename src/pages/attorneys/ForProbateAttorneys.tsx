...
const services = [
  ...
  },
  {
    ...
    description: "From professional cleanout to targeted repairs to staging, we coordinate the full preparation process through trusted local vendors — so the executor doesn't have to manage it and you don't have to track it down.",
  },
  {
    title: "Communication With All Parties",
    description: "We serve as the single real estate point of contact — keeping executors, co-heirs, and the legal team informed with consistent, clear updates throughout the process.",
  },
  {
    title: "Hands-On Local Support",
    description: "For executors managing Washington State property from out of state, we handle the property locally — with photo updates, digital documentation, and remote coordination that makes the process manageable from anywhere.",
  },
];
...
const faqs = [
  {
    ...
    answer: "We handle the real estate side completely — property assessment, condition-based pricing, preparation coordination, listing, and sale management — while keeping the attorney informed throughout. Attorneys receive consistent updates and have a single point of contact for all property-related questions. The goal is to make the real estate side of probate administration as straightforward as possible so you can focus on the legal work.",
  },
  {
    question: "What is the difference between a CMA and the valuation analysis We provide?",
    answer: "A standard comparative market analysis (CMA) is produced by most listing agents and reflects a general price range based on nearby sales. It is not a formal appraisal, and it typically does not account for condition in a documented, methodology-based way. Our condition-based pricing combines our certified appraisal training with current market data — producing a condition-adjusted, comparable-supported price opinion that is more defensible for fiduciary purposes than a standard CMA. For situations requiring a formal appraisal (date-of-death valuations, for example), our team can discuss appropriate referral resources.",
  },
  {
    question: "Can you help when heirs disagree about value or timing?",
    answer: "Yes — and this is one of the most common situations We work with. When heirs have received conflicting price opinions or have different views on what the property is worth, a clear, documented evidence-based analysis often resolves the disagreement faster than continued negotiation. our team can present the analysis to all parties — together or separately — and walk through the comparable data in plain language.",
  },
  {
    question: "Do you work with probate attorneys outside of Western Washington?",
    answer: "Our primary service area is Western Washington and the Puget Sound region — King, Snohomish, Pierce, and Kitsap Counties, with additional coverage in Skagit County and surrounding areas. For attorneys with clients in other parts of Washington State, our team can discuss appropriate referral connections. For clients outside Washington, Real Property Planning can connect attorneys and clients with a trusted broker anywhere in the country through our eXp Realty network.",
  },
];
      ...
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-primary-foreground/70 text-lg leading-relaxed mb-8">
            We work collaboratively with probate attorneys throughout the Puget Sound area and across Washington State — and is available for direct attorney consultations at your convenience.
          </p>
