...
const services = [
  ...
  },
  {
    ...
    description: (
      <>
        David Stein works alongside senior move managers, care coordinators, social workers, and placement specialists — aligning the real estate timeline with the broader transition plan. Real Property Planning has an established relationship with <Link to="/senior-transitions" className="text-accent hover:text-gold underline underline-offset-4">HB Move Management</Link> (a division of Hansen Bros. Moving &amp; Storage), one of the most experienced senior moving services in Western Washington.
      </>
    ),
  },
  {
    title: "Out-of-Area Family Coordination",
    description: "Many elder law clients have adult children managing the process from other states. David Stein handles the property locally — with consistent updates to the family, the attorney, and the care team — so no one has to travel for every step.",
  },
];
      ...
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-primary-foreground/70 text-lg leading-relaxed mb-4">
            If you work with senior clients who will need to make property decisions as part of a life transition, Medicaid plan, or estate matter, David Stein welcomes the conversation.
          </p>
