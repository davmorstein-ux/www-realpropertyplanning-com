...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "As both a licensed Washington State real estate broker and a state-certified residential appraiser, we provide pricing grounded in actual condition assessment and neighborhood-level market data — not automated estimates. This is especially valuable in Tacoma, where property values can vary significantly from one neighborhood to the next.",
  },
  {
    question: "Can you get help if I live out of state but the property is in Tacoma?",
    answer:
      "Yes. our team regularly works with out-of-state executors and family members managing Tacoma properties remotely. We coordinate property access, vendor management, preparation, and the sale process — keeping you informed at every step so you don't need to make unnecessary trips.",
  },
  {
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">
              We serve as a local point of coordination. We manage property access, works with cleanout crews, contractors, and preparation vendors, communicates with attorneys and other parties, and keep you informed throughout the process — reducing unnecessary travel and giving you confidence that nothing is falling through the cracks.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed">
              Whether you're managing from Portland, Phoenix, or across the country, our goal is to make the process as clear and manageable as possible from wherever you are.
            </p>
          </div>
        </div>
      </section>
