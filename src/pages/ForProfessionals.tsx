...
const ForProfessionals = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <HeroBandTitle as="h1">Real Estate Support for Professional Partners</HeroBandTitle>
