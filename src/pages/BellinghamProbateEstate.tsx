...
const faqs = [
  {
    ...
    answer:
      `Yes. ${FEATURED_BROKER.Role} regularly works with families managing Bellingham properties from Seattle, out of state, or farther. ${FEATURED_BROKER.pronoun.Subject} coordinates property access, vendor management, preparation, and the sale process — keeping you informed without requiring unnecessary trips.`,
  },
  {
  ...
  },
  {
    ...
    answer:
      `As both a licensed Washington State real estate broker and a state-certified residential appraiser, ${FEATURED_BROKER.role} provides pricing grounded in actual condition assessment and local market data. This is especially important in Bellingham, where unique property types and location-specific factors can significantly affect value.`,
  },
  {
    question: "Should I prepare an inherited Bellingham home before selling?",
    answer:
      `It depends on the property's condition, your timeline, and your goals. ${FEATURED_BROKER.Role} evaluates which improvements are likely to return more than they cost — and which aren't worth the investment. For families managing from a distance, this honest assessment saves both time and money.`,
  },
  {
    question: "How long does it typically take to sell an estate property in Bellingham?",
    answer:
      `Timelines depend on the probate or trust process, property condition, and seasonal market factors. Once the property is ready and legal authority is established, well-priced Bellingham homes generally sell within a reasonable timeframe. ${FEATURED_BROKER.Role} helps set realistic expectations based on your specific situation.`,
  },
  {
    question: "What if the inherited property is a second home or vacation property?",
    answer:
      `Second homes and vacation properties are common in the Bellingham area. These properties may have deferred maintenance, shared ownership, or unique characteristics that affect pricing. ${FEATURED_BROKER.Role} assesses the property's condition and market positioning to develop a strategy that accounts for these factors.`,
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              As both a licensed Washington State real estate broker and a state-certified residential appraiser, {FEATURED_BROKER.role} brings a valuation-first perspective grounded in actual property condition and comparable market data — not automated estimates that miss Bellingham's local nuances.
            </p>
          </div>
        </div>
      </section>
      ...
      <MidPageCTA
        ...
        body={`${FEATURED_BROKER.name}, a licensed real estate broker, offers confidential property consultations for executors, trustees, and families dealing with inherited or estate property in Bellingham and Whatcom County — whether you're local or managing from out of the area.`}
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">
              {FEATURED_BROKER.Role} serves as your local point of coordination — visiting the property, assessing its condition, managing cleanout crews and contractors, and communicating with attorneys and family members. The goal is to reduce the logistical burden so you can make informed decisions without unnecessary stress or travel.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed">
              For second homes and vacation properties, there are often additional considerations — seasonal access, shared ownership, deferred maintenance, or unique features that affect marketability. {FEATURED_BROKER.Role} evaluates these factors honestly and builds a strategy around the property's actual condition and positioning.
            </p>
          </div>
        </div>
      </section>
              ...
              {[
                {
                  ...
                  desc: `${FEATURED_BROKER.Role} starts with a conversation about the property, the people involved, the legal context, and what you're hoping to accomplish — whether that's a straightforward sale or something that requires more coordination.`,
                },
                {
