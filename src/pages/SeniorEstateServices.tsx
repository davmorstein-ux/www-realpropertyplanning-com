    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 md:py-16 lg:py-[84px] bg-secondary">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-8">
          ...
          <p className="text-muted-foreground text-[16px] leading-relaxed mb-6 max-w-3xl">
            When a family inherits a home, the path forward is rarely straightforward. {FEATURED_BROKER.Role} guides executors and heirs through pricing, preparation, and sale of inherited homes so the estate can be settled with clarity and minimal stress — whether the property is down the street or across the state.
          </p>
          <ul className="space-y-3 max-w-2xl">
            {[
      ...
      <section className="py-12 md:py-16 lg:py-[84px] bg-background">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-8">
          ...
          <p className="text-muted-foreground text-[16px] leading-relaxed mb-6 max-w-3xl">
            Probate property sales involve court timelines, legal documentation, and coordination with attorneys and personal representatives. {FEATURED_BROKER.Role} works alongside probate attorneys and personal representatives to market and sell property within court and estate timelines, while respecting legal requirements at every stage.
          </p>
          <ul className="space-y-3 max-w-2xl">
            {[
      ...
      <MidPageCTA
        ...
        body={`Whether you are a senior planning a move, a family member coordinating a sale, or an attorney advising a client — ${FEATURED_BROKER.Role} welcomes a confidential conversation.`}
      ...
      <section className="py-12 md:py-16 lg:py-[84px] bg-secondary">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-8">
          ...
          <p className="text-muted-foreground text-[16px] leading-relaxed mb-6 max-w-3xl">
            Before making any decision about selling, you need to understand what the property is worth and what your options look like. {FEATURED_BROKER.Role} provides clear, data‑driven opinions of value and market conditions for seniors, executors, and attorneys who need to understand their options before committing to a sale.
          </p>
          <ul className="space-y-3 max-w-2xl">
            {[
        ...
        <div className="max-w-[1100px] mx-auto px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-primary-foreground/75 text-lg leading-relaxed mb-8">
              Whether you are a senior planning a move, a family member coordinating a sale, an executor managing an estate, or an attorney advising a client — {FEATURED_BROKER.Role} welcomes a confidential conversation about your situation. There is no obligation and no sales pressure.
            </p>
