...
const HowToMoveElderlyParents = () => (
  <>
    ...
    <main id="main-content">
      {/* Hero */}
      <HeroBandTitle as="h1">How to Move Elderly Parents Out of Their Home in Washington State</HeroBandTitle>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-14 pt-10 border-t border-border">
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                <Link to="/contact?reason=aging-parent" className="text-accent hover:text-gold underline underline-offset-4">Contact us</Link> for a confidential conversation about your family's situation.
              </p>
            </div>
          </div>
        </div>
