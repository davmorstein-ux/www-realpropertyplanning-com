      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Services", url: "https://realpropertyplanning.com/services" },
          {
            ...
            url: "https://realpropertyplanning.com/sell-house-fund-senior-living",
          },
        ]}
      />
      <Header />
        ...
        <section className="pt-3 md:pt-4 pb-14 md:pb-16 bg-primary">
          <div className="container px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              <img src={fundSeniorLivingIcon} alt="" aria-hidden="true" className="mx-auto max-w-[18rem] w-full h-auto object-contain mb-4" loading="lazy" style={{ opacity: 1, filter: 'none', mixBlendMode: 'normal', background: 'transparent' }} sizes="100vw" decoding="async"/>
