...
const PowerOfAttorneys = () => {
  ...
  const [spherePositions, setSpherePositions] = useState<
    { key: string; left: number; top: number; row: number; col: number }[]
  >([]);
  ...
  useLayoutEffect(() => {
    ...
    const measure = () => {
      ...
      const sorted = cards
        .map((c) => ({ rect: c.getBoundingClientRect() }))
        .sort((a, b) => a.rect.top - b.rect.top || a.rect.left - b.rect.left);
      sorted.forEach((card) => {
        const last = rows[rows.length - 1];
        if (!last || Math.abs(card.rect.top - last.top) > 8) {
  ...
  const isSphereNearTile = useCallback(
    (sphere: { row: number; col: number }, tileIndex: number) => {
      const tileRow = Math.floor(tileIndex / colCount);
      const tileCol = tileIndex % colCount;
      return (
        (sphere.row === tileRow || sphere.row === tileRow - 1) && (sphere.col === tileCol || sphere.col === tileCol - 1)
      );
    },
    [colCount],
  );
          ...
          <div className="container px-6 lg:px-8">
            <div className="max-w-[1100px] mx-auto">
              ...
              <div className="space-y-5 text-muted-foreground text-base md:text-[17px] leading-relaxed">
                <p>
                  A power of attorney is a legal document that allows one person — the "agent" or "attorney-in-fact" —
                  to act on behalf of another person, known as the "principal." It's one of the most important planning
                  tools available, especially when someone may not be able to manage their own affairs in the future.
                </p>
                <p>
                ...
                <p>
                  In real estate, a power of attorney can authorize an agent to list a property, sign contracts,
                  coordinate with title and escrow, and close a sale — all on behalf of the homeowner. It's a practical
                  tool that keeps things moving when life circumstances make direct involvement difficult or impossible.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-6 lg:px-8">
            <div className="max-w-[1100px] mx-auto">
              ...
              <p className="text-muted-foreground text-base md:text-[17px] leading-relaxed mb-8">
                Most people don't think about a power of attorney until they need one. But in practice, these situations
                come up more often than families expect — and they usually arrive under pressure.
              </p>
              <div className="relative">
                <div ref={gridRef} className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  {poaTiles.map((tile, index) => (
                    <div
                      key={tile.title}
                      className="tile-white group block h-full min-h-[180px]"
                    ...
                    >
                      ...
                      <p className="text-base leading-relaxed text-muted-foreground">{tile.description}</p>
                    </div>
                  ))}
                </div>
        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container px-6 lg:px-8">
            <div className="max-w-[1100px] mx-auto">
              ...
              <p className="text-muted-foreground text-base md:text-[17px] leading-relaxed mb-8">
                Selling a property under a power of attorney isn't the same as a standard sale. There are additional
                documentation requirements, coordination steps, and potential complications that require experience and
                attention to detail.
              </p>
              <div className="space-y-5 text-muted-foreground text-base md:text-[17px] leading-relaxed">
                <p>
                ...
                <p>
                  ...
                  financing the purchase, the lender's underwriting team may also need to review and approve the POA
                  before the loan can close. This can add time to the process.
                </p>
                <p>
                  <strong className="text-foreground">Proper documentation.</strong> The POA must be current, properly
                  executed, and specific enough to cover real estate transactions. Vague or outdated documents are one
                  of the most common reasons for delays or rejected closings.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24 bg-secondary">
          <div className="container px-6 lg:px-8">
            <div className="max-w-[1100px] mx-auto">
              ...
              <p className="text-muted-foreground text-base md:text-[17px] leading-relaxed mb-8">
                These situations are manageable — but only when you know what to expect. Here are the challenges
                families and agents encounter most often.
              </p>
              <div className="relative grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div
                  className="tile-white group block h-full min-h-[160px]"
                  style={{
                    background: "#fff",
                    borderRadius: 12,
                    boxShadow: "0 2px 12px rgba(0,0,0,0.06)",
                ...
                >
                  ...
                  <p className="text-base leading-relaxed text-muted-foreground">
                    A POA created years ago may not meet current legal standards or may lack the specific language
                    needed for real estate transactions. Reviewing and updating the document early can prevent delays
                    later.
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  <p className="text-base leading-relaxed text-muted-foreground">
                    Delays in obtaining, recording, or verifying a POA can stall a transaction. In time-sensitive
                    situations, getting the document in order early is critical to keeping everything on track.
                  </p>
                </div>
              ...
              <div className="grid gap-6 md:grid-cols-3">
                <div className="card-3d px-6 py-8">
                  ...
                  <p className="text-muted-foreground text-[15px] leading-relaxed mb-3">
                    If you're helping a loved one who can no longer manage their property, you're not alone. Many
                ...
                <div className="card-3d px-6 py-8">
                  ...
                  <p className="text-muted-foreground text-[15px] leading-relaxed mb-3">
                    If you've been named as an agent under a power of attorney — or you're serving as executor or
              ...
              <div className="space-y-10">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-base md:text-[17px] leading-relaxed">
                    ...
                    prepare ahead of time so the closing process stays on schedule.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 md:py-24 bg-secondary">
          <div className="container px-6 lg:px-8">
            <div className="max-w-[1100px] mx-auto">
              ...
              <div className="space-y-5 text-muted-foreground text-base md:text-[17px] leading-relaxed">
                <p>
                  Selling property under a power of attorney isn't a routine transaction. It requires careful
                  coordination between attorneys, title companies, escrow officers, lenders, and sometimes the courts.
                  Every party involved has documentation standards — and if any of them reject the POA or require
