...
const faqs = [
  { question: "What should I do first with an inherited home in Kent?", answer: "Secure the property, confirm your legal authority, and get an honest assessment of its condition and value. our team can visit the home, evaluate what affects its marketability, and outline your options clearly before you make any decisions." },
  { question: "How does an appraisal background help in Kent?", answer: "As both a licensed Washington State real estate broker and a state-certified residential appraiser, we provide pricing based on actual property condition and comparable sales — not automated estimates. In Kent, where home ages and conditions vary block by block, this dual perspective is especially valuable." },
  { question: "What if siblings disagree about selling?", answer: "This happens often. We provide objective, condition-based information — realistic value, preparation costs, and available options — so every family member works from the same facts. Clear data usually helps conversations move forward." },
  { question: "Should I fix up a Kent inherited home before selling?", answer: "It depends on the property. We evaluate which improvements are likely to pay for themselves and which aren't worth the cost or delay. Many Kent inherited homes sell well with targeted preparation rather than major renovation." },
  { question: "Can you get help if I live outside Kent?", answer: "Yes. We work with families managing properties from across Washington, out of state, and overseas. We coordinate property access, vendor management, and the sale process so you don't need to make repeated trips." },
  { question: "How long does it take to sell an inherited home in Kent?", answer: "Timelines vary based on the legal process, condition, and preparation. Once the property is ready and authority is established, well-priced Kent homes typically attract interest within a few weeks. We help set realistic expectations from the beginning." },
];
