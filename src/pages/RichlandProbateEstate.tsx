...
const faqs = [
  ...
  },
  {
    ...
    answer: "As both a licensed Washington State real estate broker and a state-certified residential appraiser, we provide pricing grounded in actual condition assessment and local comparable data. In Richland, where homes tend to be well-built but may need cosmetic updating, this dual perspective ensures pricing reflects reality rather than outdated assumptions.",
  },
  {
    question: "Should I update a Richland home before selling?",
    answer: "It depends on the home's condition relative to buyer expectations in the neighborhood. We evaluate which updates are likely to return more than they cost and which aren't necessary. In Richland's more established neighborhoods, targeted cosmetic improvements can make a meaningful difference — but not every update is worth the investment.",
  },
  {
    question: "Can you get help if I live outside the Tri-Cities?",
    answer: "Yes. We work with executors and families who live outside the area — whether across the state or out of state. We coordinate property access, vendor management, preparation, and the sale process so you can make decisions without unnecessary travel.",
  },
  {
    question: "What if the estate involves a long-term family home?",
    answer: "Long-term ownership is common in Richland. These homes often carry sentimental value alongside practical considerations. We provide an honest, respectful assessment of the property's condition and market position, giving families the facts they need to make decisions at their own pace.",
  },
  {
    question: "How long does it take to sell an estate property in Richland?",
    answer: "Timelines depend on the legal process, property condition, and preparation needs. Once the home is ready and authority is established, well-priced Richland properties typically attract interest within a reasonable timeframe. We help set realistic expectations based on your specific situation.",
  },
];
...
const RichlandProbateEstate = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <HeroBandTitle as="h1">Thoughtful Guidance for Estate Property in Richland</HeroBandTitle>
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">
              We provide that structure. We coordinate with family members, manages vendors and preparation logistics, communicates with attorneys when needed, and keep everyone informed with clear, consistent updates. The goal is a process that feels steady and well-managed from start to finish.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed">
