...
const faqs = [
  ...
  },
  {
    ...
    answer:
      `Reach out directly — ${FEATURED_BROKER.name}, a Washington State licensed broker and certified appraiser, tracks Everett and broader Snohomish County AFH inventory and can notify you when a matching listing comes to market.`,
  },
];
