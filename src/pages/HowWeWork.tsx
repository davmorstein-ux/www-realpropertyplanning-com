...
const contentBlocks = [
  ...
  },
  {
    ...
    text: `${FEATURED_BROKER.Role} brings dual experience as a real estate broker and Washington state certified residential appraiser, adding depth to questions of value, marketability, and sale strategy during estate-related property transitions.`,
  },
  {
...
const HowWeWork = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <HeroBandTitle as="h1">How Real Property Planning Works With Attorneys, Executors, Trustees, and Families</HeroBandTitle>
          ...
          <div className="max-w-[1140px] mx-auto">
            ...
            <div className="mt-16 bg-card border border-border rounded-[18px] px-7 py-9 md:px-10 md:py-11 text-center">
              ...
              <p className="text-muted-foreground leading-relaxed text-base md:text-lg max-w-3xl mx-auto mb-8">
                If you are an attorney, executor, trustee, fiduciary, or family member navigating probate property, inherited real estate, or trust-owned property anywhere in Washington State, {FEATURED_BROKER.role} provides experienced real estate guidance grounded in market knowledge, valuation insight, and a practical understanding of complex property transitions.
              </p>
