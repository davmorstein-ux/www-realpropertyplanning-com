      ...
      <section className="-mt-3 lg:-mt-4 pb-6 lg:pb-8 text-center" style={{ background: 'radial-gradient(ellipse 70% 50% at center 30%, hsl(220 48% 17%), hsl(220 52% 10%) 55%, hsl(220 55% 8%) 100%)' }}>
        <div className="container px-6 lg:px-8">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-primary-foreground/90 text-[0.95rem] md:text-[1.05rem] leading-relaxed max-w-[28rem] mx-auto mb-6 motion-safe:animate-[text-emphasis-b_15s_ease-in-out_infinite]">
