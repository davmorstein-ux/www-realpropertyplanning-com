...
const studies = [
  {
    ...
    howHelped: `${FEATURED_BROKER.Role} assessed the property, coordinated a professional cleanout team, managed minor repairs and landscaping, and handled the entire listing and sale process — providing regular photo updates so she never had to fly out.`,
  ...
  },
  {
    ...
    howHelped: `${FEATURED_BROKER.Role} evaluated each issue, estimated the cost impact on market value, and recommended a targeted preparation strategy — addressing safety concerns while advising against costly renovations that would not deliver meaningful return.`,
  ...
  },
  {
    ...
    howHelped: `${FEATURED_BROKER.Role} recommended a phased approach: start with a gentle cleanout, address targeted improvements, and list at a time aligned with the transition. ${FEATURED_BROKER.Role} coordinated vendors and kept everyone informed throughout.`,
  ...
  },
  {
    ...
    howHelped: `${FEATURED_BROKER.Role} conducted a thorough property review and provided a condition-based pricing strategy — walking the executor through comparable sales, condition adjustments, and current market trends.`,
