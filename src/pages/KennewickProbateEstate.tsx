...
const faqs = [
  {
    ...
    answer: `Secure the property, confirm your legal authority to act, and get an honest assessment of its condition and market value. ${FEATURED_BROKER.Role} can walk through the home, identify what affects value, and help you understand your options before you commit to anything.`,
  },
  {
    question: "How does an appraisal background help in Kennewick?",
    answer: `As both a licensed Washington State real estate broker and a state-certified residential appraiser, ${FEATURED_BROKER.role} provides pricing based on actual property condition and local comparable data — not automated estimates. In Kennewick, where condition varies widely and pricing is sensitive, this dual perspective prevents costly mistakes.`,
  },
  {
    question: "Should I renovate a Kennewick inherited home before selling?",
    answer: `Not always. ${FEATURED_BROKER.Role} evaluates which improvements are likely to return more than they cost — and which aren't worth the investment. Many Kennewick inherited homes benefit more from targeted preparation and honest pricing than from expensive renovations.`,
  },
  {
    question: "What if family members disagree about selling?",
    answer: `This is common. ${FEATURED_BROKER.Role} provides objective, condition-based information — realistic market value, preparation costs, and available options — so every family member is working from the same set of facts. That clarity often helps move conversations forward.`,
  },
  {
    question: "Can you get help if I don't live in Kennewick?",
    answer: `Yes. ${FEATURED_BROKER.Role} regularly works with executors and family members who live outside the Tri-Cities. ${FEATURED_BROKER.pronoun.Subject} coordinates property access, vendor management, and the sale process so you can make informed decisions without unnecessary travel.`,
  },
  {
    question: "How long does it take to sell an inherited home in Kennewick?",
    answer: `Timelines depend on the probate or trust process, property condition, and market conditions. Once the home is ready and legal authority is established, well-priced Kennewick properties generally sell within a reasonable timeframe. ${FEATURED_BROKER.Role} helps set realistic expectations from the start.`,
  },
];
...
const KennewickProbateEstate = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <HeroBandTitle as="h1">Practical Guidance for Family-Held Property in Kennewick</HeroBandTitle>
        ...
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              As both a licensed Washington State real estate broker and a state-certified residential appraiser, {FEATURED_BROKER.role} evaluates inherited properties based on their actual condition, not assumptions. This valuation-first approach helps families make preparation and pricing decisions grounded in facts rather than guesswork.
            </p>
          </div>
        </div>
      </section>

      <MidPageCTA heading="Questions About a Kennewick Property?" body={`${FEATURED_BROKER.name}, a licensed real estate broker, offers confidential property consultations for executors, trustees, and families handling inherited or estate property in Kennewick and the Tri-Cities area.`} buttonText="Schedule a Consultation" microcopy="No pressure. Just practical guidance on the property questions." />
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              From there, {FEATURED_BROKER.role} manages the practical steps — coordinating cleanout crews, overseeing targeted repairs, and handling the logistics of getting the property ready and sold — so the family can focus on the decisions that matter most.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <ol className="space-y-6">
              {[
                { title: "Understanding the Situation", desc: `${FEATURED_BROKER.Role} starts with a conversation about the property, the family, and what needs to happen. No assumptions — just listening and asking the right questions.` },
