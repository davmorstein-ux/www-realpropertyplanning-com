...
const faqs = [
  {
    ...
    answer:
      "Selling inherited property in Kirkland typically requires legal authority through probate or trust administration. We coordinate with the estate attorney, trustee, or personal representative to assess the property, develop a defensible pricing strategy, manage preparation, and guide the sale — keeping all parties informed throughout the process.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "As both a licensed Washington State real estate broker and a state-certified residential appraiser, we provide pricing strategy grounded in actual condition assessment and neighborhood-level market analysis. In Kirkland's higher-value market, this dual perspective helps protect families and fiduciaries from costly pricing mistakes.",
  },
  {
    question: "Can you get help if the family is downsizing or transitioning into senior living?",
    answer:
      "Yes. Many Kirkland families reach out when a parent is moving into assisted living, independent living, or memory care. We help coordinate the timing of the property sale with the transition, working with families, care professionals, and attorneys to keep the process organized and manageable.",
  },
  {
    question: "What if multiple family members are involved in the decision?",
    answer:
      "Multi-party situations are common in Kirkland estate and trust sales. We provide clear, documented communication so all parties — whether local or out of state — have the same information. Pricing grounded in certified appraisal methodology also helps establish defensible value when consensus is needed.",
  },
  {
    question: "How long does it take to sell an estate property in Kirkland?",
    answer:
      "Timelines depend on the legal process, property condition, and preparation needs. Once the property is ready and authority is established, well-priced Kirkland homes typically sell within a few weeks. We help set realistic expectations and builds a plan around your specific situation and constraints.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <MidPageCTA
        ...
        body={`${FEATURED_BROKER.name}, a licensed real estate broker, offers confidential property consultations for executors, attorneys, trustees, and families handling inherited or estate property in Kirkland and throughout King County.`}
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">
              We work with families to coordinate the timing of the property sale with the transition itself, ensuring that move plans, care arrangements, and sale preparation are aligned. We also communicate clearly with all family members and professionals involved, reducing confusion and keeping the process moving forward.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed">
