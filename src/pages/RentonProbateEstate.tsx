...
const faqs = [
  ...
  { question: "How does our team's appraisal background help in Renton?", answer: "As both a licensed Washington State real estate broker and a state-certified residential appraiser, David Stein provides pricing based on actual property condition and local comparable data — not automated estimates. In Renton, where neighborhoods and conditions vary widely, this dual perspective prevents costly pricing mistakes." },
