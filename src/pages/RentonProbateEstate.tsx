...
const faqs = [
  { question: "What should I do first with an inherited home in Renton?", answer: `Secure the property, confirm your legal authority to act, and get an honest assessment of condition and market value. ${FEATURED_BROKER.Role} can walk through the property, identify what affects value, and help you understand your options before committing to anything.` },
  { question: "How does an appraisal background help in Renton?", answer: `As both a licensed Washington State real estate broker and a state-certified residential appraiser, ${FEATURED_BROKER.role} provides pricing based on actual property condition and local comparable data — not automated estimates. In Renton, where neighborhoods and conditions vary widely, this dual perspective prevents costly pricing mistakes.` },
  { question: "Should I renovate before selling an inherited Renton home?", answer: `Not always. ${FEATURED_BROKER.Role} evaluates which improvements are likely to return more than they cost — and which aren't worth the investment. Many inherited homes benefit more from targeted preparation and honest pricing than from expensive renovations.` },
  { question: "What if family members live in different places?", answer: `This is common. ${FEATURED_BROKER.Role} coordinates with family members across locations, provides clear information everyone can review, and manage the local logistics so decisions can move forward without requiring everyone to be present.` },
  { question: "Can you get help if I don't live in Renton?", answer: `Yes. ${FEATURED_BROKER.Role} regularly works with executors and families managing properties remotely. ${FEATURED_BROKER.pronoun.Subject} handles property access, vendor coordination, and the sale process so you can make informed decisions without unnecessary travel.` },
  { question: "How long does it take to sell an inherited home in Renton?", answer: `Timelines depend on the probate or trust process, property condition, and preparation needs. Once the home is ready and authority is established, well-priced Renton properties generally sell within a reasonable timeframe. ${FEATURED_BROKER.Role} sets realistic expectations from the start.` },
];
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">As both a licensed Washington State real estate broker and a state-certified residential appraiser, {FEATURED_BROKER.role} evaluates inherited properties based on their actual condition and neighborhood context. This means pricing grounded in facts — not assumptions — which helps families avoid the cost of overpricing or the regret of underpricing.</p>
          </div>
        </div>
      </section>
