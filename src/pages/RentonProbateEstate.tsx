...
const faqs = [
  ...
  { question: "How does David's appraisal background help in Renton?", answer: "As both a licensed Washington State real estate broker and a state-certified residential appraiser, David provides pricing based on actual property condition and local comparable data — not automated estimates. In Renton, where neighborhoods and conditions vary widely, this dual perspective prevents costly pricing mistakes." },
  { question: "Should I renovate before selling an inherited Renton home?", answer: "Not always. David evaluates which improvements are likely to return more than they cost — and which aren't worth the investment. Many inherited homes benefit more from targeted preparation and honest pricing than from expensive renovations." },
  { question: "What if family members live in different places?", answer: "This is common. David coordinates with family members across locations, provides clear information everyone can review, and manages the local logistics so decisions can move forward without requiring everyone to be present." },
  { question: "Can David help if I don't live in Renton?", answer: "Yes. David regularly works with executors and families managing properties remotely. He handles property access, vendor coordination, and the sale process so you can make informed decisions without unnecessary travel." },
  { question: "How long does it take to sell an inherited home in Renton?", answer: "Timelines depend on the probate or trust process, property condition, and preparation needs. Once the home is ready and authority is established, well-priced Renton properties generally sell within a reasonable timeframe. David sets realistic expectations from the start." },
];
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">As both a licensed Washington State real estate broker and a state-certified residential appraiser, David Stein evaluates inherited properties based on their actual condition and neighborhood context. This means pricing grounded in facts — not assumptions — which helps families avoid the cost of overpricing or the regret of underpricing.</p>
          </div>
        </div>
      </section>

      <MidPageCTA heading="Questions About a Renton Property?" body="David provides confidential consultations for executors, trustees, and families handling inherited or estate property in Renton and South King County." buttonText="Schedule a Consultation" microcopy="No pressure. Just practical guidance for your situation." />
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">David provides the structure — an honest property assessment, a realistic pricing strategy, and a clear sequence of next steps that everyone can understand. From there, he manages the preparation logistics, vendor coordination, and communication so the family can focus on making decisions rather than managing details.</p>
            <p className="text-muted-foreground text-lg leading-relaxed">Whether the transition involves a straightforward sale or a more complex situation — like a parent moving to care while the home is prepared — David keeps the process organized and on track.</p>
          </div>
        </div>
      </section>
