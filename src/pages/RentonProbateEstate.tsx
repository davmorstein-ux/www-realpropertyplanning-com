...
const faqs = [
  ...
  { question: "How does an appraisal background help in Renton?", answer: "As both a licensed Washington State real estate broker and a state-certified residential appraiser, we provide pricing based on actual property condition and local comparable data — not automated estimates. In Renton, where neighborhoods and conditions vary widely, this dual perspective prevents costly pricing mistakes." },
  { question: "Should I renovate before selling an inherited Renton home?", answer: "Not always. We evaluate which improvements are likely to return more than they cost — and which aren't worth the investment. Many inherited homes benefit more from targeted preparation and honest pricing than from expensive renovations." },
  { question: "What if family members live in different places?", answer: "This is common. We coordinate with family members across locations, provides clear information everyone can review, and manage the local logistics so decisions can move forward without requiring everyone to be present." },
  { question: "Can you get help if I don't live in Renton?", answer: "Yes. our team regularly works with executors and families managing properties remotely. We handle property access, vendor coordination, and the sale process so you can make informed decisions without unnecessary travel." },
