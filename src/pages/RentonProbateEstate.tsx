...
const RentonProbateEstate = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="Probate Real Estate & Estate Sales in Renton, WA | Real Property Planning" description="Probate, inherited property, and senior transition real estate guidance for executors, trustees, and families in Renton, King County, Washington — from valuation through closing." />
