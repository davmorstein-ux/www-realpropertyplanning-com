  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <MidPageCTA
        ...
        body="We provide confidential consultations for executors, attorneys, trustees, and families handling inherited or estate property in Redmond and throughout King County."
