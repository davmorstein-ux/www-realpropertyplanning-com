  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <MidPageCTA
        ...
        body="David Stein, a licensed real estate broker, offers confidential property consultations for executors, attorneys, trustees, and families handling inherited or estate property in Redmond and throughout King County."
