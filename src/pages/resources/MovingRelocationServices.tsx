          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-secondary border border-border rounded-xl px-6 py-8 md:px-8 text-center">
              <p className="text-muted-foreground text-base leading-relaxed">
                David Stein is currently compiling a list of recommended moving and relocation services throughout Washington State. Check back soon, or <Link to="/contact" className="text-accent hover:text-gold underline underline-offset-4">Contact us</Link> for a current referral.
              </p>
            </div>
