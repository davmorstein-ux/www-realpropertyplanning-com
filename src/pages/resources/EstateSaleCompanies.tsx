...
const EstateSaleCompanies = () => (
  <>
    ...
    <main id="main-content">
      <HeroBandTitle as="h1">Estate Sale Companies</HeroBandTitle>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-secondary border border-border rounded-xl px-6 py-8 md:px-8 text-center">
              <p className="text-muted-foreground text-base leading-relaxed">
                We are currently compiling a list of recommended estate sale companies throughout Washington State. Check back soon, or <Link to="/contact" className="text-accent hover:text-gold underline underline-offset-4">Contact us</Link> for a current referral.
              </p>
            </div>
