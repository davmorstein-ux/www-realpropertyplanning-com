...
import heroImage from "@/assets/probate-educational-guide-hero.webp";
import {
  Collapsible,
  CollapsibleTrigger,
  CollapsibleContent,
...
/>
    ...
    <MidPageCTA
      ...
      body="A short conversation with David Stein can help you understand where you are in the process and what steps make sense next."
