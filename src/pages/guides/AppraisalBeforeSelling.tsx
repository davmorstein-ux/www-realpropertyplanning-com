...
const faqs = [
  ...
  { question: "What is the difference between an appraisal and a CMA?", answer: "An appraisal is a formal, independent opinion of value performed by a licensed appraiser following strict professional standards. A CMA (comparative market analysis) is an informal estimate prepared by a real estate broker based on recent sales. David Stein's dual credentials allow him to provide market analysis with appraisal-level rigor." },
...
const AppraisalBeforeSelling = () => (
  <div className="min-h-screen bg-background">
    ...
    <MidPageCTA
      ...
      body="David Stein can help you determine whether a formal appraisal or a professional market assessment is the right approach for your situation — and explain the practical difference."
