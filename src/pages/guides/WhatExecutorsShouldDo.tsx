...
const faqs = [
  ...
  { question: "Should I clean out the home before getting it assessed?", answer: "Not necessarily. A broker experienced in estate property can assess the home in its current condition. In fact, seeing the property before cleanout helps David Stein understand the full scope of work needed and provide more accurate timeline and cost estimates." },
  { question: "What if I live out of state?", answer: "Many executors manage properties from a distance. David Stein serves as the local point of contact — coordinating property access, vendor management, preparation, and the sale process while keeping you informed through regular updates. Learn more about out-of-state property coordination." },
  { question: "How do I know if the property needs repairs before selling?", answer: "David Stein evaluates each potential repair or improvement through a return-on-investment lens, informed by our certified appraisal background. Some improvements significantly increase sale price; others are not worth the cost or delay. This analysis helps you make smart decisions with estate funds." },
];
  ...
  <div className="min-h-screen bg-background">
      ...
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground leading-relaxed">
            David Stein's dual background as a broker and <Link to="/why-valuation-matters" className="text-accent hover:text-gold underline underline-offset-4">certified residential appraiser</Link> means you get valuation insight grounded in professional methodology — not guesswork.
          </p>
        </div>
      </div>
    </section>
    ...
    <section className="py-10 bg-background">
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <ProofCallout
            quote="We didn't know where to start. David Stein made the entire process manageable and kept us informed every step of the way."
    ...
    <MidPageCTA
      ...
      body="Most executors are doing this for the first time. A short conversation with David Stein can help you understand your options, assess the property, and plan practical next steps."
    ...
    <section className="py-16 lg:py-24 bg-background">
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            The key question is which improvements are worth the investment. A $5,000 kitchen cleanup might add $15,000 in sale price. A $40,000 renovation might add only $20,000. David Stein evaluates each potential improvement using our appraisal background to estimate the likely return — helping you spend estate funds wisely.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            David Stein coordinates the entire preparation process — scheduling <Link to="/resources/estate-sale-companies" className="text-accent hover:text-gold underline underline-offset-4">estate sale companies</Link>, cleanout crews, handymen, and <Link to="/resources/property-preparation-services" className="text-accent hover:text-gold underline underline-offset-4">property preparation services</Link> — so you don't have to manage contractors yourself.
          </p>
        </div>
      </div>
    </section>
    ...
    <section className="py-16 lg:py-24 bg-secondary">
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            David Stein acts as a single point of contact for the real estate side of the equation — communicating clearly with all parties, providing regular updates, and ensuring that decisions are documented and defensible. This reduces the executor's communication burden and keeps the process moving forward.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            Learn more about how David Stein works with <Link to="/for-attorneys" className="text-accent hover:text-gold underline underline-offset-4">attorneys and fiduciaries</Link> or explore the <Link to="/how-the-process-works" className="text-accent hover:text-gold underline underline-offset-4">full sale process from consultation to closing</Link>.
          </p>
        </div>
      </div>
    </section>
    ...
    <section className="py-20 lg:py-28 bg-primary">
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link to="/contact"><Button variant="gold" size="lg"><img src={iconPhone3d} alt="" aria-hidden="true" className="w-5 h-5 mr-2 object-contain shrink-0"  loading="lazy" sizes="100vw" decoding="async"/>Schedule a Conversation</Button></Link>
        </div>
      </div>
    </section>
