...
const HowLongSellProbateProperty = () => (
  <div className="min-h-screen bg-background">
    ...
    <MidPageCTA
      ...
      body="Every situation is different. A short conversation with David Stein can help you understand where you are in the process and what realistic expectations look like."
