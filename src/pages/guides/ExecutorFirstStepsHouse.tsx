...
const ExecutorFirstStepsHouse = () => (
  <div className="min-h-screen bg-background">
    ...
    <MidPageCTA
      ...
      body="The first few weeks can feel overwhelming. A short conversation with David Stein can help you prioritize what matters most and understand the process ahead."
