...
const PricingHouseTrustEstate = () => (
  <div className="min-h-screen bg-background">
    ...
    <MidPageCTA
      ...
      body="David Stein's dual credentials as a broker and certified appraiser provide the pricing discipline that estate and trust property requires. A short conversation can help you understand your property's realistic market position."
