...
const TaxesSellingInheritedHouseWashington = () => (
  <div className="min-h-screen bg-background">
    ...
    <MidPageCTA
      ...
      body="An accurate valuation is the foundation for sound tax planning. David Stein can help you understand the property's current and historical value so you and your CPA can make informed decisions."
