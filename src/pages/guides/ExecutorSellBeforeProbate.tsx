...
const ExecutorSellBeforeProbate = () => (
  <div className="min-h-screen bg-background">
    ...
    <MidPageCTA
      ...
      body="Use this time wisely. A short conversation with David Stein can help you understand what to prepare now so you're ready to move forward as soon as legal authority is granted."
