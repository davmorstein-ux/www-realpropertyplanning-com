...
const faqs = [
  ...
  { question: "Can I sell an estate property as-is?", answer: `Yes. Selling as-is is always an option. However, properties sold as-is typically sell for less than prepared properties. ${FEATURED_BROKER.firstName} can help you compare the likely as-is sale price versus the likely price after targeted preparation, so you can make an informed decision.` },
