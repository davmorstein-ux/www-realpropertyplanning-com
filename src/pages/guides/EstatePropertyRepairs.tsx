...
const faqs = [
  ...
  { question: "Can I sell an estate property as-is?", answer: "Yes. Selling as-is is always an option. However, properties sold as-is typically sell for less than prepared properties. David Stein can help you compare the likely as-is sale price versus the likely price after targeted preparation, so you can make an informed decision." },
...
const EstatePropertyRepairs = () => (
  <div className="min-h-screen bg-background">
    ...
    <MidPageCTA
      ...
      body="David Stein evaluates each potential improvement through a return-on-investment lens, informed by our appraisal background. A short conversation can help you decide where estate funds are best spent."
