...
const faqs = [
  ...
  { question: "Can I sell an estate property as-is?", answer: `Yes. Selling as-is is always an option. However, properties sold as-is typically sell for less than prepared properties. ${FEATURED_BROKER.Role} can help you compare the likely as-is sale price versus the likely price after targeted preparation, so you can make an informed decision.` },
...
const EstatePropertyRepairs = () => (
  <div className="min-h-screen bg-background">
    ...
    <MidPageCTA
      ...
      body={`${FEATURED_BROKER.Role} evaluates each potential improvement through a return-on-investment lens, informed by his appraisal background. A short conversation can help you decide where estate funds are best spent.`}
