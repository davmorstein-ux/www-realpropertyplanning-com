...
const EstatePropertyRepairs = () => (
  <div className="min-h-screen bg-background">
    ...
    <MidPageCTA
      ...
      body="Our team evaluates each potential improvement through a return-on-investment lens, informed by our appraisal background. A short conversation can help you decide where estate funds are best spent."
