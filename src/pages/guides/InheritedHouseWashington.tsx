...
const faqs = [
  ...
  { question: "Should I sell an inherited house as-is?", answer: "It depends on the property's condition, your timeline, and the likely return on preparation investment. Some properties sell well as-is to investors or renovation buyers. Others benefit significantly from targeted preparation. Our team evaluates each situation individually and recommends the approach most likely to protect value." },
  { question: "How soon can I sell an inherited house in Washington?", answer: "Once legal authority is established (through probate, trust administration, or other means), the property can be listed for sale. Pre-listing preparation — assessment, cleanout, repairs — can begin earlier. Our team helps create a realistic timeline aligned with your specific circumstances." },
  { question: "What if there are multiple heirs who cannot agree?", answer: "Disagreements among heirs are common. Our team provides objective, data-driven market analysis that helps move conversations from opinion to evidence. For legal disputes, the estate attorney should be involved. Our team's role is to provide clear real estate data and professional guidance." },
  { question: "Do I need to go through probate to sell an inherited house?", answer: "Not always. Property held in a trust, joint tenancy, or with a transfer-on-death deed may pass outside of probate. The estate attorney can clarify the legal requirements. Our team can begin property assessment and planning regardless of the legal pathway." },
];
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {tiles.map((t) => (
              <div key={t.title} className="card-3d-blue block h-full">
