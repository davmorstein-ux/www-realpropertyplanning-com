...
const keyDifferences = [
  ...
  { title: "Patience Is Not Optional", text: "Some families need weeks or months to process the decision before the home can be listed. Rushing the timeline to meet a sales quota creates anxiety and damages trust. Our team works at the family's pace." },
];
