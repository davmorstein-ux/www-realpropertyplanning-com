...
const keyDifferences = [
  ...
  { title: "Patience Is Not Optional", text: "Some families need weeks or months to process the decision before the home can be listed. Rushing the timeline to meet a sales quota creates anxiety and damages trust. David Stein works at the family's pace." },
];
...
const faqs = [
  ...
  { question: "Can David Stein work with our senior move manager or care coordinator?", answer: "Absolutely. David Stein regularly collaborates with senior move managers, care coordinators, social workers, and placement specialists to ensure the real estate timeline supports the broader transition plan." },
  { question: "What if the senior is resistant to selling?", answer: "This is common and understandable. David Stein does not pressure anyone. He provides information, answers questions, and helps families understand their options — so the senior can participate in the decision at their own pace." },
  { question: "How does the home's condition affect the sale approach?", answer: "David Stein evaluates the property's condition and recommends a preparation strategy that balances cost, timeline, and likely return. Some homes benefit from targeted updates; others are better sold in their current condition to specific buyer pools." },
];
