...
const keyDifferences = [
  ...
  { title: "Patience Is Not Optional", text: "Some families need weeks or months to process the decision before the home can be listed. Rushing the timeline to meet a sales quota creates anxiety and damages trust. We work at the family's pace." },
];
  ...
  <div className="min-h-screen bg-background">
    ...
    <section className="py-10 bg-background">
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <ProofCallout
            quote="We appreciated Our patience, thoughtful communication, and realistic guidance throughout the sale of our family property."
