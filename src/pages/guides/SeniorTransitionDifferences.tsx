...
const keyDifferences = [
  ...
  { title: "Patience Is Not Optional", text: `Some families need weeks or months to process the decision before the home can be listed. Rushing the timeline to meet a sales quota creates anxiety and damages trust. ${FEATURED_BROKER.name} works at the family's pace.` },
];
...
const faqs = [
  ...
  { question: "What if the senior is resistant to selling?", answer: `This is common and understandable. ${FEATURED_BROKER.firstName} does not pressure anyone. ${FEATURED_BROKER.pronoun.Subject} provides information, answers questions, and help families understand their options — so the senior can participate in the decision at their own pace.` },
  { question: "How does the home's condition affect the sale approach?", answer: `${FEATURED_BROKER.name} evaluates the property's condition and recommends a preparation strategy that balances cost, timeline, and likely return. Some homes benefit from targeted updates; others are better sold in their current condition to specific buyer pools.` },
];
  ...
  <div className="min-h-screen bg-background">
    ...
    <section className="py-10 bg-background">
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <ProofCallout
            quote={`We appreciated ${FEATURED_BROKER.firstName}'s patience, thoughtful communication, and realistic guidance throughout the sale of our family property.`}
    ...
    <section className="py-20 lg:py-28 bg-primary">
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-primary-foreground/70 text-lg leading-relaxed mb-8">{FEATURED_BROKER.firstName} welcomes confidential conversations with families, care professionals, and their trusted advisors.</p>
