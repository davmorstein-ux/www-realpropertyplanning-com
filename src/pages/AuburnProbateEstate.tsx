...
const faqs = [
  ...
  { question: "How does our team's appraisal background help in Auburn?", answer: "As both a licensed Washington State real estate broker and a state-certified residential appraiser, Our team provides pricing grounded in actual property condition and local comparable sales. In Auburn, where condition is often the biggest variable in estate sales, this dual perspective prevents pricing mistakes that cost families time and money." },
  { question: "Should I clean out and fix up the home before listing?", answer: "It depends on the property. Our team evaluates what the home needs, what improvements are worth the investment, and what buyers in Auburn's market will accept as-is. The goal is to invest where it counts and avoid spending money on things that won't move the needle." },
  { question: "What if the property has significant deferred maintenance?", answer: "Many Auburn inherited homes do. Our team assesses the scope honestly — separating cosmetic issues from structural or mechanical concerns — and helps you understand how condition affects pricing. Sometimes a lower price with transparent disclosure is better than sinking money into repairs that won't fully recoup." },
  { question: "Can our team help if I live outside Auburn?", answer: "Yes. Our team works with families managing Auburn properties from across the state and out of state. He coordinates property access, cleanout crews, contractors, and the sale process so you don't need to make repeated trips." },
  { question: "How long does it take to sell an inherited home in Auburn?", answer: "Timelines depend on the legal process, condition, and preparation needs. Once the property is ready and authority is established, honestly priced Auburn homes typically sell within a reasonable timeframe. Our team helps set clear expectations from the start." },
];
...
const AuburnProbateEstate = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="Probate Real Estate & Estate Sales in Auburn, WA | Real Property Planning" description="Probate, inherited property, and senior transition real estate guidance for executors, trustees, and families in Auburn, King County, Washington — from valuation through closing." />
