...
const faqs = [
  { question: "What should I do first with an inherited home in Auburn?", answer: `Secure the property, confirm your legal authority, and get an honest assessment of its condition and realistic market value. ${FEATURED_BROKER.firstName} can visit the home, document what affects its value, and walk you through your options before you make any commitments.` },
  { question: "How does an appraisal background help in Auburn?", answer: `As both a licensed Washington State real estate broker and a state-certified residential appraiser, ${FEATURED_BROKER.name} provides pricing grounded in actual property condition and local comparable sales. In Auburn, where condition is often the biggest variable in estate sales, this dual perspective prevents pricing mistakes that cost families time and money.` },
  { question: "Should I clean out and fix up the home before listing?", answer: `It depends on the property. ${FEATURED_BROKER.name} evaluates what the home needs, what improvements are worth the investment, and what buyers in Auburn's market will accept as-is. The goal is to invest where it counts and avoid spending money on things that won't move the needle.` },
  { question: "What if the property has significant deferred maintenance?", answer: `Many Auburn inherited homes do. ${FEATURED_BROKER.name} assesses the scope honestly — separating cosmetic issues from structural or mechanical concerns — and help you understand how condition affects pricing. Sometimes a lower price with transparent disclosure is better than sinking money into repairs that won't fully recoup.` },
  { question: "Can you get help if I live outside Auburn?", answer: `Yes. ${FEATURED_BROKER.name} works with families managing Auburn properties from across the state and out of state. ${FEATURED_BROKER.pronoun.Subject} coordinates property access, cleanout crews, contractors, and the sale process so you don't need to make repeated trips.` },
  { question: "How long does it take to sell an inherited home in Auburn?", answer: `Timelines depend on the legal process, condition, and preparation needs. Once the property is ready and authority is established, honestly priced Auburn homes typically sell within a reasonable timeframe. ${FEATURED_BROKER.name} helps set clear expectations from the start.` },
];

const AuburnProbateEstate = () => {
  useEffect(() => {
    const faqSchema = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: faqs.map((f) => ({ "@type": "Question", name: f.question, acceptedAnswer: { "@type": "Answer", text: f.answer } })) };
    const localSchema = { ...hubOrganizationSchema, "@context": "https://schema.org", areaServed: [{ "@type": "City", name: "Auburn", containedInPlace: { "@type": "State", name: "Washington" } }, ...areaServed] };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <HeroBandTitle as="h1">Honest Guidance for Inherited Property in Auburn</HeroBandTitle>
      ...
      <section className="py-10 md:py-12 bg-background">
        <div className="container px-6 lg:px-8">
          ...
          <p className="text-muted-foreground leading-relaxed mb-5" style={{ fontSize: "18px" }}>
            Inherited homes in Auburn often come with real condition questions — deferred maintenance, years of accumulated belongings, and uncertainty about what the property is actually worth. An honest assessment is the best place to start.
          </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">As both a licensed Washington State real estate broker and a state-certified residential appraiser, Real Property Planning assesses inherited properties based on what they actually are — not what they used to be or what someone hopes they might be. That honesty is the foundation of every good decision that follows.</p>
          </div>
        </div>
      </section>

      <MidPageCTA heading="Have Questions About an Auburn Property?" body={`${FEATURED_BROKER.name}, a licensed real estate broker, offers confidential property consultations for executors, trustees, and families handling inherited or estate property in Auburn. Whether the home is in great shape or needs significant work, a conversation can help clarify your path.`} buttonText="Schedule a Consultation" microcopy="No pressure. Just practical guidance on the property questions." />
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">We take on that coordination. We manage the cleanout process, oversees targeted repairs, works with vendors, and keep the family updated on progress. Everything is documented, communicated clearly, and aligned with the pricing and preparation strategy.</p>
