...
const faqs = [
  { question: "What should I do first with an inherited home in Auburn?", answer: "Secure the property, confirm your legal authority, and get an honest assessment of its condition and realistic market value. David Stein can visit the home, document what affects its value, and walk you through your options before you make any commitments." },
  { question: "How does David Stein's appraisal background help in Auburn?", answer: "As both a licensed Washington State real estate broker and a state-certified residential appraiser, David Stein provides pricing grounded in actual property condition and local comparable sales. In Auburn, where condition is often the biggest variable in estate sales, this dual perspective prevents pricing mistakes that cost families time and money." },
  { question: "Should I clean out and fix up the home before listing?", answer: "It depends on the property. David Stein evaluates what the home needs, what improvements are worth the investment, and what buyers in Auburn's market will accept as-is. The goal is to invest where it counts and avoid spending money on things that won't move the needle." },
  { question: "What if the property has significant deferred maintenance?", answer: "Many Auburn inherited homes do. David Stein assesses the scope honestly — separating cosmetic issues from structural or mechanical concerns — and helps you understand how condition affects pricing. Sometimes a lower price with transparent disclosure is better than sinking money into repairs that won't fully recoup." },
  { question: "Can David Stein help if I live outside Auburn?", answer: "Yes. David Stein works with families managing Auburn properties from across the state and out of state. He coordinates property access, cleanout crews, contractors, and the sale process so you don't need to make repeated trips." },
  { question: "How long does it take to sell an inherited home in Auburn?", answer: "Timelines depend on the legal process, condition, and preparation needs. Once the property is ready and authority is established, honestly priced Auburn homes typically sell within a reasonable timeframe. David Stein helps set clear expectations from the start." },
];
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">David Stein takes on that coordination. He manages the cleanout process, oversees targeted repairs, works with vendors, and keeps the family updated on progress. Everything is documented, communicated clearly, and aligned with the pricing and preparation strategy.</p>
