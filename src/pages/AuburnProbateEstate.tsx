...
const faqs = [
  ...
  { question: "How does our team's appraisal background help in Auburn?", answer: "As both a licensed Washington State real estate broker and a state-certified residential appraiser, David Stein provides pricing grounded in actual property condition and local comparable sales. In Auburn, where condition is often the biggest variable in estate sales, this dual perspective prevents pricing mistakes that cost families time and money." },
