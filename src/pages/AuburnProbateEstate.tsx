...
const faqs = [
  ...
  { question: "Can David help if I live outside Auburn?", answer: "Yes. Our team works with families managing Auburn properties from across the state and out of state. He coordinates property access, cleanout crews, contractors, and the sale process so you don't need to make repeated trips." },
