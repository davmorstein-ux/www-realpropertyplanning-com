...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "our team uses our appraisal background to evaluate which repairs and improvements are likely to increase the sale price enough to justify the cost — and which ones aren't worth the investment. Sometimes selling as-is is the right call; other times, targeted preparation makes a meaningful difference. The key is making that decision based on data, not guesswork.",
  },
  {
    question: "How does Our dual expertise benefit Everett sellers?",
    answer:
      "As both a licensed Washington State real estate broker and a state-certified residential appraiser, we provide pricing grounded in actual condition assessment and neighborhood-level market data. This dual perspective is especially valuable with older Everett homes where condition, location, and lot characteristics can significantly affect value.",
  },
  {
    question: "What if family members disagree about what to do with the property?",
    answer:
      "This is common. We provide objective, data-driven information — condition assessment, realistic pricing, and a clear explanation of options — so families can make decisions based on facts rather than assumptions. Having a neutral, professional perspective often helps move conversations forward.",
  },
  {
    question: "Can you get help if I don't live in the Everett area?",
    answer:
      "Yes. our team regularly works with executors and family members managing Everett properties from outside the area. We coordinate property access, vendor management, preparation, and the sale process — keeping you informed at every step so you don't need to make unnecessary trips.",
  },
  {
    question: "How long does it take to sell an inherited home in Everett?",
    answer:
      "Timelines depend on the probate or trust process, property condition, and how much preparation is needed. Once the property is ready and authority is established, well-priced Everett homes typically sell within a few weeks. We help set realistic expectations and builds a timeline around your specific situation.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <MidPageCTA
        ...
        body={`${FEATURED_BROKER.name}, a licensed real estate broker, offers confidential property consultations for executors, trustees, and families handling inherited or estate property in Everett and throughout Snohomish County.`}
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">
              We provide a clear, professional perspective: an honest assessment of the property's condition, realistic pricing based on local market data, and a straightforward explanation of the options. This kind of neutral, fact-based guidance often helps families move past uncertainty and toward a decision everyone can understand.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed">
              Whether family members are local, scattered across the state, or across the country, we keep everyone informed with consistent communication throughout the process.
            </p>
          </div>
        </div>
      </section>
              ...
              {[
                {
                  ...
                  desc: "We start with a conversation about the property, the people involved, the timeline, and any concerns.",
                },
                {
