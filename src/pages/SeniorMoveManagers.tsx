...
const GINNYS_BIO = `Ginny's Girls is a family-owned senior move management and estate services company based in Edmonds, Washington, founded to help families in North King and Snohomish counties navigate life transitions with dignity and care. Meriann Roberts (Owner) and Abigail McKee (Manager) lead a team certified by NASMM (National Association of Senior Move Managers) and ISA (International Society of Appraisers). Together they offer comprehensive services including space planning, sorting, packing, move oversight, unpacking, resettling, estate liquidation, full-home clear-outs, and personal property valuation. Whether you're downsizing, managing an estate after a move or death, or preparing a home for sale, Ginny's Girls reduces stress and creates a smoother path forward for older adults and their families.`;
