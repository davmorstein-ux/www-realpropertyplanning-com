...
const faqs = [
  ...
  { question: "How does our team's appraisal background help in Marysville?", answer: "As both a licensed Washington State real estate broker and a state-certified residential appraiser, David Stein provides pricing based on actual property condition and local sales data — not automated estimates. In Marysville, where property ages and conditions range widely, this dual perspective helps families avoid pricing missteps." },
