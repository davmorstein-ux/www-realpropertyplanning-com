...
const faqs = [
  { question: "What should I do first with an inherited home in Marysville?", answer: `Secure the property, confirm your legal authority to act, and get an honest assessment of its condition and value. ${FEATURED_BROKER.Role} can visit the home, identify what affects its marketability, and outline your options before you make any decisions.` },
  { question: "How does an appraisal background help in Marysville?", answer: `As both a licensed Washington State real estate broker and a state-certified residential appraiser, ${FEATURED_BROKER.role} provides pricing based on actual property condition and local sales data — not automated estimates. In Marysville, where property ages and conditions range widely, this dual perspective helps families avoid pricing missteps.` },
  { question: "Should I fix up the home before selling?", answer: `It depends on the property's condition and your timeline. ${FEATURED_BROKER.Role} evaluates which improvements are likely to pay for themselves and which aren't worth the expense. Many Marysville inherited homes benefit from targeted cleanup and cosmetic work rather than major renovation.` },
  { question: "What if family members have different opinions about selling?", answer: `This is common. ${FEATURED_BROKER.Role} provides objective, condition-based information — realistic value, preparation options, and practical tradeoffs — so every family member has the same clear picture to work from. Shared facts usually help conversations move forward.` },
  { question: "Can you get help if I don't live in Marysville?", answer: `Yes. ${FEATURED_BROKER.Role} works with executors and families managing Snohomish County properties from other parts of the state and beyond. ${FEATURED_BROKER.pronoun.Subject} handles property access, vendor coordination, and the sale process so decisions can move forward without requiring repeated trips.` },
  { question: "How long does it take to sell an inherited home in Marysville?", answer: `Timelines depend on the legal process, property condition, and preparation scope. Once the home is ready and authority is established, appropriately priced Marysville properties generally sell within a reasonable timeframe. ${FEATURED_BROKER.Role} helps set clear expectations from the start.` },
];

const MarysvilleProbateEstate = () => {
  useEffect(() => {
    const faqSchema = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: faqs.map((f) => ({ "@type": "Question", name: f.question, acceptedAnswer: { "@type": "Answer", text: f.answer } })) };
    const localSchema = { ...hubOrganizationSchema, "@context": "https://schema.org", areaServed: [{ "@type": "City", name: "Marysville", containedInPlace: { "@type": "State", name: "Washington" } }, ...areaServed] };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <HeroBandTitle as="h1">Helping Marysville Families Work Through Inherited Property Decisions</HeroBandTitle>
      ...
      <section className="py-10 md:py-12 bg-background">
        <div className="container px-6 lg:px-8">
          ...
          <p className="text-muted-foreground leading-relaxed mb-5" style={{ fontSize: "18px" }}>
            When a family home in Marysville passes to the next generation, the decisions ahead are usually practical — what shape is the property in, what's it worth, and how do {FEATURED_BROKER.role} moves forward together. Clear, grounded guidance makes the difference between a stressful process and a manageable one.
          </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">As both a licensed Washington State real estate broker and a state-certified residential appraiser, {FEATURED_BROKER.role} provides that ground-level assessment. Our pricing reflects the property's actual condition and position within Marysville's market — giving families a reliable foundation for decision-making.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">We provide the information that helps everyone get aligned — a clear picture of the property's condition, a realistic sense of value, and a practical outline of what needs to happen next. From there, we manage the logistics so the family can focus on the decisions rather than the details.</p>
            <p className="text-muted-foreground text-lg leading-relaxed">Whether it's coordinating a cleanout, getting the property ready for market, or managing communication with attorneys and other parties, we keep things moving at a pace that works for the family.</p>
          </div>
        </div>
      </section>
