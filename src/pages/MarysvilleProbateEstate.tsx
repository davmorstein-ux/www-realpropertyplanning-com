      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">David Stein provides the information that helps everyone get aligned — a clear picture of the property's condition, a realistic sense of value, and a practical outline of what needs to happen next. From there, David Stein manages the logistics so the family can focus on the decisions rather than the details.</p>
            <p className="text-muted-foreground text-lg leading-relaxed">Whether it's coordinating a cleanout, getting the property ready for market, or managing communication with attorneys and other parties, David Stein keeps things moving at a pace that works for the family.</p>
          </div>
        </div>
      </section>
