...
const financial: Card[] = [
  { title: "CPAs & Financial Planners", description: "Tax guidance, estate coordination, and long-term financial planning.", href: "/for-cpas", image: "/tiles/set1/certified-public-accountants.webp", alt: "CPAs and financial planners Washington State", cta: "Learn More" },
              ...
              <div className="card-3d-blue__face h-full">
                <div className="flex h-full flex-col">
                  ...
                  >
                    ...
                    <p
                      className="mb-6 flex items-start justify-center transition-opacity duration-200 group-hover:opacity-0"
