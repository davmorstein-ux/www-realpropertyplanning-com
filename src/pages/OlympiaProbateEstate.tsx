...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "As both a licensed Washington State real estate broker and a state-certified residential appraiser, we provide pricing strategy grounded in actual condition assessment and neighborhood-level market analysis. In Olympia, where many estate properties reflect decades of ownership, this dual perspective helps families avoid pricing mistakes tied to deferred maintenance or outdated improvements.",
  },
  {
    question: "Can you get help with a property transition tied to retirement or senior living?",
    answer:
      "Yes. Many Olympia families reach out when a parent or loved one is transitioning into retirement, assisted living, or long-term care. We help coordinate the timing of the property sale with the transition, working with families and professionals to keep the process organized and manageable.",
  },
  {
    question: "What if the property has been in the family for a long time and needs work?",
    answer:
      "Long-held properties often have deferred maintenance, outdated systems, or accumulated personal belongings. We evaluate what preparation is worth doing — and what isn't — based on the likely return, the timeline, and the family's goals. Not every home needs extensive renovation before sale.",
  },
  {
    question: "How long does it take to sell an estate property in Olympia?",
    answer:
      "Timelines depend on the legal process, property condition, and preparation needs. We help set realistic expectations and builds a plan around your specific situation — including any coordination needed with family members, care transitions, or legal timelines.",
  },
];
...
const OlympiaProbateEstate = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <HeroBandTitle as="h1">Helping Families Navigate Estate Property in Olympia</HeroBandTitle>
      ...
      <MidPageCTA
        ...
        body={`${FEATURED_BROKER.name}, a licensed real estate broker, offers confidential property consultations for families, executors, and professionals handling estate or inherited property in Olympia and throughout Thurston County.`}
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-5">
              We work with families to coordinate timing, simplify decision-making, and keep the process manageable. We communicate clearly with all family members and professionals involved — reducing confusion and helping everyone stay aligned.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed">
