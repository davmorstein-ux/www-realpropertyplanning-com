...
const FAQS = [
  ...
  { question: "What should I measure when I tour a house for adult family home use?", answer: "Bring a tape measure. Resident bedrooms need at least 80 square feet of usable floor for one resident or 120 for two. The required exit door needs 32 inches of clear width. Bedroom escape windows need a sill no higher than 44 inches and a clear opening at least 24 inches high and 20 inches wide. Ramps can be no steeper than 1 inch of rise per foot, and a shower used for resident bathing must be at least 30 by 48 inches. The tool builds a checklist for the specific house." },
];
