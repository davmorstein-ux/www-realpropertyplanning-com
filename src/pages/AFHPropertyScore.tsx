...
const FAQS = [
  ...
  { question: "Is zoning a problem for an adult family home in Washington?", answer: "Generally not. State law (RCW 70.128.140) says an adult family home must be treated as a residential use and is a permitted use in all areas zoned residential or commercial, including single-family zones. Private HOA covenants, septic capacity, and fire access are the more common site questions." },
  { question: "What should I measure when I tour a house for adult family home use?", answer: "Bring a tape measure. Resident bedrooms need at least 80 square feet of usable floor for one resident or 120 for two. Bedroom escape windows need a sill no higher than 44 inches and a clear opening at least 24 inches high and 20 inches wide. Ramps can be no steeper than 1 inch of rise per foot, and a shower used for resident bathing must be at least 30 by 48 inches. The tool builds a checklist for the specific house." },
];
