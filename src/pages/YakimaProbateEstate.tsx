...
const faqs = [
  {
    ...
    answer:
      `Yes. ${FEATURED_BROKER.Role} works with executors, trustees, and families handling inherited and estate property throughout Washington State, including Yakima and the surrounding area. ${FEATURED_BROKER.pronoun.Subject} coordinates the process remotely when needed and provide on-the-ground support for property assessment and preparation.`,
  },
  {
    question: "What should I do first with an inherited house in Yakima?",
    answer:
      `Secure the property, confirm your legal authority to act, and get an honest assessment of the home's condition and realistic market value. ${FEATURED_BROKER.Role} can walk through the property, identify what affects value, and help you understand your options before making any commitments.`,
  },
  {
    question: "How does an appraisal background help with Yakima properties?",
    answer:
      `As both a licensed Washington State real estate broker and a state-certified residential appraiser, ${FEATURED_BROKER.role} provides pricing grounded in actual condition assessment and local comparable data — not automated estimates. In Yakima, where property values are sensitive to condition and neighborhood, this dual perspective prevents costly pricing mistakes.`,
  },
  {
    question: "Should I fix up the house before selling?",
    answer:
      `Not necessarily. ${FEATURED_BROKER.Role} evaluates which repairs or improvements are likely to return more than they cost — and which ones aren't worth the investment. Many Yakima inherited homes benefit more from honest pricing and targeted preparation than from expensive renovations.`,
  },
  {
    question: "What if family members disagree about what to do with the property?",
    answer:
      `This is common. ${FEATURED_BROKER.Role} provides objective, valuation-based information that helps families make decisions grounded in facts rather than assumptions. Having clear data about the property's condition, realistic value, and available options often helps move conversations forward.`,
  },
  {
    question: "How long does it take to sell an inherited home in Yakima?",
    answer:
      `Timelines depend on the probate or trust process, property condition, and market conditions. Once the property is ready and authority is established, well-priced Yakima homes typically sell within a reasonable timeframe. ${FEATURED_BROKER.Role} helps set realistic expectations and builds a timeline around your situation.`,
  },
];
...
const YakimaProbateEstate = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <HeroBandTitle as="h1">Practical Guidance for Inherited Property in Yakima</HeroBandTitle>
        ...
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              As both a licensed Washington State real estate broker and a state-certified residential appraiser, {FEATURED_BROKER.role} brings a condition-based, valuation-first perspective. This means pricing grounded in what the property actually is today — not what it was worth ten years ago or what an algorithm estimates from a distance.
            </p>
          </div>
        </div>
      </section>
              ...
              {[
                {
                  ...
                  desc: `${FEATURED_BROKER.Role} starts with a conversation about the property, the family, the legal context, and what you're trying to accomplish. No assumptions — just listening.`,
                },
                {
