...
const faqs = [
  ...
  },
  {
    ...
    answer:
      `Use the alert form on this page, or contact ${FEATURED_BROKER.name} directly. He tracks Tacoma and the wider Pierce County AFH market and can notify you when a matching property lists.`,
  },
];
