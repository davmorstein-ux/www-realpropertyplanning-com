...
const faqs = [
  { question: "How is selling trust property different from a normal home sale?", answer: "Trust sales involve fiduciary obligations, potential beneficiary oversight, and documentation requirements. David structures the process to account for them." },
  { question: "I live out of state — can David handle the property locally?", answer: "Absolutely. David provides hands-on local coordination — property access, vendor management, preparation, and sale oversight." },
  { question: "What documentation will I have to support my pricing decisions?", answer: "David provides detailed market analysis, comparable sales data, condition assessments, and written pricing rationale meeting a higher standard than typical agent opinions." },
  ...
  { question: "What if beneficiaries disagree about the sale?", answer: "David provides objective, data-driven pricing that helps move the conversation from emotion to facts." },
  { question: "Should I invest in repairs before selling trust property?", answer: "It depends on the property, the market, and the likely return on investment. David evaluates repair decisions with a practical perspective." },
];

const TrusteesLearnMore = () => (
  <div className="min-h-screen bg-background">
    <SEOHead
      title="Trustee Guide — Selling Trust-Held Property in Washington | David Stein"
    ...
    <DirectAnswerBlock
      ...
      answer="Trust property sales involve fiduciary obligations, beneficiary communication, defensible pricing, and sometimes attorney coordination. David Stein works with trustees to evaluate property condition, price it accurately, manage preparation and sale, and provide documentation to support fiduciary decisions."
      supportBullets={[
    ...
    <section className="py-20 lg:py-28 bg-primary">
      <div className="container px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-primary-foreground/70 text-lg leading-relaxed mb-8">I would be glad to help with valuation, preparation, coordination, or sale strategy.</p>
          <Link to="/contact">
