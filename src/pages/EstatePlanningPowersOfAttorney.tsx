          ...
          <div className="container px-6 lg:px-8">
            <div className="max-w-[900px] mx-auto">
              ...
              <h2 className="font-serif text-3xl text-foreground font-semibold mb-8 text-center">
                Featured Estate Planning Attorney — Coming Soon
              </h2>
              ...
              <div className="bg-secondary border border-border rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 p-5 sm:p-6">
                <div className="flex flex-col items-center gap-3 sm:flex-row sm:items-start sm:gap-5">
                  <div className="shrink-0">
                    <img
                      src="/placeholder.svg"
                      alt="Placeholder photo for featured estate planning attorney"
                  ...
                  <div className="flex w-full flex-col items-center sm:flex-1 sm:items-start">
                    <div className="w-full mt-2 text-center sm:text-left">
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed mb-3">
                        Bio will appear here. This section is reserved for a featured estate planning attorney.
                      </p>
                      <p className="text-muted-foreground text-sm leading-relaxed mb-3">
                      ...
                      <div className="space-y-1.5 text-sm">
                        <div className="flex items-start gap-2 justify-center sm:justify-start">
                          <img src={iconMapPin3d} alt="" aria-hidden="true" className="w-4 h-4 object-contain shrink-0 mt-1" loading="lazy" />
                          <span className="text-muted-foreground">Address</span>
                        </div>
                        <div className="flex items-center gap-2 justify-center sm:justify-start">
                          <img src={iconPhone3d} alt="" aria-hidden="true" className="w-4 h-4 object-contain shrink-1" loading="lazy" />
