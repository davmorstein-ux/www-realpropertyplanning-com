      ...
      <section className="bg-primary pt-16 pb-12 md:pt-32 md:pb-20 lg:pb-24">
        <div className="container px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <img src={iconProbateTerms} alt="Probate and estate real estate terminology guide for Washington State" className="mx-auto w-60 h-auto object-contain mb-8"  loading="lazy"/>
