...
const styles = `
  ...
  #roles-section .r2-section { font-family: 'Montserrat', sans-serif; padding: 0 40px 64px; }
  #roles-section .r2-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; max-width: 1300px; margin: 0 auto 20px; }
  #roles-section .r2-tile { width: 100%; cursor: pointer; }
  #roles-section .r2-card { width: 100%; height: 400px; background: #FDFAF5; border-radius: 5px; border: 1px solid rgba(184,154,90,.40); box-shadow: 0 8px 24px rgba(18,36,63,.15); display: flex; flex-direction: column; position: relative; transition: box-shadow .4s ease; overflow: hidden; }
