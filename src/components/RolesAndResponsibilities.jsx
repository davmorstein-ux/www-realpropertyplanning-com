...
const tileData = [
  ...
  },
  {
    ...
    img: "/tiles/set2/the-probate-process.webp",
  ...
  },
  {
    ...
    img: "/tiles/set2/probate-estate-sales.webp?v=20260602b",
  ...
  },
  {
    ...
    img: "/tiles/set2/title-escrow.webp?v=20260602b",
  ...
  },
  {
    ...
    img: "/tiles/set2/power-of-attorney.webp",
  ...
  return (
    <>
      <style>{`
        ...
        .r2-eyebrow { font-family: 'DM Sans', sans-serif !important; font-size: 13px !important; font-weight: 700 !important; letter-spacing: 0.18em; text-transform: uppercase; color: #b35f66; display: block; margin-bottom: 10px; }
        .r2-h2 { font-family: 'DM Sans', serif !important; font-size: 40px !important; font-weight: 700 !important; color: #3f1216; line-height: 1.15; margin: 0; }
        .r2-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; max-width: 1300px; margin: 0 auto 20px; }
        .r2-card { display: flex; flex-direction: column; width: 100%; height: 380px !important; min-height: 380px !important; max-height: 380px !important; background: #FDFAF5; border-radius: 5px; border: 1px solid rgba(184,154,90,0.40); box-shadow: 0 2px 8px rgba(0,0,0,0.08); overflow: hidden; position: relative; text-decoration: none; cursor: pointer; }
        ...
        .r2-pill { display: block !important; font-family: 'DM Sans', sans-serif !important; font-size: 13px !important; font-weight: 700 !important; letter-spacing: 0.18em; text-transform: uppercase; color: #b35f66 !important; margin-bottom: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .r2-title { font-family: 'DM Sans', serif !important; font-weight: 700 !important; font-size: 26px !important; color: #3f1216 !important; line-height: 1.15; margin-bottom: 4px; }
        .r2-tagline { font-family: 'DM Sans', sans-serif !important; font-weight: 500 !important; font-size: 14px !important; color: #6b5a5c !important; line-height: 1.5; }
        ...
        .r2-label { font-family: 'DM Sans', sans-serif !important; font-size: 13px !important; font-weight: 700 !important; letter-spacing: 0.04em; text-transform: uppercase; color: #6b1a21 !important; line-height: 1.4; flex: 1; }
        .r2-arrow { margin-left: auto; width: 28px; height: 28px; border: 1.5px solid #6b1a21; border-radius: 50%; display: flex; align-items: center; justify-content: center; transition: background 0.25s; flex-shrink: 0; }
        .r2-card:hover .r2-arrow { background: #6b1a21; }
        .r2-arrow svg { width: 11px; height: 11px; stroke: #6b1a21; fill: none; stroke-width: 2.2; stroke-linecap: round; stroke-linejoin: round; transition: stroke 0.25s; }
      ...
      <div className="r2-section">
        ...
        <div className="r2-grid">
          {tileData.map((tile, i) => (
            <a key={tile.title} className="r2-card marquee-hover" href={tile.href}>
