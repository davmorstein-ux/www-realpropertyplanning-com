  ...
  return (
    <>
      <style>{`
        ...
        .r2-pill { display: block !important; font-family: 'DM Sans', sans-serif !important; font-size: 13px !important; font-weight: 700 !important; letter-spacing: 0.18em; text-transform: uppercase; color: #b35f66 !important; margin-bottom: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; transition: opacity 0.15s ease; }
        .r2-title { font-family: 'DM Sans', serif !important; font-weight: 700 !important; font-size: 26px !important; color: #3f1216 !important; line-height: 1.15; transition: opacity 0.15s ease; }
