...
const HomepageLeadForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
   ...
   if (submitted) {
    return (
      <div role="status" aria-live="polite" className="bg-card rounded-2xl p-8 md:p-10 shadow-sm flex flex-col items-center justify-center text-center min-h-[400px]">
        ...
        <p className="text-muted-foreground text-lg leading-relaxed max-w-sm mb-5">
          The professionals in this network will reach out shortly to learn more about your situation.
        </p>
  ...
  return (
    <div className="bg-card rounded-2xl p-8 md:p-10 shadow-sm">
      ...
      <p className="text-muted-foreground text-base leading-relaxed mb-6">
        Share a few details and the professionals in this network will follow up directly — usually within one business day.
      </p>
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            className={`${inputClass} resize-none`}
            placeholder="Timeline, concerns, questions — anything that would help the professionals in this network understand your situation"
          />
        </div>
