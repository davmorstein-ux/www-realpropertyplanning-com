...
const ALL: Record<string, RelatedLink> = {
  forAttorneys: {
    href: "/for-attorneys",
    label: "For Attorneys & Fiduciaries",
    description: "How we support attorneys with the real estate workstream on probate, trust, and family-law matters.",
  },
  executors: {
    href: "/executors",
    label: "For Executors",
    description: "A clear roadmap for personal representatives managing estate real property in Washington.",
  },
  trustees: {
    href: "/trustees",
    label: "For Trustees",
    description: "Defensible pricing and sale coordination for trust-held real estate.",
  },
  probateSales: {
    href: "/probate-estate-sales",
    label: "Probate & Estate Sales",
    description: "How probate property sales actually run on a Washington court timeline.",
  },
  seniorTransitions: {
    href: "/senior-transitions",
    label: "Senior Home Sales",
    description: "Selling a longtime home during a move to assisted living, memory care, or a smaller residence.",
  },
  forCpas: {
    href: "/for-cpas",
    label: "For CPAs",
    description: "Property guidance for CPAs advising clients through estate or life transitions.",
  },
  ...
  whyValuation: {
    ...
    description: "Why pricing built on appraisal discipline holds up where automated estimates do not.",
  },
  howProcess: {
  ...
  faq: {
    href: "/faq",
    label: "FAQ",
    description: "Common questions about probate property, valuation, and senior transitions.",
  },
  contact: {
    href: "/contact",
    label: "Contact us",
    description: "Start a confidential conversation about a specific property.",
  },
  resources: {
    href: "/resources",
  ...
  // Guides
  guideHowProbateWorks: {
    href: "/guides/how-probate-real-estate-works",
    label: "How Probate Real Estate Works",
    description: "Letters, court timing, and what executors can and can't do before they're issued.",
  },
  guideExecutorFirstSteps: {
    href: "/guides/executor-first-steps-house",
    label: "First Steps with the House",
    description: "What to secure, document, and avoid in the first two weeks.",
  },
  guideInheritedHouse: {
    href: "/guides/inherited-house-washington",
    label: "Inherited House in Washington",
    description: "Sell, rent, or keep — how to think through an inherited property.",
  },
  guideOutOfState: {
    href: "/guides/out-of-state-families",
    label: "Handling It from Out of State",
    description: "Coordinating a Washington estate sale when no one local is available.",
  },
  guideSellDuringProbate: {
    href: "/guides/sell-house-during-probate-washington",
    label: "Selling During Probate",
    description: "Court timing, fiduciary defensibility, and price approvals.",
  },
  guideHowLong: {
    href: "/guides/how-long-sell-probate-property",
    label: "How Long Does It Take?",
    description: "Realistic Washington probate sale timelines.",
  },
  guideTaxes: {
    href: "/guides/taxes-selling-inherited-house-washington",
    label: "Taxes on an Inherited House",
    description: "Step-up basis, capital gains, and what to ask your CPA.",
  },
  guideAppraisalVsCma: {
    href: "/guides/appraisal-vs-cma",
    label: "Appraisal vs. CMA",
  ...
  guideAsIs: {
    ...
    label: "As-Is or Fix Up?",
    description: "How to decide on prep work for an inherited property.",
  },
  guidePricing: {
    href: "/guides/pricing-house-trust-estate",
    label: "Pricing a Trust or Estate House",
  ...
  resAttorneys: {
    ...
    label: "Probate & Estate Attorneys",
    description: "How to find and work with a Washington probate attorney.",
  },
  resCpas: {
    href: "/resources/cpas-financial-advisors",
    label: "CPAs & Financial Advisors",
    description: "When to bring tax and financial advisors into an estate sale.",
  },
  resEstateSale: {
    href: "/resources/estate-sale-companies",
    label: "Estate Sale Companies",
    description: "When a contents sale makes sense before listing the home.",
  },
  resPrep: {
  ...
  resMoving: {
    ...
    description: "Senior-friendly movers and downsizing support.",
  },
  resSeniorMove: {
    href: "/senior-move-managers",
    label: "Senior Move Managers",
    description: "Specialists who plan and run a senior household move.",
  },
  resSeniorLiving: {
    href: "/resources/senior-living-communities",
    label: "Senior Living Communities",
    description: "Independent, assisted, memory-care, and adult-family-home options.",
  },
  resChecklist: {
    href: "/resources/washington-executors-10-step-checklist",
    label: "Executor's 10-Step Checklist",
    description: "A printable starting point for new personal representatives.",
  },
  ...
  slIndependent: {
    ...
    description: "Active-senior communities without daily care.",
  },
  slMemoryCare: {
    href: "/senior-living/memory-care",
    label: "Memory Care",
    description: "Specialized communities for dementia and Alzheimer's.",
  },
  slSkilled: {
    href: "/senior-living/nursing-and-skilled-care",
    label: "Nursing & Skilled Care",
    description: "Higher-acuity options when medical needs increase.",
  },

  // Hubs
  guidesHub: {
    href: "/guides-and-resources",
    label: "All Guides & Resources",
    description: "The full educational library.",
  },
  testimonials: {
    href: "/testimonials",
    label: "Client Stories",
    description: "How families have navigated these transitions.",
  },
};
...
function pickContextual(currentPath: string): { keys: Array<keyof typeof ALL>; heading: string; intro: string } {
  ...
  if (p.startsWith("/guides/")) {
    if (p.includes("executor") || p.includes("first-steps") || p.includes("what-executors")) {
      return {
        keys: ["guideHowProbateWorks", "guideOutOfState", "executors"],
        heading: "Related Guides for Executors",
        intro: "More step-by-step guides for personal representatives.",
      };
    }
    if (p.includes("probate") || p.includes("how-long") || p.includes("sell-house-during-probate")) {
      return {
        keys: ["guideExecutorFirstSteps", "guideHowLong", "probateSales"],
        heading: "More on Probate Real Estate",
        intro: "Companion guides on Washington probate property sales.",
      };
    }
    if (p.includes("appraisal") || p.includes("pricing") || p.includes("cma")) {
      return {
        keys: ["guideAppraisalVsCma", "guidePricing", "whyValuation"],
        heading: "More on Pricing & Valuation",
        intro: "Related guides on how estate property gets priced.",
      };
    }
    if (p.includes("inherited") || p.includes("taxes") || p.includes("as-is")) {
      return {
        keys: ["guideTaxes", "guideAsIs", "guideInheritedHouse"],
        heading: "More for Inheriting a House",
        intro: "Companion guides for newly-inherited Washington property.",
      };
    }
    if (p.includes("heirs") || p.includes("disagree") || p.includes("out-of-state") || p.includes("repairs")) {
      return {
        keys: ["guideHeirsDisagree", "guideOutOfState", "guideRepairs"],
        heading: "Related Family-Coordination Guides",
        intro: "More on the people-and-property side of estate sales.",
      };
    }
    if (p.includes("senior")) {
      return {
        keys: ["moveElderly", "seniorTransitions", "resSeniorMove"],
        heading: "Related Senior-Transition Guides",
        intro: "More on moving a parent or downsizing a longtime home.",
      };
    }
    return {
      keys: ["guidesHub", "executors", "probateSales"],
      heading: "Related Guides",
      intro: "More guides on Washington estate, probate, and inherited property.",
    };
  }
  ...
  if (p.startsWith("/insights/") || p.startsWith("/insights-guidance/")) {
    return {
      ...
      intro: "More articles on the same topic.",
    };
  }

  // Resources — recommend other resources + the matching pro hub.
  if (p.startsWith("/resources/")) {
    if (p.includes("attorney"))
      return {
        keys: ["resCpas", "forAttorneys", "resChecklist"],
        heading: "Other Professional Resources",
        intro: "More resources for the legal and financial side of an estate.",
      };
    if (p.includes("cpa") || p.includes("financial"))
      return {
    ...
    if (p.includes("estate-sale") || p.includes("preparation") || p.includes("moving")) {
      return {
        keys: ["resPrep", "resMoving", "resSeniorMove"],
        heading: "Other Property-Preparation Resources",
        intro: "Vendors and specialists who help prepare a home for sale.",
      };
    }
    if (p.includes("senior"))
      return {
        keys: ["resSeniorLiving", "resSeniorMove", "seniorTransitions"],
        heading: "Other Senior-Care Resources",
        intro: "More on senior living, moving, and care planning.",
      };
    if (p.includes("checklist"))
      return {
        keys: ["executors", "guideExecutorFirstSteps", "guideHowProbateWorks"],
        heading: "Companion Resources for Executors",
        intro: "Use these alongside the checklist.",
      };
    return {
  ...
  if (p.startsWith("/senior-living/")) {
    if (p.includes("memory"))
      return {
        keys: ["slAssisted", "slSkilled", "seniorTransitions"],
        heading: "Related Senior-Living Options",
        intro: "Other care-level options families weigh alongside memory care.",
      };
    if (p.includes("assisted"))
      return {
        keys: ["slIndependent", "slMemoryCare", "moveElderly"],
        heading: "Related Senior-Living Options",
        intro: "Adjacent care levels and the home-sale side of the move.",
      };
    if (p.includes("independent"))
      return {
        keys: ["slAssisted", "slAdultFamily", "moveElderly"],
        heading: "Related Senior-Living Options",
        intro: "When independent living needs to step up — and how the home factors in.",
      };
    if (p.includes("nursing") || p.includes("skilled"))
      return {
        keys: ["slMemoryCare", "slAssisted", "seniorTransitions"],
        heading: "Related Senior-Living Options",
        intro: "Other higher-acuity options and the home-sale coordination.",
      };
    if (p.includes("adult-family"))
      return {
        keys: ["slAssisted", "slMemoryCare", "moveElderly"],
        heading: "Related Senior-Living Options",
        intro: "How adult family homes compare and what happens with the house.",
      };
    if (p.includes("power-of-attorney"))
      return {
        keys: ["executors", "trustees", "moveElderly"],
        heading: "Related Authority & Transition Resources",
        intro: "POA alongside the broader fiduciary picture.",
      };
    return {
      keys: ["slAssisted", "slMemoryCare", "seniorTransitions"],
      heading: "Related Senior-Living Options",
      intro: "Compare housing levels and the property side of the move.",
    };
  }
  ...
  if (p === "/counties" || p.endsWith("-county") || p.startsWith("/counties/")) {
    return {
      keys: ["probateSales", "executors", "guideOutOfState"],
      heading: "Companion Resources",
      intro: "Service and guide pages most often used alongside this county.",
    };
  }
  ...
  if (p.startsWith("/cities/") || p.endsWith("-probate-estate-real-estate")) {
    return {
      keys: ["probateSales", "executors", "guideInheritedHouse"],
      heading: "Companion Resources",
      intro: "Most-used pages alongside this local hub.",
    };
  }
  ...
  if (p.startsWith("/for-") || p.startsWith("/attorneys/") || p.includes("attorney")) {
    return {
      keys: ["forAttorneys", "executors", "whyValuation"],
      heading: "Related Professional Pages",
      intro: "Adjacent professional and fiduciary resources.",
    };
  }

  // Default catch-all (homepage, contact, about, etc.)
  return {
    keys: ["probateSales", "seniorTransitions", "executors"],
    heading: "Related Resources",
    intro: "Most-visited pages on the site.",
  };
}
                  ...
                  <div className="tile-white__inner h-full">
                    <div className="tile-white__face h-full">
                      <div className="flex h-full flex-col">
                        ...
                        <p className="text-[16px] leading-[1.6] text-muted-foreground mb-5">{link.description}</p>
