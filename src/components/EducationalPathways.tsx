          ...
          {pathways.map((p, i) => (
            ...
            >
              <div className="flex items-start gap-3 mb-3">
                <img src={iconBookOpen3d} alt="" aria-hidden="true" className="w-7 h-7 object-contain shrink-0 mt-0.5" loading="lazy" sizes="100vw" decoding="async"/>
              ...
              <span className="inline-flex items-center text-sm font-medium text-primary group-hover:text-gold transition-colors pl-10">
                Read more
                <img src={iconArrowRight3d} alt="" aria-hidden="true" className="w-4 h-4 ml-1.5 object-contain group-hover:translate-x-1 transition-transform" loading="lazy" sizes="100vw" decoding="async"/>
              </span>
            </Link>
          ))}
        </div>
