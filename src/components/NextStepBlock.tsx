        ...
        <div className="space-y-4">
          {steps.map((step) => (
            ...
            >
              ...
              <img src={iconArrowRight3d} alt="" aria-hidden="true" className="w-6 h-6 object-contain shrink-0 opacity-40 group-hover:opacity-100 transition-opacity" loading="lazy" sizes="100vw" decoding="async"/>
            </Link>
          ))}
        </div>
      </div>
