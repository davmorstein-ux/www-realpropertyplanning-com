        ...
        <div className="max-w-[1060px] mx-auto">
          ...
          >
            ...
            <div className="space-y-4 text-foreground text-[18px] md:text-[19px] leading-[1.75] font-medium">
              ...
              <p>
                Real Property Planning does not provide legal, tax, accounting, financial, brokerage, or appraisal services directly. Professional licensing credentials referenced on this site belong to individual members of our professional network, who provide their respective services independently, through their own separately licensed businesses — not through Real Property Planning. Visitors should consult qualified, appropriately licensed professionals regarding their specific situation.  The professionals listed here are independent and are not employees, partners, or affiliates of Real Property Planning. This directory is provided for educational and informational purposes only.
              </p>
            </div>
          </div>
        </div>
