...
export const tileCategories: TileCategory[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { title: "Senior\nHome Sales", subtitle: "", href: "/senior-move-managers", iconSrc: iconFundSeniorLiving, labelSpacing: "tight", iconOffsetY: "4%", iconScale: 1.05, mobileContentOffsetY: "-3%", mobileTextDown: true, mobileIconDown: true, mobileIconOffsetY: "10%" },
