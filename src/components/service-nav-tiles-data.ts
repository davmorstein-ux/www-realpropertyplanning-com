...
export const tileCategories: TileCategory[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { title: "Service Areas", subtitle: "", href: "/counties", iconSrc: iconServiceAreas, iconOffsetY: "-15%", iconScale: 1.1, mobileTextDown: true, mobileIconDown: true, mobileSmallText: true, textOffsetY: "-15%" },
