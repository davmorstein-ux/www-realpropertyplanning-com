...
export const tileCategories: TileCategory[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { title: "Paying for\nSenior Living", subtitle: "", href: "/sell-house-fund-senior-living", iconSrc: iconPayingForSeniorLiving, labelSpacing: "tight", iconOffsetY: "-4%", iconScale: 0.77, mobileTextDown: true, mobileIconDown: true, mobileIconOffsetY: "-19%", mobileContentOffsetY: "5%", mobileLargeText: true },
