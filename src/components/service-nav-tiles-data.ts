...
export interface ServiceTile {
  ...
  mobileTextOffsetY?: string;
  mobileSmallText?: boolean;
  mobileXSmallText?: boolean;
}
...
export const tileCategories: TileCategory[] = [
  {
    ...
    tiles: [
      ...
      { title: "Financial\nPlanning", subtitle: "", href: "/for-financial-planners", iconSrc: iconFinancialPlanning, labelSpacing: "tight", iconOffsetY: "4%", mobileContentOffsetY: "-2%", mobileTextDown: true, mobileIconDown: true, mobileIconOffsetY: "14%" },
      ...
      { title: "Realtor", subtitle: "", href: "/realtor", iconSrc: iconRealtor, contentOffsetY: "-0.5%", mobileContentOffsetY: "0.5%", iconOffsetY: "25%", iconScale: 1.1, mobileTextDown: true, mobileIconDown: true },
  ...
  },
  {
    ...
    tiles: [
      { title: "Executors", subtitle: "", href: "/executors", iconSrc: iconExecutors, iconOffsetY: "-2%", mobileTextDown: true, mobileIconDown: true, mobileIconOffsetY: "0%", mobileXSmallText: true, mobileTextOffsetY: "3%" },
      { title: "Trustees", subtitle: "", href: "/trustees", iconSrc: iconTrustees, mobileTextDown: true, mobileIconDown: true, mobileSmallText: true },
