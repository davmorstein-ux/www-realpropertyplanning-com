...
export const tileCategories: TileCategory[] = [
  {
    ...
    tiles: [
      ...
      { title: "Realtor", subtitle: "", href: "/realtor", iconSrc: iconRealtor, iconOffsetY: "8%", textOffsetY: "8px", contentOffsetY: "2%", mobileContentOffsetY: "-2%", mobileTextDown: true, mobileIconDown: true },
