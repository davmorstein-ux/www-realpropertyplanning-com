...
export const tileCategories: TileCategory[] = [
  {
    ...
    tiles: [
      ...
      { title: "Senior Living", subtitle: "", href: "/senior-living-and-relocation", iconSrc: iconSeniorLiving, mobileTextDown: true, mobileIconDown: true, textOffsetY: "6px", iconScale: 1.15 },
