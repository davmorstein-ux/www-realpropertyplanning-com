...
export const serviceTiles: ServiceTile[] = [
  ...
  { title: "Senior Moves", subtitle: "", href: "/senior-move-managers", iconSrc: iconSeniorMoves, mobileContentOffsetY: "-3%", mobileTextDown: true, mobileIconDown: true, mobileIconOffsetY: "10%" }, iconSrc: iconSeniorMoves, mobileContentOffsetY: "-3%", mobileTextDown: true, mobileIconDown: true, mobileIconOffsetY: "10%" },
