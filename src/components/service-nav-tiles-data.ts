...
export const tileCategories: TileCategory[] = [
  {
    ...
    tiles: [
      ...
      { title: "Realtor", subtitle: "", href: "/realtor", iconSrc: iconRealtor, iconOffsetY: "8%", textOffsetY: "8px", contentOffsetY: "4%", mobileContentOffsetY: "-4%", mobileTextDown: true, mobileIconDown: true },
