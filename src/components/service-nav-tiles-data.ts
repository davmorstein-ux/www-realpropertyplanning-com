...
import iconGrayDivorce from "@/assets/icons/gray-divorce-split-house-couple-washington.png";
...
export const tileCategories: TileCategory[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { title: "Gray Divorce", subtitle: "", href: "/gray-divorce-real-estate", iconSrc: iconGrayDivorce, iconOffsetY: "-8%", iconScale: 0.99, mobileTextDown: true, mobileIconDown: true, mobileSmallText: true },
