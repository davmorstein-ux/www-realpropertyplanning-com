...
export const tileCategories: TileCategory[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { title: "Gray Divorce", subtitle: "", href: "/gray-divorce-real-estate", iconSrc: iconGrayDivorce, iconOffsetY: "4%", iconScale: 1.0, mobileTextDown: true, mobileIconDown: true, mobileSmallText: true },
