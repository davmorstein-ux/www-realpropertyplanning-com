...
export const tileCategories: TileCategory[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { title: "Paying for\nSenior Care", subtitle: "", href: "/sell-house-fund-senior-living", iconSrc: iconFundSeniorLiving, labelSpacing: "tight", iconOffsetY: "4%", mobileContentOffsetY: "-3%", mobileTextDown: true, mobileIconDown: true, mobileIconOffsetY: "10%" },
