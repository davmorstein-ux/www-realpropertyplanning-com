...
export const tileCategories: TileCategory[] = [
  {
    ...
    tiles: [
      ...
      { title: "Mortgage\nLending", subtitle: "", href: "/lenders-and-financing-specialists", iconSrc: iconLending, labelSpacing: "tight", contentOffsetY: "-1.3%", mobileContentOffsetY: "-2%", mobileTextDown: true, mobileIconDown: true, mobileIconOffsetY: "14%" },
