...
export const tileCategories: TileCategory[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { title: "Guides &\nResources", subtitle: "", href: "/guides-and-resources", iconSrc: iconResources, labelSpacing: "tight", iconOffsetY: "12%", iconScale: 1.15, mobileTextDown: true, mobileIconDown: true },
    ],
  },
];
