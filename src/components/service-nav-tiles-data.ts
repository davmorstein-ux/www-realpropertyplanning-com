...
export const tileCategories: TileCategory[] = [
  {
    ...
    tiles: [
      ...
      { title: "Realtor", subtitle: "", href: "/realtor", iconSrc: iconRealtor, contentOffsetY: "3%", mobileContentOffsetY: "4%", iconOffsetY: "25%", iconScale: 1.1, mobileTextDown: true, mobileIconDown: true, mobileSmallText: true },
