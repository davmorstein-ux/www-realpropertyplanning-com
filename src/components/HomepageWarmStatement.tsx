    ...
    <section className="py-16 lg:py-24 bg-cream">
      <div className="container px-6 lg:px-8">
        <div className="max-w-[680px] mx-auto text-center">
          <h2 className="font-serif text-red-900 mb-8 font-bold text-lg text-center whitespace-pre-line">
          ...
          <div className="bg-card border-l-4 border-gold rounded-lg p-8 mb-10 text-left">
            <p className="font-serif leading-relaxed mb-3 opacity-100 italic text-slate-800 text-5xl font-bold md:text-4xl text-center">
