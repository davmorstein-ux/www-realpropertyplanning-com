...
import proofOfThoughtSeal from "@/assets/icons/real-estate-certification-seal-washington.webp";
  ...
  return (
    <div className="flex flex-col items-center text-center px-2">
      <div className="w-28 h-28 rounded-full overflow-hidden -mt-4 mb-1">
        <img src={proofOfThoughtSeal} alt="Proof of Thought verified seal" className="w-full h-full object-cover"  loading="lazy" sizes="100vw" decoding="async width={512} height={512} />
      </div>
