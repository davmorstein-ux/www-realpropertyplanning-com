        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-stretch">
          {sections.map((s) => (
            <a
              ...
              className="tile-white marquee-hover group block h-full no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2"
            >
                ...
                <div className="tile-white__face h-full">
                  <div className="flex h-full flex-col">
                    ...
                    >
                      ...
                      <p className="text-foreground text-[14px] leading-relaxed mb-6">{s.blurb}</p>
