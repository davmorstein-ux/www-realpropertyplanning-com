...
const CTASection = ({
  ...
  body = "A short conversation is usually the fastest way to get clarity. The professionals in this network work with families throughout Washington and can connect you with a trusted partner if the property is in another state.",
