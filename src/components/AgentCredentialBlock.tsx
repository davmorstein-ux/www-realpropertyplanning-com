...
const AgentCredentialBlock = () => (
  <div className="mt-4 text-center">
    ...
    <p className="text-muted-foreground text-base leading-snug mt-1">Washington State Licensed Real Estate Broker — David Stein's real estate license is held under eXp Realty</p>
