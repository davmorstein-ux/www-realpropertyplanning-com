...
const AgentCredentialBlock = () => (
  <div className="mt-4 text-center">
    <p className="font-serif text-[22px] text-foreground font-extrabold leading-snug tracking-[-0.01em]">Real Property Planning</p>
    <p className="text-foreground/80 text-lg font-semibold leading-snug mt-1">President, Real Property Planning</p>
    <p className="text-muted-foreground text-base leading-snug mt-1">Washington State Licensed Real Estate Broker — Real estate licenses are held under eXp Realty</p>
