...
const styles = `
  ...
  .p1card { width: 100%; height: 380px; background: #FFFFFF; border-radius: 16px; border: 2px solid #c3525c; box-shadow: 0 2px 8px rgba(0,0,0,0.08), inset 0 0 0 1px rgba(201,168,76,0.35); display: flex; flex-direction: column; position: relative; transition: all 0.3s ease; overflow: hidden; }
  ...
  .p1pill { display: block; font-size: 11px; font-weight: 700; letter-spacing: .18em; text-transform: uppercase; color: #b35f66; margin-bottom: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; transition: opacity .15s ease; }
  .p1title { font-family: 'DM Sans', serif; font-weight: 700; font-size: 22px; color: #3f1216; line-height: 1.15; transition: opacity .15s ease; }
