...
const advantages = [
  ...
  },
  {
    ...
    description:
      "Overpricing causes the property to sit. Underpricing means the estate loses money. Real Property Planning's valuation training helps avoid both — and that difference matters most in estate situations where there's no room for error.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Families often ask whether it's worth fixing up the house before selling. Real Property Planning's analysis looks at what improvements actually return value — so you're not spending money on things the market won't reward.",
  },
];
