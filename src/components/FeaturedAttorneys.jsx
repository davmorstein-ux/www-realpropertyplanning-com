...
const styles = `
  ...
  .pa-section { font-family: 'Montserrat', sans-serif; padding: 0 40px 64px; }
  .pa-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; max-width: 1300px; margin: 0 auto 20px; padding-top: 10px; }
  .pa-tile { width: 100%; cursor: pointer; text-decoration: none; display: block; }
