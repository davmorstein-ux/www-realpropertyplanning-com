...
const ClientReviewsSection = ({
  ...
  subheading = "Real feedback from clients and professionals who have worked with Real Property Planning during probate, estate, and senior transition situations.",
