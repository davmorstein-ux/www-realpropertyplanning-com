...
const ServiceNavTileCard = ({ tile }: { tile: ServiceTile }) => {
  return (
    ...
    >
      ...
      <span className="absolute inset-[10%] flex flex-col items-center justify-center px-[6px] py-[4px] -translate-y-[6%] sm:translate-y-0 sm:inset-[12%] sm:px-[10px] sm:py-[6px] sm:-translate-y-[11%]">
        <img
          src={tile.iconSrc}
          alt={tile.title}
