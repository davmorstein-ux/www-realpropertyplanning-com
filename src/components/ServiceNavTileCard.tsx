  ...
  return (
    ...
    >
      <div className="relative mx-auto w-full max-w-[520px]" style={{ aspectRatio: "1 / 1.18" }}>
        ...
        <span className="absolute left-[17%] right-[17%] top-[12%] bottom-[20%] flex flex-col items-center justify-center px-[4%] -space-y-6 sm:-space-y-8 lg:-space-y-10">
          <img
            src={tile.iconSrc}
            alt={tile.title}
            className="mx-auto max-h-[150px] w-[58%] object-contain mix-blend-multiply [background:transparent] sm:max-h-[172px] lg:max-h-[190px]"
            loading="lazy"
          />
