...
const ServiceNavTileCard = ({ tile }: { tile: ServiceTile }) => {
  ...
  return (
    <Link
      ...
      className="premium-tile group relative block w-full text-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 -my-[22%] -mx-[4%] scale-[1.45] sm:-my-[22%] sm:-mx-[6%] sm:scale-[1.588] z-0 hover:z-10"
    >
