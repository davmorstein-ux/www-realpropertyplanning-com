...
const ServiceNavTileCard = ({ tile }: { tile: ServiceTile }) => {
  return (
    ...
    >
      ...
      <h3 className="font-serif text-[2rem] font-bold leading-tight tracking-tight text-foreground lg:text-[2.15rem]">
        {tile.title}
      </h3>
    </Link>
  );
