...
const ServiceNavTileCard = ({ tile }: { tile: ServiceTile }) => {
  return (
    <Link
      to={tile.href}
      className="premium-tile group flex w-full flex-col items-center justify-center gap-4 text-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
    >
      ...
      <div className="relative w-full aspect-square">
        ...
        <span className="absolute inset-0 flex items-center justify-center p-[23%]">
          <img
            src={tile.iconSrc}
            alt={tile.title}
      ...
      <h3 className="font-serif text-[1.35rem] sm:text-[1.55rem] lg:text-[1.65rem] font-bold leading-[1.15] tracking-tight text-foreground">
        {tile.title}
      </h3>
    </Link>
  );
