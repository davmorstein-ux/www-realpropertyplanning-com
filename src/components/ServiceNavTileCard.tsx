  ...
  const tileVisual = (
    <>
      ...
      >
        ...
        <h3
          className={`tile-label -mt-6 max-w-[92%] text-center font-serif text-[0.8rem] font-bold leading-[1.15] tracking-tight text-foreground sm:text-[1.1rem] md:text-[1.3rem] lg:text-[1.7rem] xl:text-[2rem] whitespace-pre-line ${tile.labelSpacing ? 'tile-label-tight' : ''} ${tile.mobileTextDown ? 'mobile-text-down' : ''} ${tile.mobileLargeText ? 'mobile-text-large' : ''} ${tile.mobileSmallText ? 'mobile-text-small' : ''}`}
