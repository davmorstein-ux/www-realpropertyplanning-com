  ...
  const tileVisual = (
    <>
      ...
      >
        ...
        <h3
          className={`-mt-6 max-w-[92%] text-center font-serif text-[1rem] font-bold leading-[1.15] tracking-tight text-foreground sm:text-[1.3rem] md:text-[1.5rem] lg:text-[1.7rem] xl:text-[2rem] whitespace-pre-line ${tile.labelSpacing ? 'tile-label-tight' : ''} ${tile.mobileTextDown ? 'mobile-text-down' : ''} ${tile.mobileLargeText ? 'mobile-text-large' : ''}`}
