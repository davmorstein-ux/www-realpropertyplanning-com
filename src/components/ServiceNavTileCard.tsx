  ...
  return (
    ...
    >
      ...
      <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-secondary">
        <tile.icon className="h-6 w-6 text-foreground/60" strokeWidth={1.6} />
      </div>

      <h3 className="font-serif text-[2.5rem] font-bold leading-[1.15] tracking-tight text-foreground lg:text-[2.75rem]">
        {tile.title}
      </h3>
    </Link>
  );
