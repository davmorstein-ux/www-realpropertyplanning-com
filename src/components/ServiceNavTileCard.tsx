...
const ServiceNavTileCard = ({ tile }: { tile: ServiceTile }) => {
  return (
    <Link
      to={tile.href}
      className="premium-tile group relative block w-full text-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 -m-[4%] scale-[1.375]"
    >
      ...
      <span className="absolute inset-[14%] bottom-[22%] flex flex-col items-center justify-center px-[10px] py-[10px]">
        <img
          ...
          loading="lazy"
        />
        <h3 className="-mt-3 max-w-[92%] text-center font-serif text-[1.1rem] font-bold leading-[1.1] tracking-tight text-foreground sm:text-[1.4rem] md:text-[1.7rem] lg:text-[2rem] xl:text-[2.4rem]">
          {tile.title}
        </h3>
      </span>
    </Link>
