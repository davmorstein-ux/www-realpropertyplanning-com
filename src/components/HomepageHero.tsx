  ...
  return (
    ...
    >
      <div className="flex flex-col items-center px-6 lg:px-8 py-1 lg:py-1 w-full max-w-6xl mx-auto text-center">
        ...
        {/* Warm subheading — matches h1 typography exactly */}
        <p className="hero-bright-subheading font-sans text-[18px] md:text-[22px] font-bold tracking-[0.04em] leading-relaxed mb-8 pb-2 max-w-2xl">
