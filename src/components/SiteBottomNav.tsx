      ...
      <nav className="sbn-bar" aria-label="Site bottom navigation">
        <div className="sbn-inner">
          ...
          <Link to="/sitemap" className="sbn-item" data-tip="Site Map" aria-label="Site Map">
            <div className="sbn-icon-wrap" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', overflow: 'visible', minWidth: '90px' }}>
          ...
          >
            <div className="sbn-icon-wrap">
              <img src={compassIcon} alt="" aria-hidden="true" loading="lazy" style={{ height: '70px', width: 'auto', objectFit: 'contain', display: 'block', transform: 'rotate(20deg)', transition: 'transform 0.2s ease' }} />
            </div>
