...
const CountyPageTemplate = ({
  ...
  const defaultCountyFaqs = [
    ...
    {
      question: `Can the professionals in this network handle a ${countyName} estate sale if every heir lives out of state?`,
      answer: `Routinely. Out-of-state personal representatives are one of the most common situations in ${countyName}. The professionals in this network handle the in-person walk-through, vendor coordination, photo and video updates, showings, and offer review — so the heirs almost never need to travel to ${countyName} to close.`,
    },
  ];
    ...
    <div className="min-h-screen bg-background" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
      ...
      <main id="main-content">
        ...
        <DirectAnswerBlock
          ...
          answer={
            aeoAnswer ||
            `${FEATURED_BROKER.Role} provides experienced guidance for executors, trustees, attorneys, and families selling probate, inherited, and trust-held property in ${countyName}. Each property is carefully evaluated, and defensible pricing is provided based on licensed broker and certified appraiser expertise.`
          }
          ...
          <section className="py-14 lg:py-18 bg-cream">
            <div className="container px-6 lg:px-8">
              <div className="max-w-3xl mx-auto">
                ...
                <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                  Real Property Planning publishes the full DSHS licensing record for every one of them: capacity, specialty designations,
