          ...
          {areas.map((area, index) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <img src={mappin3d} alt="" aria-hidden="true" className="w-7 h-7 object-contain shrink-0 transition-transform duration-300 ease-out group-hover:scale-110"  loading="lazy" sizes="100vw" decoding="async"/>
