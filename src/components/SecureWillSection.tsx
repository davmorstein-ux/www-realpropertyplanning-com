          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <div className="relative w-[336px] sm:w-96 lg:w-[450px] will-vault-float">
              ...
              <button
                ...
                className="absolute bottom-[12%] left-1/2 -translate-x-1/2 w-[44%] h-[7%] cursor-pointer rounded-md bg-transparent hover:bg-white/10 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary/50"
