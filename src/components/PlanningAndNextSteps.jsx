...
const styles = `
  ...
  .pns-brochure { width: 100%; height: 420px !important; min-height: 420px !important; max-height: 420px !important; overflow: hidden; background: #FDFAF5; border-radius: 5px; border: 1px solid rgba(184,154,90,.40); position: relative; transform: rotateX(28deg); transform-origin: bottom center; transform-style: preserve-3d; box-shadow: 0 4px 0 1px rgba(155,132,78,.20), 0 8px 0 1px rgba(130,110,60,.11), 0 20px 44px rgba(18,36,63,.22); display: flex; flex-direction: column; transition: box-shadow .4s ease; }
  .pns-tile:hover .pns-brochure { box-shadow: 0 4px 0 1px rgba(155,132,78,.20), 0 8px 0 1px rgba(130,110,60,.11), 0 32px 64px rgba(18,36,63,.30); }
  .pns-brochure::before { content: ''; position: absolute; inset: 0; background: #F0EAE0; border-radius: 5px; transform: translateY(5px) translateZ(-4px); z-index: -1; }
  .pns-brochure::after { content: ''; position: absolute; inset: 0; background: #E5DED3; border-radius: 5px; transform: translateY(10px) translateZ(-8px); z-index: -2; }
      ...
      <div className="pns-card-inner">
        ...
        <div className="pns-text-area">
          ...
          <div className="pns-hover-panel">
            ...
            <a href="#" className="pns-overlay-cta">{cta}</a>
          </div>
        </div>
      </div>
