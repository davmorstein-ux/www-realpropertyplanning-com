...
const styles = `
  ...
  .pns-grid-row { display: grid; gap: 20px; max-width: 1300px; margin: 30px auto 20px; grid-template-columns: repeat(4, 1fr); }
  ...
  .pns-card-inner { padding: 30px 0 0; overflow: visible; flex: 1; display: flex; flex-direction: column; }
