      ...
      <div className="container px-6 lg:px-8">
        ...
        <div className="pt-8 mb-6" data-nosnippet="true">
          <p className="text-primary-foreground/70 text-base leading-relaxed max-w-4xl">
            Real Property Planning is a hub for Professionals, Seniors, Families & Estate Transitions created by David Stein. Guidance provided through Real Property Planning reflects David Stein's individual licensed expertise as a Washington State Licensed Real Estate Broker and Washington State Certified Residential Appraiser. Legal, tax, and probate-specific advice should be obtained from qualified legal and tax professionals.
          </p>
