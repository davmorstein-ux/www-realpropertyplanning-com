...
const cityServiceOverrides: Record<string, Record<string, CityServiceOverride>> = {
  ...
  bellevue: {
    "probate-estate-sales": {
      intro: `Bellevue's real estate market spans a wide range — from mid-century ramblers in Crossroads and Wilburton to multimillion-dollar estates in West Bellevue and Vuecrest. When a probate or estate sale involves Bellevue property, pricing accuracy matters because the gap between neighborhoods can be dramatic. ${FEATURED_BROKER.Role} provides the Eastside-specific valuation insight that executors, attorneys, and families need to handle estate property in Bellevue's competitive, fast-moving market.`,
      scenarios: [
      ...
      whyLocal: `Bellevue's market is shaped by tech-industry demand, rapid development, and a wide spread between neighborhoods. An estate property in Bridle Trails faces entirely different buyer expectations than one in Factoria or Lake Hills. Automated tools frequently miss these neighborhood-level distinctions, especially for properties with deferred maintenance competing against the new construction that dominates parts of the Eastside. ${FEATURED_BROKER.Role}'s on-site assessment accounts for how Bellevue's specific submarket dynamics, lot characteristics, and condition factors affect realistic pricing.`,
    },
    "senior-transitions": {
      intro: `Many Bellevue seniors have lived in their homes for decades — watching the Eastside transform from a quiet suburb into one of the most competitive real estate markets in the state. When it's time to transition from a longtime Bellevue home to assisted living, independent living, or a smaller residence, the sale involves both significant financial stakes and deeply personal decisions. ${FEATURED_BROKER.Role} helps Bellevue families navigate this process with experienced pricing, practical coordination, and a pace that respects the family's timeline.`,
      scenarios: [
    ...
    "executor-support": {
      ...
      whyLocal: `Bellevue executors face a market where mispricing carries significant financial consequences. Overprice and the property sits while the estate accumulates costs; underprice and beneficiaries may question the executor's judgment. ${FEATURED_BROKER.Role}'s dual credentials provide the defensible, neighborhood-specific pricing analysis that Bellevue estate situations require — accounting for the Eastside's development dynamics, submarket differences, and the realistic cost of bringing a deferred-maintenance property to competitive condition.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries managing property matters on the Eastside need a real estate partner who understands Bellevue's competitive market dynamics, the range of property types across the city's neighborhoods, and the documentation standards that legal proceedings require. ${FEATURED_BROKER.Role} works with Bellevue-area legal professionals as a responsive, credentialed resource for estate, trust, probate, divorce, and guardianship property matters.`,
      scenarios: [
    ...
    "preparing-home-for-sale": {
      ...
      whyLocal: `Bellevue's buyer expectations are influenced by the extensive new construction and high-end remodels that dominate parts of the Eastside market. Preparing an older home requires understanding which improvements today's Bellevue buyers actually value — updated kitchens and baths matter, but over-improving a $1.2M home with $200K in renovations may not produce proportional return. ${FEATURED_BROKER.Role}'s valuation expertise helps sellers invest preparation dollars where they'll have the most impact.`,
    },
    "divorce-related-home-sales": {
      intro: `Divorce-related property sales in Bellevue often involve significant financial stakes — Eastside home values mean the property is frequently the largest marital asset. Both parties and their attorneys need a broker who can provide objective, defensible valuation and manage the sale with professional discretion in a community where privacy matters. ${FEATURED_BROKER.Role} provides the neutral, credentialed guidance that Bellevue divorce-related sales require.`,
      scenarios: [
    ...
    "trust-estate-property-sales": {
      ...
      whyLocal: `Trust property sales in Bellevue require pricing that can withstand beneficiary scrutiny and, if necessary, court review. In a market where the difference between neighborhoods can exceed $500,000, generic pricing approaches create fiduciary risk. ${FEATURED_BROKER.Role}'s dual credentials provide trustees with the kind of documented, analytically grounded valuation and sale management that Bellevue's high-stakes trust property situations demand.`,
    },
  },
  ...
  "mercer-island": {
    ...
    "senior-transitions": {
      ...
      whyLocal: `Mercer Island seniors often own homes with characteristics that don't translate neatly into automated valuations — mature landscaping, lake access variations, or mid-century architecture that some buyers prize and others discount. Understanding how these features interact in the island's limited-inventory market requires property-specific assessment, not algorithm output. ${FEATURED_BROKER.Role} helps families see their island home through the market's eyes while respecting the personal significance of the transition.`,
    },
    "executor-support": {
      intro: `Serving as executor for a Mercer Island estate property carries unique responsibility — the property is likely high-value, the market operates with limited inventory and particular buyer expectations, and the community's private character adds sensitivity. ${FEATURED_BROKER.Role} provides executors with island-specific valuation expertise, professional coordination, and the discreet handling that Mercer Island estate situations require.`,
      scenarios: [
    ...
    "divorce-related-home-sales": {
      ...
      whyLocal: `Mercer Island's small community and high property values create unique dynamics for divorce-related sales. Privacy is difficult to maintain when every new listing is noticed, and valuation accuracy matters enormously when the home may represent $3M or more in marital assets. ${FEATURED_BROKER.Role}'s dual credentials provide the objective, defensible pricing that family law cases require, while years of experience on the island ensure the sale is managed with appropriate discretion.`,
    },
    "trust-estate-property-sales": {
      intro: `Trust-owned property on Mercer Island represents some of the highest-value residential assets in the Pacific Northwest. Trustees managing island property sales face fiduciary obligations that demand precision — defensible pricing, documented process, and transparent communication with beneficiaries who often have strong opinions about property they may have grown up visiting. ${FEATURED_BROKER.Role} provides the island-specific expertise and fiduciary-grade documentation these situations require.`,
      scenarios: [
  ...
  "bainbridge-island": {
    "probate-estate-sales": {
      ...
      whyLocal: `Bainbridge Island's real estate market is shaped by its ferry-dependent geography, rural-premium character, and the intentional lifestyle that draws buyers to the island. A Winslow village property near the ferry operates in a completely different market segment than a large-lot property on the north end. ${FEATURED_BROKER.Role}'s on-site assessment accounts for how Bainbridge's unique island characteristics — lot size, location relative to the ferry and village, rural features, and custom construction — affect realistic pricing.`,
    },
    "senior-transitions": {
      intro: `Bainbridge Island seniors often have deep roots in the island community — relationships built over decades, homes customized to their lives, and a connection to the island's artistic, natural character. When it's time to transition from a Bainbridge home, the decision involves both practical real estate considerations and the personal weight of leaving an intentionally chosen community. ${FEATURED_BROKER.Role} provides patient, island-informed guidance for families navigating this transition.`,
      scenarios: [
      ...
      whyLocal: `Bainbridge seniors are often leaving more than a house — they're leaving an island community they chose deliberately. The property itself may have characteristics that don't translate easily into standard valuations: custom construction, artist studios, larger lots with gardens, or proximity to the Winslow ferry terminal. ${FEATURED_BROKER.Role}'s property-specific assessment captures what makes each Bainbridge home unique, helping families price accurately while navigating the emotional dimension of an island transition.`,
    },
    "executor-support": {
      intro: `Executors managing estate property on Bainbridge Island face a market with unique characteristics — ferry-dependent access, a mix of village and rural property types, and a community where estate situations carry personal visibility. ${FEATURED_BROKER.Role} helps Bainbridge executors navigate the island's distinct market with defensible pricing, practical coordination, and the local knowledge that managing an island estate requires.`,
      scenarios: [
      ...
      whyLocal: `Bainbridge estate properties often defy simple market comparisons — the island's mix of Winslow village homes, mid-island neighborhoods, waterfront properties, and large-lot rural estates means every property's value is driven by its specific combination of location, lot characteristics, and construction type. ${FEATURED_BROKER.Role}'s on-site assessment provides executors with the property-specific analysis they need for defensible pricing in a market where automated tools consistently miss the mark.`,
    },
    "attorney-fiduciary-support": {
      intro: `Legal professionals managing property matters on Bainbridge Island need a broker who understands the island's unique real estate dynamics — not just Kitsap County broadly. The ferry-dependent market, premium-rural hybrid property types, and close-knit community create considerations that standard market analysis doesn't address. ${FEATURED_BROKER.Role} provides Bainbridge-area attorneys and fiduciaries with island-specific expertise, defensible pricing, and responsive coordination.`,
      scenarios: [
    ...
    "divorce-related-home-sales": {
      ...
      whyLocal: `Bainbridge Island's small community and limited comparable sales create distinct challenges for divorce-related property valuation. Island properties with unique features — waterfront, acreage, Winslow walkability — require on-site assessment rather than automated estimates, and the small-community dynamics demand a broker who can manage the sale with appropriate discretion. ${FEATURED_BROKER.Role} provides the credentialed objectivity and island familiarity these sensitive situations require.`,
    },
    "trust-estate-property-sales": {
      intro: `Trust-owned property on Bainbridge Island often represents a significant family asset tied to decades of island living. Trustees managing the sale face fiduciary obligations that demand defensible pricing — challenging in a market with limited comparable sales, premium-rural hybrid values, and property features (acreage, waterfront, outbuildings) that automated tools handle poorly. ${FEATURED_BROKER.Role} provides the island-specific expertise and documented methodology that Bainbridge trust sales require.`,
      scenarios: [
      ...
      whyLocal: `Trust property sales on Bainbridge Island require the kind of property-specific analysis that broad market tools cannot provide. The island's limited comparable sales, hybrid value characteristics, and ferry-dependent market rhythms demand on-site assessment by someone with both island knowledge and the analytical credentials that fiduciary documentation requires. ${FEATURED_BROKER.Role}'s dual background meets both needs.`,
    },
  },
  ...
  edmonds: {
    "probate-estate-sales": {
      ...
      whyLocal: `Edmonds' real estate market is defined by its walkable downtown, ferry access, and the dramatic view corridors that define neighborhoods like the Bowl. A home with an unobstructed Sound view commands a very different price than one a few blocks away without it. ${FEATURED_BROKER.Role}'s on-site assessment captures these block-by-block differences — providing executors and families with Edmonds-specific pricing that accounts for view quality, downtown proximity, and the community's particular buyer expectations.`,
    },
    "senior-transitions": {
      intro: `Many Edmonds seniors chose the community deliberately — for its walkable downtown, ferry access, arts scene, and the small-city character that makes daily life enjoyable. Transitioning from a longtime Edmonds home involves practical real estate decisions and the personal weight of leaving a community where relationships and routines are deeply established. ${FEATURED_BROKER.Role} helps Edmonds families navigate this transition with patience, honest pricing, and experienced coordination.`,
      scenarios: [
      ...
      whyLocal: `Edmonds seniors often own homes in locations — the Bowl, near the ferry, along the waterfront — where the value is heavily influenced by view quality, walkability, and community character. These aren't factors that automated tools price well. ${FEATURED_BROKER.Role} provides the property-specific assessment that helps families understand exactly what their Edmonds home is worth, which preparation decisions make sense, and how to time the sale alongside the family's transition plan.`,
    },
    "executor-support": {
      intro: `Executors managing estate property in Edmonds inherit responsibility for a home in a community where location nuances matter significantly — Sound views, Bowl positioning, ferry proximity, and downtown walkability all affect value in ways that require local expertise. ${FEATURED_BROKER.Role} helps Edmonds executors with property-specific assessment, practical coordination, and the clear communication that estate administration requires.`,
      scenarios: [
      ...
      whyLocal: `Edmonds estate properties are often in locations where block-by-block differences in view quality, walkability, and waterfront proximity create significant pricing variation. An executor unfamiliar with these nuances risks mispricing — especially if relying on automated tools that don't distinguish between a Bowl home with Sound views and one without. ${FEATURED_BROKER.Role}'s on-site assessment provides the Edmonds-specific analysis that defensible estate pricing requires.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries managing property matters in Edmonds benefit from a broker who understands the community's specific market dynamics — the premium that views, walkability, and ferry access command, and how those factors vary across Edmonds' neighborhoods. ${FEATURED_BROKER.Role} provides Edmonds-area legal professionals with locally grounded property assessments, clear documentation, and responsive coordination.`,
      scenarios: [
    ...
    "preparing-home-for-sale": {
      ...
      whyLocal: `Edmonds properties sell based on a combination of condition, views, and lifestyle proximity — and the relative importance of each factor varies by neighborhood. A Bowl home with a panoramic view can tolerate more deferred maintenance than a non-view property in Firdale. ${FEATURED_BROKER.Role}'s Edmonds experience helps sellers invest preparation dollars where they'll actually affect the outcome.`,
    },
    "divorce-related-home-sales": {
      intro: `Divorce-related property sales in Edmonds combine the financial stakes of a view-driven market with the sensitivity of a small coastal community where listing activity is noticed. Both parties need a broker who can provide objective, defensible valuation — especially for Edmonds properties where view premiums and ferry proximity create value that's difficult to quantify without on-site assessment. ${FEATURED_BROKER.Role} provides the neutral expertise these situations demand.`,
      scenarios: [
    ...
    "trust-estate-property-sales": {
      ...
      whyLocal: `Trust property sales in Edmonds require understanding the specific factors that drive value in this view-dependent, walkable coastal market. ${FEATURED_BROKER.Role}'s dual credentials provide the defensible, Edmonds-specific analysis that trust administration standards demand.`,
    },
  ...
  "gig-harbor": {
    ...
    "executor-support": {
      ...
      whyLocal: `Gig Harbor executors need pricing that reflects the peninsula's specific market — not broad Pierce County averages. A harbor-view property near downtown Gig Harbor operates in a completely different market segment than a larger-lot property on the rural side of the peninsula. ${FEATURED_BROKER.Role}'s on-site evaluation provides the property-specific analysis that Gig Harbor estate pricing requires — especially important where beneficiaries may have outdated or emotionally influenced expectations of what the property is worth.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries with property matters in Gig Harbor need a broker who understands the peninsula's specific real estate dynamics — harbor-view premiums, the distinction between downtown and rural peninsula properties, and how Narrows Bridge connectivity affects the buyer pool. ${FEATURED_BROKER.Role} provides Gig Harbor-area legal professionals with locally informed assessments, defensible documentation, and professional coordination.`,
      scenarios: [
    ...
    "preparing-home-for-sale": {
      ...
      whyLocal: `Gig Harbor properties sell based on a combination of harbor character, view quality, and waterfront access — and preparation strategy needs to emphasize these peninsula-specific elements. A harbor-view home with dated finishes may outperform a fully updated interior-lot property if the views are presented well. ${FEATURED_BROKER.Role}'s peninsula experience helps sellers invest preparation dollars where they'll actually affect the outcome.`,
    },
    "divorce-related-home-sales": {
      intro: `Divorce-related property sales in Gig Harbor involve the challenge of valuing peninsula-specific premiums — harbor views, waterfront access, and maritime character — in a market where these features create significant value differences that generic approaches miss. Both parties need a broker who can provide defensible, peninsula-specific valuation while managing the sale with discretion in a community where real estate activity is closely observed. ${FEATURED_BROKER.Role} provides this combination.`,
      scenarios: [
  ...
  poulsbo: {
    "probate-estate-sales": {
      intro: `Poulsbo's Scandinavian heritage, Liberty Bay waterfront, and small-town character create a real estate market where community identity and local knowledge matter more than in larger markets. Estate and probate properties in Poulsbo — whether along Liberty Bay, in established neighborhoods near Viking Avenue, or in the more rural areas surrounding town — each require locally specific valuation and coordination. ${FEATURED_BROKER.Role} provides the Poulsbo-focused expertise these situations demand.`,
      scenarios: [
    ...
    "executor-support": {
      ...
      whyLocal: `Poulsbo's market is small enough that comparable sales may be limited, but specific enough that broad-area averages miss the value drivers that matter — Liberty Bay proximity, downtown walkability, lot characteristics, and community character. ${FEATURED_BROKER.Role} provides executors with the property-specific, on-site analysis that Poulsbo estate pricing requires — especially important where beneficiaries may not understand how the local market differs from where they currently live.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries with property matters in Poulsbo benefit from a broker who understands the community's distinctive real estate dynamics — Liberty Bay waterfront premiums, Scandinavian heritage village character, and the pricing nuances of a small Kitsap County market. ${FEATURED_BROKER.Role} provides Poulsbo-area legal professionals with community-specific assessments, defensible pricing, and responsive coordination.`,
      scenarios: [
    ...
    "valuation-guidance": {
      intro: `Property valuation in Poulsbo requires understanding a market shaped by community identity — Liberty Bay waterfront premiums, Viking Avenue walkability, Scandinavian-heritage character, and the transition from in-town homes to the more rural properties surrounding the community. Automated tools consistently miss these Poulsbo-specific value drivers. ${FEATURED_BROKER.Role} provides the on-site, community-focused assessment that Poulsbo property decisions require.`,
      scenarios: [
  ...
  seattle: {
    "probate-estate-sales": {
      ...
      whyLocal: `Seattle estate properties exist within a market where neighborhood context changes everything. A mid-century rambler in Wedgwood, a craftsman in Wallingford, and a condo in South Lake Union each operate in fundamentally different submarkets with different buyer pools and pricing dynamics. ${FEATURED_BROKER.Role}'s neighborhood-level experience across Seattle allows him to assess each estate property on its own terms — evaluating how condition, lot potential, zoning, and neighborhood trajectory affect realistic pricing for executors and attorneys who need defensible analysis, not automated estimates.`,
    },
    "senior-transitions": {
      intro: `Seattle seniors have often lived through decades of neighborhood transformation — watching their corner of the city evolve while staying rooted in the home they chose years or decades ago. Transitioning from a longtime Seattle home involves navigating a complex urban market where neighborhood dynamics, property types, and buyer expectations vary dramatically across the city. ${FEATURED_BROKER.Role} helps Seattle families approach this transition with neighborhood-specific pricing, practical coordination, and patient guidance.`,
      scenarios: [
    ...
    "attorney-fiduciary-support": {
      ...
      whyLocal: `Seattle's property matters are complicated by the city's market complexity. A property in Ballard raises different questions than one in Rainier Valley or on Capitol Hill — lot potential, neighborhood trajectory, property type, and buyer demographics all vary dramatically. ${FEATURED_BROKER.Role}'s experience across Seattle's neighborhoods, combined with ${FEATURED_BROKER.role}'s certified appraisal credentials, provides attorneys and fiduciaries with the versatile, defensible analysis that Seattle's diverse property landscape requires.`,
    },

    "downsizing-services": {
      intro: `Downsizing in Seattle means navigating more than 80 neighborhoods — each with distinct pricing, buyer expectations, and lifestyle character. A longtime home in Wallingford presents entirely different downsizing considerations than one in West Seattle or Beacon Hill. ${FEATURED_BROKER.Role} helps Seattle homeowners evaluate their options with neighborhood-level market insight and honest guidance on preparation, pricing, and timing in the city's complex market.`,
      scenarios: [
      ...
      whyLocal: `Seattle's downsizing landscape is complicated by the city's neighborhood diversity and rapid change. A home in Wallingford faces different buyer expectations than one in Columbia City — and zoning changes may mean the property's highest value isn't as a residence at all. ${FEATURED_BROKER.Role}'s experience across Seattle's 80+ neighborhoods helps homeowners understand their specific situation rather than relying on citywide averages.`,
    },
    "valuation-guidance": {
      intro: `Property values in Seattle can vary by hundreds of thousands of dollars within a few blocks — driven by neighborhood trajectory, view corridors, zoning potential, property type, and condition. Automated tools that rely on citywide averages consistently miss these hyperlocal dynamics. ${FEATURED_BROKER.Role} provides the neighborhood-level, condition-based assessment that Seattle property decisions demand, whether for estate settlement, trust administration, or pre-listing strategy.`,
      scenarios: [
      ...
      whyLocal: `Seattle's market complexity makes automated valuation particularly risky. A mid-century rambler in Ravenna may be valued primarily as a lot in one micro-market and primarily as a home in the next — and the difference can exceed $200,000. ${FEATURED_BROKER.Role}'s dual credentials and experience across Seattle's neighborhoods provide the property-specific analysis these high-stakes decisions require.`,
    },
    "preparing-home-for-sale": {
      intro: `Preparing a home for sale in Seattle varies dramatically by neighborhood, property type, and buyer demographic. A vintage Craftsman in Wallingford needs a different preparation approach than a mid-century rambler in Lake City or a condo in Belltown. ${FEATURED_BROKER.Role} helps Seattle homeowners make preparation decisions based on what buyers in their specific neighborhood actually value — not generic staging advice that ignores the city's market diversity.`,
      scenarios: [
  ...
  tacoma: {
    "probate-estate-sales": {
      intro: `Tacoma's real estate market reflects a city in transformation — from the revitalized Stadium District and waterfront to the established North End neighborhoods and the evolving communities of Hilltop and South Tacoma. Estate and probate properties in Tacoma require pricing that accounts for this neighborhood-level variation and the city's distinct position as Pierce County's urban center. ${FEATURED_BROKER.Role} provides the Tacoma-specific guidance that executors and families need.`,
      scenarios: [
    ...
    "downsizing-services": {
      ...
      whyLocal: `Tacoma's downsizing landscape is shaped by the city's rapid revitalization — neighborhoods that were stable and affordable five years ago may have appreciated dramatically, while others present different value dynamics. A North End home faces different buyer expectations than one in South Tacoma or Parkland. ${FEATURED_BROKER.Role}'s Tacoma-specific experience helps homeowners understand their property's realistic position in this evolving market.`,
    },
    "valuation-guidance": {
      intro: `Property valuation in Tacoma reflects a city in transition — neighborhoods like the Stadium District and Hilltop are revitalizing rapidly, while other areas maintain different pricing dynamics. Automated tools that rely on citywide averages miss the neighborhood-level value shifts that define Tacoma's current market. ${FEATURED_BROKER.Role} provides the on-site, neighborhood-specific assessment that Tacoma property decisions require.`,
      scenarios: [
    ...
    "divorce-related-home-sales": {
      ...
      whyLocal: `Tacoma divorce-related valuations are complicated by the city's rapid evolution — a North End property may have appreciated 40% in five years while a South Tacoma home followed a different trajectory. These neighborhood-level dynamics affect settlement calculations significantly. ${FEATURED_BROKER.Role} provides the current, Tacoma-specific analysis that family law cases in Pierce County require.`,
    },
    "trust-estate-property-sales": {
      intro: `Trust-owned property in Tacoma spans the city's full range — from established North End homes to properties in revitalizing neighborhoods to multi-unit or mixed-use assets in the city's diverse housing stock. Trustees face fiduciary obligations that demand defensible pricing in a market where neighborhood-level dynamics are shifting rapidly. ${FEATURED_BROKER.Role} provides the Tacoma-specific expertise and documented methodology that trust property sales in this evolving market require.`,
      scenarios: [
  ...
  snohomish: {
    ...
    "executor-support": {
      intro: `Executors managing Snohomish estates often face properties with rural characteristics, deferred maintenance, and accumulated belongings that suburban-focused agents aren't equipped to handle. ${FEATURED_BROKER.Role} provides the property-specific guidance executors need for Snohomish's distinctive housing stock — from historic downtown homes to acreage properties with outbuildings.`,
      scenarios: [
  ...
  silverdale: {
    ...
    "executor-support": {
      intro: `Executors handling Silverdale estates often manage the process from across Puget Sound or from out of state entirely. ${FEATURED_BROKER.Role} provides the on-the-ground coordination executors need in a market where military buyer demographics and Central Kitsap's growth patterns both influence strategy.`,
      scenarios: [
  ...
  lynnwood: {
    ...
    "downsizing-services": {
      intro: `Lynnwood's transformation from a traditional suburb into a light rail-connected urban hub creates interesting downsizing possibilities — newer condos near transit, more manageable townhomes, or a move to a quieter community. ${FEATURED_BROKER.Role} helps Lynnwood homeowners evaluate their property in today's shifting market and make informed decisions about timing, preparation, and pricing.`,
      scenarios: [
      ...
      whyLocal: `Lynnwood's downsizing market is being reshaped by light rail and new construction. Homeowners who have been in their properties for decades may find that their home's highest value comes from redevelopment potential rather than traditional residential sale. ${FEATURED_BROKER.Role} helps clients understand which scenario applies to their specific property and neighborhood within Lynnwood's evolving landscape.`,
    },
    "executor-support": {
      intro: `Serving as an executor for a Lynnwood estate property means navigating a market in transition. Light rail, new zoning, and shifting buyer demographics can all affect how an estate property should be priced and positioned. ${FEATURED_BROKER.Role} provides executors with the practical, locally informed guidance needed to manage a Lynnwood estate sale with confidence.`,
      scenarios: [
    ...
    "valuation-guidance": {
      ...
      whyLocal: `Lynnwood's market is moving faster than most automated tools can track. A property near the City Center station may carry development premium that a standard residential comparison misses entirely. Meanwhile, homes in more established neighborhoods like Alderwood or Martha Lake still trade on traditional residential factors. ${FEATURED_BROKER.Role}'s on-site evaluation accounts for these diverging dynamics within the same city.`,
    },
    "preparing-home-for-sale": {
      intro: `Preparing a Lynnwood home for sale — especially an estate or longtime family property — requires understanding which improvements matter in today's shifting market. A mid-century rambler near the light rail corridor may need different preparation than a similar home in a quieter Lynnwood neighborhood. ${FEATURED_BROKER.Role} helps families make practical preparation decisions based on the property's specific location and realistic buyer expectations.`,
      scenarios: [
      ...
      whyLocal: `In Lynnwood's evolving market, preparation strategy depends heavily on where the property sits within the city's transformation. Homes near light rail stations may benefit from minimal preparation if the primary buyer pool is developers, while properties in established residential neighborhoods still need traditional staging and updates to attract homebuyers. ${FEATURED_BROKER.Role} helps families avoid both over-investing and under-preparing.`,
    },
    "divorce-related-home-sales": {
      intro: `Selling a shared home during a divorce in Lynnwood requires objectivity, market accuracy, and an understanding of how the city's shifting dynamics affect property value. ${FEATURED_BROKER.Role} provides the neutral, experienced guidance that both parties and their attorneys need to move forward with clarity in Lynnwood's evolving market.`,
      scenarios: [
      ...
      whyLocal: `Divorce-related sales in Lynnwood often involve disagreements about value that are amplified by the city's rapid transformation. One party may believe the home has development potential while the other sees it as a standard residential property. ${FEATURED_BROKER.Role}'s appraisal credentials provide the objective, defensible basis both attorneys and their clients need for productive negotiations.`,
    },
    "trust-estate-property-sales": {
      intro: `Trust-owned property in Lynnwood may have been placed in trust when the city's market looked very different. As light rail reshapes neighborhoods and new construction changes buyer expectations, trustees need current, locally informed guidance to fulfill their fiduciary obligations. ${FEATURED_BROKER.Role} helps trustees navigate Lynnwood's evolving market with clarity and appropriate documentation.`,
      scenarios: [
  ...
  woodinville: {
    "probate-estate-sales": {
      ...
      whyLocal: `Woodinville's market doesn't behave like a standard suburban community. Properties with acreage, equestrian facilities, or wine district proximity attract a niche buyer pool with specific expectations. Estate properties here often include features — outbuildings, rural infrastructure, specialty landscaping — that automated tools completely miss. ${FEATURED_BROKER.Role}'s appraisal background is especially valuable for Woodinville properties where the land, improvements, and location all contribute to value in ways that require on-site assessment.`,
    },
    "senior-transitions": {
    ...
    "executor-support": {
      ...
      whyLocal: `Estate properties in Woodinville frequently include features that make standard probate sale approaches insufficient. Acreage, outbuildings, equestrian facilities, and proximity to the wine district all affect value and marketability in ways that require on-site, hands-on evaluation. ${FEATURED_BROKER.Role}'s appraisal background provides executors with the property-specific insight they need to make confident decisions about unique Woodinville estates.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries working with Woodinville property need a real estate partner who understands rural-adjacent valuation, acreage properties, and the wine country market's unique dynamics. ${FEATURED_BROKER.Role} provides the reliable, well-documented guidance legal professionals need when property characteristics extend well beyond standard residential norms.`,
      scenarios: [
      ...
      whyLocal: `Woodinville properties often include features — acreage, outbuildings, specialty improvements — that create valuation complexity for legal proceedings. Standard residential comparisons may miss the value (or limitation) of these features entirely. ${FEATURED_BROKER.Role}'s appraisal credentials provide attorneys and fiduciaries with the kind of defensible, property-specific analysis needed for estate settlements, trust administration, and family law proceedings involving non-standard properties.`,
    },
    "valuation-guidance": {
      intro: `Valuing property in Woodinville requires understanding how acreage, outbuildings, wine country proximity, and rural character affect market value. Standard automated tools frequently miss these features or misapply suburban comparables to properties that behave more like rural or estate-style real estate. ${FEATURED_BROKER.Role} provides the hands-on, property-specific valuation insight that Woodinville's unique market demands.`,
      scenarios: [
    ...
    "divorce-related-home-sales": {
      ...
      whyLocal: `Divorce settlements involving Woodinville property are often complicated by the home's unique features. One party may have invested heavily in equestrian facilities, a workshop, or landscaping that they value sentimentally at a different level than the market. ${FEATURED_BROKER.Role}'s appraisal credentials provide the objective, defensible valuation that helps attorneys and mediators cut through subjective disagreements and reach fair outcomes.`,
    },
    "trust-estate-property-sales": {
  ...
  kirkland: {
    ...
    "senior-transitions": {
      ...
      whyLocal: `Kirkland seniors often own homes in locations that have appreciated significantly — but the home itself may not reflect what today's buyers expect in terms of condition and finish. The gap between emotional value and market reality is especially pronounced in Kirkland, where walkability, waterfront proximity, and neighborhood charm drive premiums that only apply when the property is presented effectively. ${FEATURED_BROKER.Role}'s appraisal background helps families understand where their home actually stands and what preparation makes financial sense.`,
    },
    "downsizing-services": {
    ...
    "executor-support": {
      ...
      whyLocal: `Kirkland executors face a market where mispricing carries real consequences — overprice and the property sits while the estate accumulates carrying costs; underprice and beneficiaries question the executor's judgment. With Kirkland's wide range of neighborhood values and the transformation happening around Totem Lake, accurate pricing requires on-the-ground assessment rather than automated tools. ${FEATURED_BROKER.Role}'s dual credentials provide the defensible analysis that Kirkland estate situations demand.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries managing property matters in Kirkland need a real estate partner who understands the city's waterfront-driven market premiums, the significant pricing variation between neighborhoods, and the documentation standards that legal proceedings require. ${FEATURED_BROKER.Role} works with Kirkland-area legal professionals as a responsive, credentialed resource for estate, trust, probate, divorce, and guardianship property matters across the city's diverse submarkets.`,
      scenarios: [
    ...
    "divorce-related-home-sales": {
      ...
      whyLocal: `Divorce negotiations involving Kirkland property are complicated by the city's wide range of neighborhood values and the emotional premium both parties often attach to the Kirkland address. Automated estimates may validate one party's expectations while contradicting the other's — neither accurately. ${FEATURED_BROKER.Role}'s dual broker and appraiser credentials provide the neutral, property-specific analysis that helps Kirkland divorce situations reach fair resolution based on actual market conditions rather than aspirational pricing.`,
    },
    "trust-estate-property-sales": {
      intro: `Trust-owned property in Kirkland requires fiduciary-level care in a market where the city's waterfront charm and Eastside location create significant values — and where trustee decisions are subject to beneficiary scrutiny. Whether the trust property is a longtime family home in Juanita, a condo near downtown Kirkland, or a view property on Finn Hill, ${FEATURED_BROKER.role} provides trustees with the defensible pricing and professional sale management that trust administration demands.`,
      scenarios: [
  ...
  issaquah: {
    ...
    "downsizing-services": {
      ...
      whyLocal: `Issaquah downsizers face a specific challenge: the community's newer construction and HOA-maintained neighborhoods set high presentation standards. A home with dated finishes or deferred maintenance may need strategic preparation to compete effectively. ${FEATURED_BROKER.Role} helps Issaquah homeowners determine which improvements deliver meaningful return and which are unnecessary given their property's specific submarket and buyer pool.`,
    },
    "executor-support": {
      intro: `Executors handling property in Issaquah need to understand how the city's varied housing landscape — from master-planned communities with HOA requirements to older Olde Town homes with different buyer expectations — affects the sale process. ${FEATURED_BROKER.Role} provides executors with clear, practical guidance tailored to Issaquah's specific market segments.`,
      scenarios: [
      ...
      whyLocal: `Issaquah estates present distinct challenges depending on whether the property is in a master-planned community or the older housing stock near Olde Town. HOA requirements, community architectural standards, and condition relative to the community's newer homes all affect how the property should be priced and prepared. ${FEATURED_BROKER.Role} provides executors with the submarket-specific insight needed to manage these distinctions confidently.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries working with Issaquah property benefit from a real estate partner who understands the city's unique structure — master-planned communities with strict HOA governance alongside older residential areas with different market dynamics. ${FEATURED_BROKER.Role} provides the reliable communication and submarket-specific insight that legal professionals need for property matters in Issaquah.`,
      scenarios: [
      ...
      whyLocal: `Issaquah's legal professionals encounter property situations where the community structure — HOAs, architectural review boards, trail easements — adds layers of complexity to standard real estate transactions. ${FEATURED_BROKER.Role}'s experience across Issaquah's diverse housing segments helps attorneys and fiduciaries navigate these community-specific requirements while providing defensible valuation guidance.`,
    },
    "valuation-guidance": {
      intro: `Property valuation in Issaquah requires distinguishing between the city's master-planned communities, its Olde Town core, and its foothills-adjacent properties. Each segment carries different value drivers and buyer expectations that automated tools often conflate. ${FEATURED_BROKER.Role} provides the condition-based, submarket-specific valuation insight that Issaquah's varied landscape demands.`,
      scenarios: [
    ...
    "preparing-home-for-sale": {
      ...
      whyLocal: `Issaquah buyers — particularly in the master-planned communities — have high expectations for move-in condition. But not every update delivers proportional value. ${FEATURED_BROKER.Role} helps Issaquah sellers understand which preparation investments matter in their specific submarket and which improvements buyers in their price range won't pay extra for, avoiding both over-spending and under-preparing.`,
    },
    "divorce-related-home-sales": {
      intro: `Divorce-related property sales in Issaquah require objectivity about a home's value within its specific community context — whether it's a Highlands home with HOA amenities, an Olde Town property with character appeal, or a foothills lot with mountain views. ${FEATURED_BROKER.Role} provides the neutral, submarket-informed guidance both parties need to reach fair, defensible conclusions.`,
      scenarios: [
  ...
  redmond: {
    "probate-estate-sales": {
      ...
      whyLocal: `Redmond's transformation from bedroom community to tech hub has created dramatic value differences between neighborhoods that are only minutes apart. An estate home on Education Hill faces different buyer dynamics than one in Bear Creek or Redmond Ridge. Automated valuations frequently miss how campus proximity, light rail expansion, and school boundary changes affect specific properties. ${FEATURED_BROKER.Role}'s on-the-ground familiarity with Redmond's micro-markets ensures estates are priced based on how today's buyers actually evaluate these neighborhoods.`,
    },
    "senior-transitions": {
      intro: `Many Redmond seniors settled here when the city was still primarily agricultural and suburban — long before Microsoft and the tech boom reshaped the landscape. Now facing transitions to smaller homes, assisted living, or moves closer to family, these homeowners often find that their properties have appreciated far beyond expectations while the neighborhoods around them have changed significantly. ${FEATURED_BROKER.Role} helps Redmond seniors and their families navigate these transitions with honest pricing guidance and practical coordination.`,
      scenarios: [
    ...
    "downsizing-services": {
      ...
      whyLocal: `Redmond's downsizing decisions are uniquely influenced by the city's ongoing transformation. Light rail expansion, campus growth, and changing neighborhood demographics mean that the optimal timing and preparation strategy for a downsizing sale depends heavily on the specific submarket. ${FEATURED_BROKER.Role}'s local knowledge helps downsizing homeowners avoid the common mistake of applying generic Eastside assumptions to Redmond's rapidly evolving micro-markets.`,
    },
    "executor-support": {
      intro: `Executors handling Redmond estate property face a market that has changed dramatically from when the deceased purchased their home. Properties near Microsoft's campus, along the Sammamish River trail, or in newer communities like Redmond Ridge each present different challenges around valuation, preparation, and buyer expectations. ${FEATURED_BROKER.Role} provides executors with the structured, Redmond-specific guidance needed to manage estate real property responsibly.`,
      scenarios: [
    ...
    "valuation-guidance": {
      ...
      whyLocal: `Redmond's valuation landscape is uniquely challenging because the city's rapid development has created adjacent neighborhoods with dramatically different value trajectories. An Education Hill property and an Overlake condo may both carry Redmond addresses but face completely different buyer pools and pricing dynamics. ${FEATURED_BROKER.Role}'s certified appraiser background provides the analytical foundation to navigate these distinctions accurately.`,
    },
    "preparing-home-for-sale": {
      ...
      whyLocal: `Redmond's buyer expectations are shaped by the tech industry's influence on the local market. Buyers often compare properties against newer construction with modern layouts and finishes. ${FEATURED_BROKER.Role} helps sellers identify which preparation investments will genuinely affect sale price in Redmond's specific neighborhoods — rather than spending on upgrades that won't move the needle for the property's actual buyer pool.`,
    },
    "divorce-related-home-sales": {
      intro: `Divorce-related property sales in Redmond carry unique complexity because the city's tech-driven appreciation has created significant equity in many homes — equity that both parties may value differently based on when they purchased and how they perceive the market's trajectory. ${FEATURED_BROKER.Role} provides the objective, credential-backed guidance needed to navigate Redmond marital property sales with clarity and discretion.`,
      scenarios: [
    ...
    "trust-estate-property-sales": {
      ...
      whyLocal: `Trust properties in Redmond exist within a market that rewards precision — small differences in location, condition, and neighborhood trajectory can create meaningful value variations. Trustees who rely on generic Eastside data risk either underpricing in strong micro-markets or overpricing in areas where buyer expectations have shifted. ${FEATURED_BROKER.Role} provides the Redmond-specific analysis that supports sound fiduciary decision-making.`,
    },
  },
  ...
  everett: {
    "probate-estate-sales": {
      ...
      whyLocal: `Everett's market is defined by dramatic neighborhood-level variation — a craftsman in Norton-Grand has different dynamics than a rambler near Mall Drive or a view property in Bayside. The city's ongoing waterfront revitalization has created pockets of rapid appreciation adjacent to areas where values remain more stable. ${FEATURED_BROKER.Role}'s familiarity with Everett's neighborhood trajectories ensures probate properties are priced based on realistic buyer demand rather than citywide averages.`,
    },
    "senior-transitions": {
    ...
    "executor-support": {
      ...
      whyLocal: `Executors unfamiliar with Everett may not realize how dramatically the city's neighborhoods differ — or how quickly some areas are changing while others remain stable. ${FEATURED_BROKER.Role}'s presence in Snohomish County ensures executors receive Everett-specific guidance rather than generic suburban assumptions that don't reflect the county seat's distinctive character and market dynamics.`,
    },
    "attorney-fiduciary-support": {
    ...
    "preparing-home-for-sale": {
      ...
      whyLocal: `Everett's diverse housing stock means preparation strategies vary dramatically by neighborhood and property type. What works for a Bayside view property doesn't apply to a Lowell ranch, and the budget for preparation should reflect the realistic return in each specific micro-market. ${FEATURED_BROKER.Role} helps Everett sellers avoid over-investing in updates that won't move the needle — or under-preparing in neighborhoods where presentation genuinely affects sale price.`,
    },
    "divorce-related-home-sales": {
      ...
      whyLocal: `Everett divorces frequently involve employment-related complications — Boeing layoff cycles, naval station transfers, and the financial dynamics of single-income transitions in a county-seat market. ${FEATURED_BROKER.Role} provides the objective, locally informed analysis that helps both parties and their attorneys move forward with realistic expectations about the Everett property's value and marketability.`,
    },
    "trust-estate-property-sales": {
      ...
      whyLocal: `Trust properties in Everett require understanding the county seat's distinctive market dynamics — where industrial heritage, military presence, and urban renewal create conditions that standard suburban analysis doesn't capture. ${FEATURED_BROKER.Role} provides trustees with the Everett-specific insight needed to make well-supported fiduciary decisions in a market where neighborhood trajectory matters as much as property condition.`,
    },
  },
  ...
  duvall: {
    ...
    "preparing-home-for-sale": {
      ...
      whyLocal: `Duvall's buyer pool has different expectations than suburban Eastside markets. Over-improving a Duvall home with trendy finishes may not generate the return it would in Redmond or Kirkland, while under-preparing can extend time on market in a community where inventory already moves more slowly. ${FEATURED_BROKER.Role} helps Duvall sellers find the right preparation balance for their specific property and the realistic buyer profile it will attract.`,
    },
    "divorce-related-home-sales": {
      ...
      whyLocal: `Divorce negotiations involving Duvall property require understanding that standard suburban valuation methods don't fully apply. The town's limited annual sales volume, the premium or discount that rural features create, and the narrower buyer pool all affect realistic pricing. ${FEATURED_BROKER.Role}'s appraisal background provides the objective, locally grounded analysis needed for equitable resolution when Duvall's small-market dynamics make standard approaches insufficient.`,
    },
    "trust-estate-property-sales": {
      intro: `Trust-owned property in Duvall may include features that trustees and corporate trust departments rarely encounter — acreage, outbuildings, agricultural elements, or river-adjacent parcels where standard residential trust administration approaches need adaptation. ${FEATURED_BROKER.Role} provides trustees with the locally informed, property-specific guidance that Duvall's distinctive real estate requires.`,
      scenarios: [
  ...
  lakewood: {
    "probate-estate-sales": {
      intro: `Lakewood's real estate market is shaped by the proximity of Joint Base Lewis-McChord, lakefront properties on American Lake and Gravelly Lake, and a wide range of housing types across the city's diverse neighborhoods. When a probate or estate sale involves Lakewood property, understanding how military buyer demographics, lakefront premiums, and neighborhood-specific conditions affect pricing is essential. ${FEATURED_BROKER.Role} provides the locally grounded guidance that Lakewood executors and families need.`,
      scenarios: [
      ...
      whyLocal: `Lakewood's market operates differently from neighboring Tacoma or University Place because of JBLM's influence on buyer demographics, the distinct lakefront enclaves, and the city's wide price range. An estate property on American Lake faces a completely different buyer pool than one near the base. ${FEATURED_BROKER.Role}'s on-site assessment accounts for these Lakewood-specific dynamics — military influence, lakefront premiums, and the practical realities of selling estate property in a market with diverse buyer expectations.`,
    },
    "senior-transitions": {
      intro: `Many Lakewood seniors have deep roots in the community — some connected to decades of military service, others drawn by the lakefront lifestyle or the city's established neighborhoods. When it's time to transition from a longtime Lakewood home, the process involves understanding how the city's unique market dynamics affect the sale while coordinating the move to a senior living community or family home. ${FEATURED_BROKER.Role} helps Lakewood families navigate this transition with patience and practical expertise.`,
      scenarios: [
    ...
    "executor-support": {
      ...
      whyLocal: `Lakewood executors face a market where JBLM's PCS (Permanent Change of Station) cycles create seasonal buyer fluctuations, and lakefront properties operate in a niche market with limited inventory. An executor who doesn't account for these Lakewood-specific patterns risks mispricing or mistiming the sale. ${FEATURED_BROKER.Role}'s local experience helps executors navigate these dynamics with confidence.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries managing property matters in Lakewood need a real estate partner who understands the city's military-influenced market, lakefront property dynamics, and the diverse housing stock across Lakewood's neighborhoods. ${FEATURED_BROKER.Role} works with Lakewood-area legal professionals as a responsive, credentialed resource for estate, trust, probate, divorce, and guardianship property matters.`,
      scenarios: [
  ...
  bothell: {
    ...
    "senior-transitions": {
      ...
      whyLocal: `Bothell seniors often own homes in the original core or established neighborhoods that have been reshaped by the city's growth. The gap between what these homes meant to the family and what today's market values can be significant — especially when competing against newer construction in Canyon Park. ${FEATURED_BROKER.Role}'s appraisal background helps families understand where their Bothell property actually stands and what preparation makes practical sense.`,
    },
    "downsizing-services": {
    ...
    "executor-support": {
      ...
      whyLocal: `Bothell executors face the unusual challenge of a market that straddles two counties — meaning comparable sales, buyer demographics, and even tax implications can vary based on which side of the boundary the property sits. ${FEATURED_BROKER.Role}'s experience with Bothell's specific cross-county dynamics helps executors avoid the pricing errors that occur when the wrong comparables are applied.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries managing property matters in Bothell need a real estate partner who understands the city's dual-county market dynamics, the contrast between established and newly developed neighborhoods, and the documentation standards that legal proceedings require. ${FEATURED_BROKER.Role} works with Bothell-area legal professionals as a responsive, credentialed resource for property matters that span King and Snohomish County boundaries.`,
      scenarios: [
    ...
    "valuation-guidance": {
      ...
      whyLocal: `Bothell's valuation challenges stem from its dual-county identity — automated tools that draw comparable sales from a geographic radius inevitably mix King County and Snohomish County markets, producing unreliable estimates. ${FEATURED_BROKER.Role}'s certified appraisal credentials and local experience allow ${FEATURED_BROKER.pronoun.object} to select the truly relevant comparables for each Bothell property, providing the analytically grounded valuation that cross-county situations demand.`,
    },
    "preparing-home-for-sale": {
      intro: `Preparing a Bothell home for sale requires understanding whether the property competes against Canyon Park's newer construction, established homes in the original downtown core, or properties along the Sammamish River corridor — each segment with different buyer expectations. ${FEATURED_BROKER.Role} helps Bothell sellers identify which improvements generate return in their specific submarket and avoid preparation that exceeds what the market will reward.`,
      scenarios: [
    ...
    "divorce-related-home-sales": {
      ...
      whyLocal: `Divorce negotiations involving Bothell property are uniquely complicated by the dual-county dynamic. Each party's attorney may pull comparables from different sides of the King-Snohomish boundary, reaching different conclusions. ${FEATURED_BROKER.Role}'s cross-county experience and appraisal credentials provide the neutral, property-specific analysis needed for equitable resolution.`,
    },
    "trust-estate-property-sales": {
      intro: `Trust-owned property in Bothell presents fiduciary challenges that reflect the city's dual-county position and evolving market — trustees need guidance that accounts for which county's comparables apply, how Canyon Park's growth affects neighboring values, and whether the property's location near UW Bothell creates development considerations. ${FEATURED_BROKER.Role} provides trustees with the cross-county expertise that Bothell trust administration requires.`,
      scenarios: [
      ...
      whyLocal: `Trust property sales in Bothell require fiduciary guidance that navigates the city's dual-county market with precision. A trustee who applies the wrong county's comparables — or blends both without distinction — creates pricing that may not withstand beneficiary challenge. ${FEATURED_BROKER.Role}'s cross-county experience and appraisal background provide the defensible, property-specific analysis that Bothell trust situations demand.`,
    },
  },
  ...
  kent: {
    "probate-estate-sales": {
      intro: `Kent is one of the largest cities in King County, with a housing market that spans the East Hill's established ramblers, newer construction throughout the city, West Hill properties, and valley-floor homes adjacent to commercial and industrial corridors. When a probate or estate sale involves Kent property, the wide range of housing types and the significant pricing differences between locations within the city make neighborhood-level guidance essential. ${FEATURED_BROKER.Role} brings the South King County expertise that Kent estate situations require.`,
      scenarios: [
      ...
      whyLocal: `Kent's housing market is shaped by geography — East Hill homes face different buyer expectations than valley-floor properties or West Hill view homes. The city's proximity to major employers, industrial areas, and transportation corridors creates submarket dynamics that automated estimates frequently flatten into a single 'Kent average.' ${FEATURED_BROKER.Role}'s on-site assessment accounts for how specific location, condition, and neighborhood context affect realistic pricing.`,
    },
    "senior-transitions": {
      ...
      whyLocal: `Kent seniors often own homes in neighborhoods where the surrounding community has changed significantly. The East Hill that a senior remembers from the 1970s looks and functions differently today — and the buyer pool has evolved accordingly. ${FEATURED_BROKER.Role}'s experience with Kent's specific submarkets helps families set realistic expectations and prepare properties in ways that match what today's buyers are actually looking for.`,
    },
    "downsizing-services": {
    ...
    "executor-support": {
      ...
      whyLocal: `Kent executors face a market where the difference between neighborhoods — East Hill versus valley, Panther Lake versus West Hill — can represent significant pricing variation. An executor who relies on a single 'Kent' average risks either leaving money on the table or overpricing into a stale listing. ${FEATURED_BROKER.Role}'s South King County experience helps executors price accurately for their property's specific submarket.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries managing property matters in Kent need a real estate partner who understands South King County's largest city — its diverse housing stock, the geographic divisions that create distinct micro-markets, and the documentation standards that legal proceedings require. ${FEATURED_BROKER.Role} works with Kent-area legal professionals as a responsive, credentialed resource for estate, trust, probate, divorce, and guardianship property matters across the city's varied neighborhoods.`,
      scenarios: [
  ...
  puyallup: {
    "probate-estate-sales": {
      intro: `Puyallup's valley location creates a market where property types range from older homes near the historic downtown to newer South Hill developments and properties with agricultural-heritage lot characteristics. When probate or estate sales involve Puyallup property, understanding how these valley-specific factors affect realistic pricing is essential. ${FEATURED_BROKER.Role} provides the locally grounded guidance that Puyallup executors, attorneys, and families need.`,
      scenarios: [
      ...
      whyLocal: `Puyallup's market is shaped by the valley's geography — South Hill properties command different premiums than downtown-area homes, and properties with agricultural-heritage characteristics require specialized understanding. Automated tools that average sales across the area miss the elevation, lot-type, and neighborhood distinctions that materially affect value. ${FEATURED_BROKER.Role}'s on-site assessment accounts for these valley-specific dynamics.`,
    },
    "senior-transitions": {
      intro: `Many Puyallup seniors have spent decades in their South Hill or downtown-area homes, raising families in the valley community. When it's time to transition to a smaller home, senior living, or a family member's residence, the sale involves both financial considerations and deep personal attachment. ${FEATURED_BROKER.Role} helps Puyallup families navigate this process with experienced pricing and patient coordination.`,
      scenarios: [
      ...
      whyLocal: `Puyallup seniors often own homes with features — larger lots, outbuildings, mature landscaping — that automated tools undervalue. The gap between emotional significance and realistic market position requires locally informed analysis. ${FEATURED_BROKER.Role}'s appraisal background helps families understand where their property stands in a valley market where neighborhood, elevation, and lot characteristics all influence pricing.`,
    },
    "executor-support": {
      intro: `Executors managing estate property in Puyallup face a market where South Hill homes, downtown-area properties, and valley-floor locations each carry different value dynamics. ${FEATURED_BROKER.Role} provides the valley expertise and steady communication that Puyallup executors need to price accurately and manage the sale alongside Pierce County probate requirements.`,
      scenarios: [
      ...
      whyLocal: `Puyallup executors face a market where the valley's range of property types means comparable selection requires local judgment. ${FEATURED_BROKER.Role}'s dual credentials provide the defensible, neighborhood-specific pricing analysis that Puyallup estate situations require.`,
    },
    "downsizing-services": {
      intro: `Downsizing from a longtime Puyallup home often means leaving a larger South Hill property or a family home near downtown for something smaller. ${FEATURED_BROKER.Role} helps homeowners manage the sale with clear pricing, practical coordination, and respect for the emotional weight of leaving a home that may hold decades of memories.`,
      scenarios: [
      ...
      whyLocal: `Downsizing in Puyallup often involves properties with characteristics that don't fit standard comparable analysis neatly. ${FEATURED_BROKER.Role}'s valley experience helps downsizing clients understand realistic market value for homes where lot and improvements create unique buyer appeal.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries working on matters involving Puyallup property need a real estate professional who understands the valley's diverse housing stock. ${FEATURED_BROKER.Role} serves as a reliable resource for Pierce County legal professionals handling Puyallup property matters where local expertise affects legal and financial outcomes.`,
      scenarios: [
      ...
      whyLocal: `Legal professionals handling Puyallup matters need a partner who understands valley-specific valuation factors. ${FEATURED_BROKER.Role}'s dual credentials provide the objective foundation that Pierce County legal proceedings and fiduciary situations require.`,
    },
    "valuation-guidance": {
      intro: `Accurate property valuation in Puyallup requires understanding the valley's distinct submarkets — South Hill properties carry different premiums than downtown-area homes, and lots with outbuildings or acreage need specialized analysis. ${FEATURED_BROKER.Role} provides the valuation insight Puyallup clients need for estate settlements, trust administration, and informed sale decisions.`,
      scenarios: [
    ...
    "preparing-home-for-sale": {
      ...
      whyLocal: `Preparation strategy in Puyallup depends on the property's location and price tier. A South Hill home warrants different investment than a valley-floor property. ${FEATURED_BROKER.Role}'s valley experience helps sellers find the right balance between under-preparation and over-investment.`,
    },
    "divorce-related-home-sales": {
      intro: `Divorce-related property sales in Puyallup are complicated by the valley's internal market variation — spouses may reference South Hill, downtown, or valley-floor comparables to support different value conclusions. ${FEATURED_BROKER.Role} provides the objective, neighborhood-specific analysis that Puyallup divorce situations require.`,
      scenarios: [
      ...
      whyLocal: `Divorce negotiations involving Puyallup property are complicated by the valley's price range and internal diversity. Both parties may cite 'Puyallup sales' from different neighborhoods. ${FEATURED_BROKER.Role}'s valley experience provides the neutral analysis needed for fair resolution.`,
    },
    "trust-estate-property-sales": {
      intro: `Trust-owned property in Puyallup may be located anywhere in the valley — from South Hill view homes to downtown-area older properties to lots with agricultural-heritage characteristics. Each creates different fiduciary considerations for trustees. ${FEATURED_BROKER.Role} provides the Pierce County expertise that Puyallup's varied market demands.`,
      scenarios: [
      ...
      whyLocal: `Trust property sales in Puyallup require fiduciary guidance that accounts for the valley's diverse property types. ${FEATURED_BROKER.Role}'s valley experience and appraisal credentials provide the submarket-specific analysis that fiduciary situations demand.`,
    },
  },
  ...
  "federal-way": {
    "probate-estate-sales": {
      ...
      whyLocal: `Federal Way's market is complicated by geographic spread and internal diversity. A lake-adjacent property, a town-center townhome, and a hillside view home operate in effectively different markets despite sharing a Federal Way address. ${FEATURED_BROKER.Role}'s South King County experience and appraisal credentials provide the property-specific analysis estate situations require.`,
    },
    "senior-transitions": {
      intro: `Many Federal Way seniors have lived in their homes since the city's major growth period — watching neighborhoods develop and the town center evolve. When it's time to transition from a longtime Federal Way home, the sale involves meaningful financial value and personal attachment. ${FEATURED_BROKER.Role} helps families navigate this process with honest pricing, practical coordination, and patience.`,
      scenarios: [
      ...
      whyLocal: `Federal Way seniors often own homes that have appreciated but may not match today's buyer expectations. The gap between emotional and realistic market value requires honest, condition-based analysis. ${FEATURED_BROKER.Role}'s appraisal background helps families understand exactly where their property stands in a market with increasing competition from newer construction.`,
    },
    "executor-support": {
      intro: `Executors managing Federal Way estate property face a South King County market where values vary significantly by neighborhood, lake proximity, views, and housing age. ${FEATURED_BROKER.Role} provides the local expertise and reliable communication that Federal Way executors need alongside legal responsibilities.`,
      scenarios: [
    ...
    "downsizing-services": {
      ...
      whyLocal: `Downsizing in Federal Way involves understanding how the city's range of neighborhoods affects buyer demand for each specific property. ${FEATURED_BROKER.Role}'s South King experience helps clients understand realistic value and preparation priorities.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries handling Federal Way property matters need a real estate professional who understands the city's diverse South King County market and can provide defensible guidance. ${FEATURED_BROKER.Role} serves as a reliable resource for legal professionals with Federal Way property matters.`,
      scenarios: [
      ...
      whyLocal: `Legal professionals handling Federal Way matters need a partner who can distinguish between the city's meaningfully different neighborhoods. ${FEATURED_BROKER.Role}'s dual credentials provide the objective foundation that South King County legal proceedings require.`,
    },
    "valuation-guidance": {
      intro: `Accurate property valuation in Federal Way requires understanding the city's internal market diversity — lake-adjacent homes, mountain-view properties, town-center condos, and established ramblers each follow different value patterns. ${FEATURED_BROKER.Role} provides the valuation insight that Federal Way clients need for estate settlements, trust administration, and property decisions.`,
      scenarios: [
      ...
      whyLocal: `Federal Way's valuation landscape is complicated by geographic spread and the wide range of property types. Automated tools produce estimates that don't reflect any specific neighborhood accurately. ${FEATURED_BROKER.Role}'s credentials provide the property-specific analysis Federal Way situations demand.`,
    },
    "preparing-home-for-sale": {
      intro: `Preparing a Federal Way home for sale requires understanding buyer expectations at the property's price point and location. A home near Steel Lake faces different preparation priorities than one near the town center or in an established hillside neighborhood. ${FEATURED_BROKER.Role} helps sellers avoid both under-preparation and over-investment.`,
      scenarios: [
      ...
      whyLocal: `Preparation strategy in Federal Way depends on location and buyer demographic. Lake-adjacent homes warrant different investment than properties in the city's more affordable segments. ${FEATURED_BROKER.Role}'s South King experience helps sellers calibrate preparation to their specific submarket.`,
    },
    "divorce-related-home-sales": {
      intro: `Divorce-related property sales in Federal Way are complicated by the city's internal diversity — spouses may cite comparable sales from lake-adjacent, view, or established-neighborhood areas to support different value conclusions. ${FEATURED_BROKER.Role} provides the objective, property-specific analysis Federal Way divorce situations require.`,
      scenarios: [
      ...
      whyLocal: `Divorce negotiations involving Federal Way property are complicated by the city's wide price range. Both parties may cite real sales from different neighborhoods. ${FEATURED_BROKER.Role}'s South King experience provides the neutral analysis needed for fair resolution.`,
    },
    "trust-estate-property-sales": {
      intro: `Trust-owned property in Federal Way may be near the lakes, in established residential neighborhoods, or in areas affected by newer development. Each creates different fiduciary considerations. ${FEATURED_BROKER.Role} provides trustees with the South King County expertise that Federal Way's diverse market demands.`,
      scenarios: [
      ...
      whyLocal: `Trust property sales in Federal Way require fiduciary guidance that accounts for internal market diversity. A trustee who applies citywide averages to a lake-adjacent property creates pricing that may not withstand beneficiary scrutiny. ${FEATURED_BROKER.Role}'s credentials provide the submarket analysis fiduciary situations demand.`,
    },
  },
  ...
  burien: {
    ...
    "senior-transitions": {
      ...
      whyLocal: `Burien seniors often own homes in neighborhoods where value has shifted meaningfully. ${FEATURED_BROKER.Role}'s appraisal background helps families understand where their specific property stands relative to today's market, not general perceptions.`,
    },
    "executor-support": {
      intro: `Executors managing Burien estate property face a market where micro-neighborhoods create wide value variation within a compact area. ${FEATURED_BROKER.Role} provides the neighborhood-specific guidance and reliable communication that Burien executors need whether the property is a Three Tree Point waterfront home, a Seahurst hillside property, or a downtown-area rambler.`,
      scenarios: [
    ...
    "downsizing-services": {
      ...
      whyLocal: `Downsizing in Burien requires understanding which micro-market the property belongs to — because Three Tree Point, Seahurst, and downtown attract different buyers with different expectations. ${FEATURED_BROKER.Role}'s experience helps clients price and prepare for the right audience.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries handling Burien property matters need a real estate professional who understands how the city's dramatic micro-neighborhood differences affect valuation and sale strategy. ${FEATURED_BROKER.Role} serves as a reliable resource for legal professionals where neighborhood-specific expertise is essential.`,
      scenarios: [
    ...
    "preparing-home-for-sale": {
      ...
      whyLocal: `Preparation strategy in Burien depends entirely on which micro-neighborhood the property belongs to. A Seahurst view home warrants different investment than a corridor-area property. ${FEATURED_BROKER.Role}'s Burien experience helps sellers calibrate appropriately.`,
    },
    "divorce-related-home-sales": {
      intro: `Divorce-related property sales in Burien are complicated by dramatic internal diversity — spouses may cite comparable sales from Three Tree Point, Seahurst, or downtown areas that support wildly different value conclusions. ${FEATURED_BROKER.Role} provides the objective, micro-neighborhood analysis Burien divorce situations require.`,
      scenarios: [
      ...
      whyLocal: `Divorce negotiations involving Burien property are uniquely complicated because micro-neighborhoods create such wide value variation. Both parties may cite real Burien sales from entirely different neighborhoods. ${FEATURED_BROKER.Role}'s micro-market expertise provides the neutral analysis needed when each side's comparables tell dramatically different stories.`,
    },
    "trust-estate-property-sales": {
      intro: `Trust-owned property in Burien may be a Three Tree Point waterfront home, a Seahurst hillside view property, a downtown-adjacent rambler, or a corridor-area home — each demanding different fiduciary analysis. ${FEATURED_BROKER.Role} provides trustees with the micro-neighborhood expertise that Burien's uniquely varied market demands.`,
      scenarios: [
  ...
  bremerton: {
    ...
    "executor-support": {
      ...
      whyLocal: `Bremerton executors face a market where the city's transformation makes comparable selection unusually challenging. Recent sales in revitalizing areas may not apply to outlying neighborhoods, and vice versa. ${FEATURED_BROKER.Role}'s Kitsap experience and appraisal credentials provide the defensible, neighborhood-specific analysis that Bremerton estate situations require.`,
    },
    "downsizing-services": {
      intro: `Downsizing from a longtime Bremerton home often means leaving a community deeply connected to the Naval Shipyard, the ferry system, and the city's working-waterfront identity. ${FEATURED_BROKER.Role} helps Bremerton homeowners manage the sale with clear pricing that accounts for the city's uneven revitalization and coordination that respects the personal significance of the transition.`,
      scenarios: [
      ...
      whyLocal: `Downsizing in Bremerton requires understanding whether the specific property is in a revitalizing area or a more traditional market — because preparation strategy, buyer expectations, and realistic pricing differ significantly. ${FEATURED_BROKER.Role}'s Kitsap experience helps downsizing clients navigate a city where one-size-fits-all market guidance doesn't apply.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries handling matters involving Bremerton property need a real estate professional who understands the city's revitalization dynamics, military buyer demographics, and neighborhood-level value variation. ${FEATURED_BROKER.Role} serves as a reliable resource for Kitsap County legal professionals with Bremerton property matters where local market knowledge directly affects legal and fiduciary outcomes.`,
      scenarios: [
      ...
      whyLocal: `Legal professionals handling Bremerton matters need a partner who understands both the revitalization dynamics and the military-influenced buyer pool. ${FEATURED_BROKER.Role}'s dual credentials and Kitsap experience provide the objective foundation that Bremerton legal proceedings and fiduciary situations require in a market where neighborhood-level conditions change faster than citywide statistics reflect.`,
    },
    "valuation-guidance": {
      intro: `Accurate property valuation in Bremerton requires understanding the city's uneven revitalization — waterfront and Manette properties have appreciated on a different trajectory than established neighborhoods in the outlying areas. ${FEATURED_BROKER.Role} provides the condition-based valuation insight that Bremerton clients need for estate settlements, trust administration, and property decisions in a market where transformation creates pricing complexity.`,
      scenarios: [
      ...
      whyLocal: `Bremerton's valuation landscape is complicated by the city's uneven revitalization — automated tools averaging across the city produce estimates that may significantly over- or understate value depending on the specific neighborhood. ${FEATURED_BROKER.Role}'s on-site assessment and appraisal credentials capture the revitalization-driven differences that make Bremerton's neighborhoods so varied.`,
    },
    "preparing-home-for-sale": {
      intro: `Preparing a Bremerton home for sale requires understanding where the property falls in the city's revitalization landscape. A Manette bungalow near the ferry warrants different preparation than an established rambler in an outlying neighborhood. ${FEATURED_BROKER.Role} helps Bremerton sellers calibrate preparation to what their specific submarket rewards.`,
      scenarios: [
    ...
    "trust-estate-property-sales": {
      ...
      whyLocal: `Trust property sales in Bremerton require fiduciary guidance that accounts for the city's uneven transformation. A trustee who applies revitalization-driven appreciation to an outlying-area property creates pricing that may not withstand beneficiary scrutiny — and one who ignores Manette's growth undersells the trust asset. ${FEATURED_BROKER.Role}'s Kitsap experience provides the neighborhood-specific analysis fiduciary situations demand.`,
    },
  },
  ...
  renton: {
    ...
    "executor-support": {
      ...
      whyLocal: `Renton executors face a market where the pace of change makes pricing especially consequential — overprice and the property sits while the market may shift; underprice and beneficiaries question the executor's judgment in a city where appreciation has been significant. ${FEATURED_BROKER.Role}'s current Renton experience and appraisal credentials provide the defensible analysis executors need.`,
    },
    "downsizing-services": {
      intro: `Downsizing from a longtime Renton home means selling in one of South King County's most dynamic markets — where significant appreciation creates financial opportunity but updated buyer expectations require strategic preparation. ${FEATURED_BROKER.Role} helps Renton homeowners manage the sale with current pricing and practical coordination.`,
      scenarios: [
      ...
      whyLocal: `Downsizing in Renton's dynamic market requires understanding how the city's transformation affects the specific property. ${FEATURED_BROKER.Role}'s experience helps clients capture the appreciation their home has earned while preparing strategically for today's buyer expectations.`,
    },
    "attorney-fiduciary-support": {
      intro: `Attorneys and fiduciaries handling matters involving Renton property need a real estate professional who understands the city's rapid transformation, neighborhood-level dynamics, and how employer-driven demand affects pricing. ${FEATURED_BROKER.Role} serves as a reliable resource for South King County legal professionals with Renton property matters where current, defensible market analysis directly affects legal outcomes.`,
      scenarios: [
      ...
      whyLocal: `Legal professionals handling Renton matters need a partner who can provide current, defensible pricing in a market that moves faster than most. ${FEATURED_BROKER.Role}'s dual credentials and Renton experience provide the objective analysis that South King County legal proceedings require when yesterday's data may not reflect today's market.`,
    },
    "valuation-guidance": {
      intro: `Accurate property valuation in Renton requires current, neighborhood-specific analysis — Kennydale lakefront, Highlands development areas, Benson Hill established neighborhoods, and Landing-adjacent properties each follow different value trajectories. ${FEATURED_BROKER.Role} provides the current-market insight Renton clients need when the city's pace of change makes timing and data currency essential.`,
      scenarios: [
    ...
    "divorce-related-home-sales": {
      ...
      whyLocal: `Divorce negotiations involving Renton property are complicated by the city's rapid appreciation — both parties may be partially right, one citing the neighborhood's trajectory and the other the home's current state. ${FEATURED_BROKER.Role}'s condition-based, appraisal-grounded approach provides the neutral analysis needed when market momentum and property reality tell different stories.`,
    },
    "trust-estate-property-sales": {
      intro: `Trust-owned property in Renton may be a Kennydale lakefront home, a Highlands rambler in a developing area, or a Benson Hill established property — each requiring different fiduciary analysis in a market where values have shifted significantly. ${FEATURED_BROKER.Role} provides trustees with the current South King County expertise that Renton's dynamic market demands.`,
      scenarios: [
  ...
  enumclaw: {
    "probate-estate-sales": {
      intro: `Enumclaw's plateau location at the foot of Mount Rainier creates a market unlike anywhere else in King County — where small-town homes with mountain views, agricultural properties with acreage, and rural-residential lots with outbuildings all require specialized understanding. When probate or estate sales involve Enumclaw property, the community's unique characteristics and specific buyer demographics make locally grounded guidance essential. ${FEATURED_BROKER.Role} provides the property-specific analysis that Enumclaw executors, attorneys, and families need.`,
      scenarios: [
    ...
    "senior-transitions": {
      ...
      whyLocal: `Enumclaw seniors often own properties with features — acreage, outbuildings, mountain views, agricultural improvements — that metro-focused brokers may not know how to evaluate or market. ${FEATURED_BROKER.Role}'s experience with the plateau's unique market helps families understand how these features affect realistic pricing and which buyers to target.`,
    },
    "executor-support": {
      intro: `Executors managing estate property in Enumclaw face a market that operates differently from metro-area communities — where acreage, mountain views, agricultural features, and small-town location create pricing dynamics that require plateau-specific understanding. ${FEATURED_BROKER.Role} provides the property-specific expertise and reliable communication that Enumclaw executors need, especially when they're managing from the metro area.`,
      scenarios: [
      ...
      whyLocal: `Enumclaw executors — especially those from the metro area — face a market where standard residential valuation approaches may not apply. Properties with acreage, outbuildings, and mountain views require on-site assessment by someone who understands how these features affect value on the plateau. ${FEATURED_BROKER.Role}'s experience provides the defensible analysis executors need.`,
    },
    "downsizing-services": {
      intro: `Downsizing from a longtime Enumclaw home often means leaving a property with characteristics that don't exist in metro-area markets — acreage, mountain views, outbuildings, or agricultural features that have defined the homeowner's daily life. ${FEATURED_BROKER.Role} helps Enumclaw homeowners manage the sale with pricing that accurately reflects these unique features and coordination appropriate for the plateau's specialized market.`,
      scenarios: [
    ...
    "attorney-fiduciary-support": {
      ...
      whyLocal: `Legal professionals handling Enumclaw matters need a partner who understands that plateau properties don't follow metro-area valuation rules. ${FEATURED_BROKER.Role}'s dual credentials and experience with rural-residential properties provide the objective foundation that legal proceedings involving Enumclaw's unique market require.`,
    },
    "valuation-guidance": {
      intro: `Accurate property valuation in Enumclaw requires understanding the plateau's specialized market — where mountain views, acreage, agricultural features, and distance from employment centers create value patterns that automated tools and metro-focused analysis consistently miss. ${FEATURED_BROKER.Role} provides the plateau-specific insight that Enumclaw clients need for estate settlements, trust administration, and informed decisions.`,
      scenarios: [
      ...
      whyLocal: `Enumclaw's valuation landscape is fundamentally different from metro-area markets. Automated tools trained on suburban comparable patterns produce estimates that miss the acreage premiums, view values, and agricultural-feature contributions that define plateau property worth. ${FEATURED_BROKER.Role}'s experience with these property types provides the analysis Enumclaw situations require.`,
    },
    "preparing-home-for-sale": {
      intro: `Preparing an Enumclaw home for sale requires understanding the plateau market's specific buyer expectations — which are fundamentally different from metro-area standards. Buyers looking at Enumclaw properties often value views, land, outbuildings, and rural character over the kitchen-and-bathroom updates that drive metro-area sales. ${FEATURED_BROKER.Role} helps Enumclaw sellers prepare strategically for their actual buyer pool.`,
      scenarios: [
