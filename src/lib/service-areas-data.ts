...
const cityContent: Record<string, Omit<CityData, "name" | "slug" | "county" | "countySlug">> = {
  ...
  kirkland: {
    ...
    brokerAppraiserValue: "Kirkland's appeal lies in its location, walkability, and neighborhood character — but those qualities can be difficult to quantify with automated tools. Real Property Planning evaluates each property based on its actual condition, lot characteristics, and realistic buyer demand in Kirkland. Our appraisal background provides an analytical foundation that supports confident pricing decisions, especially for properties that need preparation or have deferred maintenance.",
    localSituations: [
  ...
  redmond: {
    ...
    heroIntro: "Redmond's real estate market reflects its dual identity — a technology hub anchored by Microsoft and Nintendo alongside established residential neighborhoods that predate the tech boom by decades. Estate properties in Redmond range from mid-century homes in older neighborhoods to newer construction in master-planned communities, each with its own buyer expectations and pricing dynamics. Real Property Planning works with executors and families throughout Redmond, bringing the local Eastside expertise needed to navigate this varied market accurately.",
    localKnowledge: "Redmond's housing stock includes everything from older homes in downtown Redmond and Education Hill to newer construction in Redmond Ridge, Trilogy, and the Overlake area. These submarkets behave differently, and an estate or inherited property may need very different preparation and pricing strategies depending on location. Real Property Planning's familiarity with Redmond's micro-markets helps clients avoid the common mistake of applying a one-size-fits-all approach.",
    brokerAppraiserValue: "Redmond's tech-driven market creates wide value spreads between neighborhoods — an Education Hill rambler, an Overlake townhome near transit, and a Trilogy active-adult property each serve fundamentally different buyer pools. Real Property Planning's certified appraisal credentials allow us to evaluate which comparables truly apply based on a property's specific location, age, and condition, providing the defensible analysis that Redmond estate and transition situations require.",
    localSituations: [
  ...
  bothell: {
    ...
    localKnowledge: "Bothell's real estate spans mid-century homes in the original downtown core, newer construction near Canyon Park and the University of Washington Bothell campus, and properties along the river corridor. The city's position across two counties means comparable sales may come from either side of the boundary, and buyer demographics can shift meaningfully between neighborhoods. Real Property Planning's experience with Bothell's specific market dynamics helps clients price and position properties accurately.",
    brokerAppraiserValue: "Bothell's dual-county position creates a valuation challenge that most brokers don't encounter — comparable sales from King County and Snohomish County may support different pricing conclusions for the same property. Real Property Planning's certified appraisal credentials allow us to evaluate which comparables truly apply based on the property's specific location, buyer pool, and neighborhood context. This cross-county analytical foundation is especially valuable for estate and transition properties where defensible pricing is essential.",
    localSituations: [
  ...
  issaquah: {
    ...
    localFaqs: [
      ...
      { question: "How does our team determine the right price for an Issaquah estate property?", answer: "Through a condition-adjusted comparable analysis grounded in certified appraisal methodology. This means our team doesn't just pull nearby sales — our team evaluates how the subject property's specific condition, location within Issaquah, and current buyer demand affect its realistic market position. The result is a defensible price that holds up to scrutiny from co-heirs, attorneys, and the market itself." },
      { question: "Does our team help with cleanout and preparation?", answer: "Yes — our team coordinates with trusted local vendors for estate cleanout, targeted repairs, and staging as needed. We evaluate each potential improvement through a return-on-investment lens so families don't over-spend on preparation that won't meaningfully improve the outcome." },
    ],
  },
  sammamish: {
    tone: "premium",
  ...
  seattle: {
    ...
    localFaqs: [
      ...
      { question: "Does our team handle estate properties in all Seattle neighborhoods?", answer: "Yes — our team serves the full city of Seattle, including Capitol Hill, Ballard, Magnolia, West Seattle, Beacon Hill, Rainier Valley, Northgate, Shoreline-adjacent neighborhoods, and everything in between. Neighborhood knowledge is a core part of how our team approaches pricing and preparation strategy." },
    ],
  },
  renton: {
    tone: "urban",
    ...
    heroIntro: "Renton's real estate market spans a wide range — from established neighborhoods near downtown to newer construction in the Highlands and communities bordering Bellevue and Newcastle. Estate properties in Renton require local pricing knowledge that accounts for this variation. Real Property Planning works with executors and families throughout Renton, providing honest, condition-adjusted guidance that reflects the specific neighborhood, not just broad county trends.",
  ...
  auburn: {
    ...
    localKnowledge: "Auburn's housing market includes mid-century homes in the valley, newer developments on the hillside areas, and properties with larger lots along the rural edges. The city's proximity to major employers and transportation corridors influences buyer demand in ways that vary by neighborhood. Real Property Planning helps Auburn clients understand these dynamics and position estate or transition properties effectively based on their specific location and condition.",
  },
  "federal-way": {
    tone: "suburban",
  ...
  seatac: {
    ...
    localKnowledge: "SeaTac's housing market is compact and influenced by its airport-adjacent location. Properties vary significantly in value based on their proximity to flight paths, commercial zones, and the quieter residential pockets of the city. Real Property Planning helps clients navigate SeaTac's unique market dynamics with honest, condition-based guidance that accounts for the factors specific to this community.",
  },
  tukwila: {
    tone: "urban",
    ...
    localKnowledge: "Tukwila's residential areas include neighborhoods near Foster Point, Riverton Heights, and the hillside areas with views toward the Cascades. The city's commercial centers, light rail access, and proximity to major employers all influence buyer demographics. Real Property Planning helps clients understand how Tukwila's unique position as both a commercial hub and residential community affects realistic property values.",
  },
  woodinville: {
    tone: "rural",
  ...
  kenmore: {
    ...
    localKnowledge: "Kenmore's housing includes waterfront and water-view properties along Lake Washington, established mid-century homes in the hillside neighborhoods, and newer developments near the city center. Proximity to the lake, trail access, and views all significantly influence value. Real Property Planning helps Kenmore clients understand how these factors — combined with property condition — affect realistic market positioning.",
  },
  "maple-valley": {
    tone: "suburban",
  ...
  enumclaw: {
    ...
    localKnowledge: "Enumclaw's housing market includes homes in the walkable downtown area, established neighborhoods, and properties with acreage and mountain views in the surrounding plateau. The community's agricultural heritage means some properties include outbuildings, livestock facilities, or unique lot configurations. Real Property Planning helps clients understand how these property characteristics and Enumclaw's specific buyer demographics affect realistic pricing.",
  ...
  duvall: {
    ...
    localKnowledge: "Duvall's housing market includes homes in the walkable town center, newer subdivisions, and larger rural properties along the valley. The community's small-town identity and agricultural surroundings create a market where buyer expectations differ from more urban areas. Real Property Planning's appraisal background helps clients in Duvall understand how property size, rural features, and community character affect realistic valuation.",
    brokerAppraiserValue: "Duvall's Snoqualmie Valley location means many properties have features — river proximity, acreage, agricultural outbuildings, equestrian facilities — that automated tools trained on suburban data consistently misjudge. Real Property Planning's certified appraisal background provides the property-specific analysis Duvall clients need, especially when estate or trust situations require defensible pricing for homes that don't fit standard residential comparable patterns.",
    localSituations: [
  ...
  brier: {
    ...
    localKnowledge: "Brier's housing stock tends toward older single-family homes on lots that are significantly larger than those in neighboring communities. The community's zoning protects its semi-rural character, which appeals to buyers seeking privacy and space. Real Property Planning helps clients understand how Brier's unique lot sizes, mature landscaping, and residential character affect property values — factors that automated estimates often misjudge in a community this small.",
  },
  mukilteo: {
    tone: "waterfront",
  ...
  everett: {
    ...
    aeoAnswer: "Everett's evolving market offers opportunity for estate property sales — but realistic pricing and practical preparation are key. Real Property Planning evaluates each property's condition, identifies cost-effective improvements, and manages the full sale process for executors and families who need clear, honest guidance.",
    aeoSupportBullets: [
  ...
  "woodinville-snohomish": {
    ...
    localKnowledge: "Properties in the Snohomish County Woodinville area range from estate-style homes near the wine district to rural properties with acreage and newer suburban developments. Real Property Planning's appraisal background helps clients in this area understand how the blend of rural, suburban, and wine-country characteristics affects property values.",
  },
  snohomish: {
    tone: "smalltown",
  ...
  arlington: {
    ...
    localKnowledge: "Arlington's housing includes established homes in the downtown area, suburban developments, and properties with acreage in the surrounding areas toward Darrington and the foothills. The community's balance of small-city accessibility and rural character creates a market where property features like land size, outbuildings, and road access meaningfully affect value. Real Property Planning's appraisal credentials help Arlington clients understand these dynamics.",
  },
  monroe: {
    tone: "smalltown",
    ...
    localKnowledge: "Monroe's housing ranges from homes near the historic downtown and fairgrounds to newer subdivisions and larger rural properties along the valley. The community's accessibility via US-2, its proximity to both employment centers and outdoor recreation, and its range of property sizes all influence buyer demographics. Real Property Planning helps Monroe clients understand how these factors affect value for estate and transition properties.",
  },
  stanwood: {
    tone: "smalltown",
  ...
  "university-place": {
    ...
    heroIntro: "Lakewood and University Place are established Pierce County communities with distinct characters — Lakewood's diverse housing stock and military-adjacent economy, and University Place's waterfront-adjacent neighborhoods and strong community identity. Estate properties in both communities require pricing that reflects the specific neighborhood rather than broad county trends. Our team works with executors and families throughout both communities with the condition-adjusted, location-specific guidance these markets require.",
  ...
  sumner: {
    ...
    localKnowledge: "Sumner's housing includes established homes near downtown, newer construction on the edges of the city, and properties influenced by the valley's agricultural context. The community's small-town character and proximity to Puyallup and Auburn create a buyer pool with specific expectations. Real Property Planning helps Sumner clients position estate and transition properties realistically within this local context.",
  },
  orting: {
    tone: "smalltown",
  ...
  graham: {
    ...
    localKnowledge: "Graham's housing ranges from established homes on larger lots to newer subdivisions and properties with acreage, outbuildings, and agricultural uses. The community's rural character means property features like land area, well and septic systems, and road access meaningfully affect value. Real Property Planning's appraisal credentials help Graham clients understand how these rural-specific factors influence realistic property pricing.",
  },
  dupont: {
    tone: "military",
  ...
  fife: {
    ...
    localKnowledge: "Fife's residential areas are relatively compact, with established neighborhoods surrounded by commercial and industrial zones. The community's location along major transportation corridors and proximity to Tacoma and Federal Way influence buyer demographics. Real Property Planning helps Fife clients navigate the community's specific market dynamics with clear, condition-based guidance.",
  },
  milton: {
    tone: "suburban",
    ...
    localKnowledge: "Milton's housing is primarily established single-family homes in a compact residential setting. The community's position across two counties and its proximity to Edgewood, Federal Way, and Fife influence comparable sales and buyer demographics. Real Property Planning helps Milton clients understand how these cross-boundary dynamics and the community's small-market character affect realistic property values.",
  },
  edgewood: {
    tone: "rural",
    ...
    localKnowledge: "Edgewood's housing tends toward larger-lot single-family homes with a rural-residential feel, along with some newer development. The community's zoning protects its semi-rural character, which appeals to buyers seeking space and privacy. Real Property Planning helps clients understand how Edgewood's distinctive lot sizes and residential character affect property values — factors that generic pricing tools often undervalue.",
  },
  buckley: {
    tone: "smalltown",
  ...
  eatonville: {
    ...
    localKnowledge: "Eatonville's housing ranges from established homes near the compact town center to rural properties with acreage and mountain access. The community's tourism connection to Mount Rainier and its agricultural character create a niche buyer pool. Real Property Planning helps Eatonville clients understand how the community's rural character and limited market activity affect realistic property values.",
  },
  ...
  silverdale: {
    ...
    aeoAnswer: "Silverdale's proximity to Naval Base Kitsap and its blend of established and newer neighborhoods create specific dynamics for estate property sales. Real Property Planning provides practical guidance on pricing, preparation, and family coordination — helping executors and trustees navigate the process with clarity.",
    aeoSupportBullets: [
  ...
  poulsbo: {
    ...
    localKnowledge: "Poulsbo's housing ranges from historic homes near the waterfront and downtown to newer developments and larger rural properties in the surrounding area. Waterfront access, Liberty Bay views, and proximity to downtown all significantly influence value. Real Property Planning's appraisal credentials are particularly valuable in Poulsbo, where the range of property types and the community's distinctive character make generic pricing approaches unreliable.",
    brokerAppraiserValue: "Poulsbo's mix of waterfront homes, village-adjacent properties, and rural-residential lots creates a market where automated pricing tools fall short. Real Property Planning evaluates each property on its actual characteristics — Liberty Bay proximity, view corridors, lot topography, and condition — providing the kind of grounded analysis that Poulsbo sellers and their advisors need for confident decisions.",
    localSituations: [
  ...
  "mount-vernon": {
    ...
    aeoAnswer: "Mount Vernon estate properties benefit from the city's position as Skagit County's commercial center, with steady local demand and spillover from buyers priced out of King and Snohomish Counties. Probate proceedings are administered through Skagit County Superior Court in Mount Vernon. Our team provides condition-adjusted analysis and full local coordination for families managing the process remotely.",
    aeoSupportBullets: [
...
export function getToneHowWeHelpLead(cityName: string, serviceName: string, tone?: CommunityTone): string {
  switch (tone) {
    case "premium":
      return `Real Property Planning's dual credentials as a licensed broker and certified appraiser inform every step of the ${serviceName.toLowerCase()} process in ${cityName}:`;
    case "urban":
      return `Real Property Planning provides experienced guidance tailored to ${cityName}'s market:`;
    case "waterfront":
      return `Real Property Planning brings locally informed guidance to ${serviceName.toLowerCase()} in ${cityName}:`;
    case "smalltown":
    case "rural":
      return `Real Property Planning provides steady, hands-on guidance through the ${serviceName.toLowerCase()} process:`;
    case "military":
...
export function getToneCTAHeading(cityName: string, serviceName: string, tone?: CommunityTone): string {
  switch (tone) {
    ...
    case "waterfront":
      return `Talk with our team About Your Property`;
    default:
...
const deepWhyLocalBank: Record<string, Partial<Record<CommunityTone, string>>> = {
  "probate-estate-sales": {
    premium: `Probate properties in premium markets like {city} often appear to be worth more than their actual condition supports — or less, if unique features are overlooked. Real Property Planning's on-site evaluation accounts for the specific factors that drive value in {city}: neighborhood positioning, lot characteristics, view quality, and the realistic cost of bringing deferred-maintenance properties to market standard. This is valuation guidance built on local knowledge, not automated assumptions.`,
    urban: `Estate properties in {city} exist within a complex urban market where neighborhood, zoning, and property type all affect value. A probate property in one part of {city} may be best positioned as a renovation opportunity; in another area, it may attract developers. Real Property Planning's familiarity with {city}'s neighborhood-level dynamics allows him to advise executors and attorneys on the most realistic path to a successful sale.`,
    suburban: `In {city}'s suburban market, estate properties often compete against newer construction and recently updated homes. Buyers have expectations shaped by move-in-ready listings, which means a probate property with deferred maintenance or dated finishes needs careful pricing and preparation strategy. Real Property Planning helps families and executors understand how their specific property fits within {city}'s competitive landscape.`,
    waterfront: `Waterfront estate properties in {city} require specialized local knowledge — view premiums, waterfront access quality, marine exposure, and seasonal market patterns all affect how these properties should be priced and presented. Generic comparable sales from non-waterfront areas are unreliable guides. Real Property Planning's appraisal credentials and local experience provide the waterfront-specific insight that estate sales in {city} require.`,
    smalltown: `In {city}'s smaller market, comparable sales may be limited and market timing can matter more than in larger communities. Estate properties here often have unique features — larger lots, older construction, or characteristics that don't fit neatly into automated valuation models. Real Property Planning provides the in-person, condition-based analysis that probate sales in {city}'s market require.`,
    military: `{city}'s real estate market is influenced by military presence — PCS cycles, VA-eligible buyer demographics, and proximity to installations all affect property demand and pricing. For estate sales in {city}, understanding these dynamics helps executors price accurately and reach the right buyer pool. Real Property Planning's local knowledge accounts for the military-market factors that generic pricing tools miss.`,
    rural: `Rural estate properties in {city} often include features that standard market analysis doesn't cover — acreage, outbuildings, septic and well systems, or road access limitations. These characteristics can significantly affect value, and they require on-the-ground evaluation rather than desk-based estimates. Real Property Planning provides the hands-on assessment that rural probate and estate sales in {city} demand.`,
  },
  "senior-transitions": {
    premium: `Senior transition properties in {city} are often well-maintained but may show their age in ways that affect premium-market buyer expectations. Understanding how kitchen vintage, systems age, and cosmetic updates affect value in {city}'s competitive market helps families make smart preparation decisions. Real Property Planning's appraisal background provides the condition-specific insight these decisions require.`,
    urban: `In {city}'s urban environment, a senior selling a longtime home may be leaving a neighborhood that has changed dramatically since they moved in. Understanding how urban redevelopment, shifting demographics, and neighborhood trajectory affect value helps families make informed decisions. Real Property Planning's experience across {city}'s neighborhoods provides the local context these transitions require.`,
    suburban: `In {city}, longtime family homes being sold during a senior transition often have a character that newer homes lack — but they may also need updates to meet current buyer expectations. Real Property Planning helps families understand the balance: which improvements will affect the sale price, which won't, and how to prepare the home in a way that makes financial sense without unnecessary stress or expense.`,
    waterfront: `Waterfront homes in {city} that have been in the same family for years may have specialized maintenance needs — marine exposure wear, dock conditions, or drainage systems — that affect both value and buyer interest. Real Property Planning provides families with a realistic assessment of what these properties are worth and what preparation makes sense given {city}'s waterfront market dynamics.`,
    smalltown: `Senior transitions in {city} are often deeply personal — the family has lived in the same home for decades, and the community knows them. Real Property Planning brings local understanding and patience to these situations, helping families navigate the sale at a pace that works while providing honest guidance on what the home is worth in {city}'s specific market.`,
    military: `In {city}, many senior transitions involve veteran families whose property decisions intersect with retirement planning and military benefit considerations. Real Property Planning's practical, locally grounded approach helps these families understand their property's realistic value and coordinate the sale alongside their broader transition planning.`,
    rural: `Rural senior transitions in {city} often involve properties with features that standard market analysis doesn't address — larger lots, outbuildings, deferred land maintenance, or systems like well and septic that need assessment. Real Property Planning provides the on-the-ground evaluation these properties need, helping families understand the full picture before making decisions.`,
  },
  "downsizing-services": {
    premium: `Homeowners downsizing from premium properties in {city} often face a tension between their home's emotional value and its market value. A home that has been well-loved for decades may not show as well as a recently updated property. Real Property Planning's appraisal perspective helps owners see their home through the market's eyes — understanding exactly where their property stands and which preparation decisions make financial sense.`,
    urban: `Downsizing in {city}'s urban market involves specific considerations — the property's neighborhood trajectory, density changes, transit development, and competition from new construction all influence realistic pricing. Real Property Planning's neighborhood-level market knowledge helps homeowners in {city} make clear-eyed decisions about timing, preparation, and pricing strategy.`,
    suburban: `For suburban homeowners in {city}, downsizing from a family home raises practical questions about value, preparation, and timing. The home may have been a perfect fit for a growing family but now competes against newer, more efficient construction. Real Property Planning helps {city} homeowners understand how condition, age, and neighborhood context affect what their home is actually worth.`,
    waterfront: `Downsizing from a waterfront property in {city} carries unique valuation considerations. The water premium is real, but it depends on specific factors — view quality, access type, shoreline condition — that vary property by property. Real Property Planning's appraisal credentials provide the precise, waterfront-specific analysis that {city} homeowners need for confident pricing decisions.`,
    smalltown: `In {city}, homeowners who have lived in the same home for decades may have a strong sense of their property's value — but the market may see it differently. Real Property Planning provides honest, condition-based guidance that helps homeowners in {city}'s smaller market understand realistic pricing without the uncomfortable surprise that sometimes comes with listing a well-loved but dated home.`,
    military: `Military families downsizing in {city} often have practical, timeline-driven priorities. The sale needs to happen efficiently, pricing needs to be realistic, and the process needs to work within the constraints of a military transition. Real Property Planning's practical approach to valuation and sale coordination aligns well with the no-nonsense expectations of military-connected homeowners.`,
  ...
  "executor-support": {
    ...
    urban: `Managing estate property in {city}'s urban market can be complex — the property's neighborhood context, zoning, and condition all affect strategy. An executor may need guidance on whether the property's best use is as a residence, a renovation opportunity, or a lot sale. Real Property Planning's familiarity with {city}'s neighborhood dynamics helps executors make these decisions with confidence.`,
    suburban: `Executors in {city} often manage a home that was the center of family life — well-loved but possibly showing its age. Understanding how that property competes in {city}'s suburban market, where buyers often expect updated or move-in-ready homes, is critical for realistic pricing and smart preparation decisions. Real Property Planning provides this context through condition-based analysis, not guesswork.`,
    waterfront: `Waterfront estate properties in {city} present specific challenges for executors — view premiums, marine condition factors, seasonal market timing, and limited comparable sales all complicate pricing. Real Property Planning's appraisal credentials and waterfront experience help executors navigate these factors with clarity and defensible pricing documentation.`,
    smalltown: `In {city}'s smaller market, executors benefit from working with someone who knows the community and understands the local dynamics. Comparable sales may be limited, and the property may have features that don't fit standard valuation models. Real Property Planning provides the hands-on, locally grounded guidance that executor responsibilities in {city} require.`,
    military: `Executors in {city}'s military-connected market need a broker who understands how base proximity, PCS cycles, and VA buyer demographics affect realistic property demand and pricing. Real Property Planning accounts for these military-market factors to help executors price estate property accurately and reach the right buyer pool efficiently.`,
    rural: `Rural estate properties in {city} often include features that complicate an executor's job — acreage, outbuildings, well/septic systems, easements, or mixed-use zoning. Standard desktop valuations miss these factors. Real Property Planning provides the on-the-ground evaluation that rural estate property in {city} requires for responsible pricing and sale coordination.`,
  },
  "attorney-fiduciary-support": {
    premium: `Attorneys and fiduciaries managing property matters in {city}'s premium market need a real estate partner who provides defensible pricing opinions, not aspirational estimates. Real Property Planning's certified appraisal background produces documentation that withstands court scrutiny and beneficiary challenge — the kind of property-specific analysis that premium estate and trust situations demand.`,
    urban: `Legal professionals with property matters in {city}'s diverse urban market need a broker who can navigate different property types, neighborhood contexts, and market dynamics. Real Property Planning's experience across {city}'s neighborhoods — combined with our appraisal credentials — provides the versatile, defensible real estate support that attorneys and fiduciaries need for their client matters.`,
    ...
    waterfront: `Waterfront property matters in {city} require specialized valuation knowledge that most brokers don't have. View premiums, shoreline access quality, marine condition factors, and seasonal demand patterns all affect defensible pricing. Real Property Planning's appraisal background provides attorneys and fiduciaries with the waterfront-specific analysis these situations require.`,
    smalltown: `In {city}'s smaller market, the relationship between legal professionals and their real estate partners carries weight — both professionally and within the community. Real Property Planning provides the kind of dependable, locally informed service that earns trust over time, handling property matters with the care and discretion that {city}'s community context requires.`,
    military: `Attorneys serving military families in {city} need a real estate partner who understands PCS timelines, VA loan considerations, and the practical realities of military-connected property transitions. Real Property Planning's familiarity with {city}'s military-influenced market dynamics allows him to provide the efficient, knowledgeable support these situations require.`,
    rural: `Rural property matters in {city} often involve characteristics that standard market analysis doesn't address — acreage valuations, easement questions, water rights, septic/well conditions, and access issues. Real Property Planning provides attorneys and fiduciaries with the hands-on, rural-specific property analysis that these matters require for defensible decision-making.`,
  },
  "valuation-guidance": {
  ...
  "preparing-home-for-sale": {
    ...
    smalltown: `Preparing a home for sale in {city} is often deeply personal — the home may have been in the family for decades. Real Property Planning helps families approach preparation practically: which improvements matter in {city}'s local market, which are not worth the investment, and how to manage the cleanout and vendor coordination with care and efficiency.`,
    military: `Preparing a home for sale in {city} on a military timeline requires efficiency and clear priorities. Real Property Planning helps military families and executors focus preparation on the improvements that actually affect sale outcomes — not cosmetic perfection, but practical preparation that positions the property well for {city}'s buyer pool within the available timeframe.`,
    rural: `Rural property preparation in {city} often extends well beyond the house — outbuildings, land maintenance, fencing, well/septic condition, and access paths all need assessment. Real Property Planning coordinates all aspects of rural preparation, helping sellers understand which investments matter and which are not worth the expense given {city}'s rural buyer expectations.`,
  },
  "divorce-related-home-sales": {
    premium: `Divorce-related sales in {city}'s premium market carry high financial stakes — accurate pricing is essential for a fair settlement, and both parties typically want defensible numbers. Real Property Planning's certified appraisal background provides the objective, property-specific analysis that premium divorce sales require — pricing grounded in actual condition and market positioning, not automated estimates that miss critical factors.`,
    urban: `In {city}'s diverse urban market, divorce-related property valuations are complicated by neighborhood dynamics, property type variations, and rapidly shifting market conditions. Real Property Planning's neighborhood-level expertise provides both parties and their attorneys with pricing guidance that reflects the property's specific location and condition — not citywide averages.`,
    suburban: `Divorce-related home sales in {city}'s suburban market require objective guidance from a broker who won't take sides. Real Property Planning provides condition-based pricing that both parties can rely on — grounded in local comparable sales and honest assessment of the property's condition, not emotional attachment or aspirational estimates.`,
    waterfront: `Waterfront divorce sales in {city} are inherently complex — the water premium is real but varies significantly by specific view, access, and condition. Both parties need defensible pricing that accurately reflects these factors. Real Property Planning's appraisal credentials provide the objective, waterfront-specific analysis that fair settlement requires.`,
    smalltown: `Divorce-related property sales in {city} add a layer of community sensitivity. Both parties benefit from a broker who can handle the situation with discretion and professionalism while providing honest, defensible pricing in a market where comparable sales may be limited. Real Property Planning brings that combination of objectivity and local understanding.`,
    military: `Military divorce sales in {city} may involve unique considerations — BAH calculations, PCS timing, VA loan assumptions, and service-related scheduling constraints. Real Property Planning's familiarity with {city}'s military-connected market dynamics helps both parties and their attorneys navigate these factors alongside the standard property sale process.`,
  ...
  "trust-estate-property-sales": {
    premium: `Trust property sales in {city}'s premium market require pricing that meets fiduciary standards — defensible, well-documented, and grounded in actual property analysis. Real Property Planning's dual credentials provide trustees with the professional-grade valuation and sale coordination that premium trust properties require, supporting both sound decision-making and clear beneficiary communication.`,
    urban: `Managing trust property in {city}'s urban market requires understanding how diverse property types, neighborhood dynamics, and market pace affect sale strategy. Real Property Planning's experience across {city}'s neighborhoods helps trustees navigate these considerations while maintaining the documentation and communication standards that trust administration demands.`,
    suburban: `Trust property sales in {city}'s suburban market benefit from a broker who combines reliable execution with transparent pricing documentation. Real Property Planning's approach — condition-based assessment, clear communication, and consistent follow-through — provides the professional partnership that trustees and their attorneys need for fiduciary-appropriate property disposition.`,
    waterfront: `Trust-owned waterfront properties in {city} present specialized valuation challenges — view premiums, marine condition factors, and seasonal market patterns all affect pricing in ways that standard comparisons don't capture. Real Property Planning's appraisal credentials provide the property-specific analysis that waterfront trust property sales require for defensible, fiduciary-appropriate pricing.`,
    smalltown: `Trust property sales in {city}'s smaller market require a broker who combines local market knowledge with the documentation standards that fiduciary responsibilities demand. Real Property Planning provides that combination — locally grounded assessment, clear pricing rationale, and communication that keeps trustees, beneficiaries, and attorneys informed throughout the process.`,
    military: `Trust property in {city}'s military-connected market requires understanding how base proximity, PCS cycles, and VA buyer activity affect realistic pricing and market timing. Real Property Planning accounts for these local dynamics while maintaining the professional documentation and communication standards that trust administration requires.`,
    rural: `Rural trust properties in {city} often include characteristics — acreage, outbuildings, land features, access considerations — that standard market analysis doesn't address. Real Property Planning provides the hands-on evaluation and clear documentation that trustees need for defensible pricing and responsible sale coordination of rural trust-held property.`,
  },
};
...
const deepCTABodies: Record<CommunityTone, string[]> = {
  premium: [
    ...
    "Real Property Planning provides experienced, discreet guidance for clients and professionals in {city}.",
  ...
  waterfront: [
    ...
    "Real Property Planning provides locally informed guidance for property transitions in {city}.",
