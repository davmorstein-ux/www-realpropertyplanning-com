...
const cityContent: Record<string, Omit<CityData, "name" | "slug" | "county" | "countySlug">> = {
  ...
  bellevue: {
    ...
    aeoAnswer: "Bellevue's market rewards accurate pricing and professional presentation — even for estate properties with deferred maintenance. Buyers in Bellevue have high expectations for condition and finish, which means the preparation strategy matters as much as the pricing. David evaluates each property with both a broker's understanding of buyer expectations and an appraiser's methodology for condition-adjusted value — so families get honest guidance on what to address before listing and what to leave alone.",
    localFaqs: [
      { question: "How is selling an inherited Bellevue home different from a standard sale?", answer: "Bellevue's buyer pool includes tech-sector employees, international buyers, and move-up families — all of whom have specific expectations. An estate home with dated finishes or deferred maintenance needs to be priced and positioned carefully to appeal to the buyers most likely to see its value. David's preparation analysis helps families make targeted decisions rather than over-investing in renovations that don't deliver return." },
      { question: "What about inherited condos in the Bellevue downtown corridor?", answer: "Condo sales in Bellevue involve HOA documentation, building financials, and resale certificate requirements that add complexity to an already detailed process. David coordinates the full documentation process so executors don't have to manage it independently." },
    ],
  },
  kirkland: {
    tone: "suburban",
  ...
  issaquah: {
    ...
    localFaqs: [
      ...
      { question: "Does David help with cleanout and preparation?", answer: "Yes — David coordinates with trusted local vendors for estate cleanout, targeted repairs, and staging as needed. He evaluates each potential improvement through a return-on-investment lens so families don't over-spend on preparation that won't meaningfully improve the outcome." },
    ],
  },
  sammamish: {
    tone: "premium",
  ...
  "mount-vernon": {
    ...
    aeoAnswer: "Mount Vernon estate properties benefit from the city's position as Skagit County's commercial center, with steady local demand and spillover from buyers priced out of King and Snohomish Counties. Probate proceedings are administered through Skagit County Superior Court in Mount Vernon. David provides condition-adjusted analysis and full local coordination for families managing the process remotely.",
    aeoSupportBullets: [
    ...
    localFaqs: [
      {
        ...
        answer: "These communities attract buyers who are specifically seeking what they offer — rural character, agricultural surroundings, small-community lifestyle. Marketing to that buyer means understanding them: where they come from, what they're looking for, and what they'll pay for the right property in the right condition. David's approach to small Skagit community sales is calibrated to the actual buyer demand in these specific locations, not derived from broader county averages that don't apply here.",
      },
      {
