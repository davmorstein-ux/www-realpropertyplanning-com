export interface EstateProbateTopic {
  title: string;
  href: string;
}

export const estateProbateTopics: EstateProbateTopic[] = [
  ...
  { title: "Preparing the Property", href: "/estate-probate-inherited-property/preparing-the-property" },
