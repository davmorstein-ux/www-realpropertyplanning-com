...
export const CONTRACT_LABELS: Record<AFHContract, string> = {
  ...
  wcfPrivateDutyNursing: "WCF Private Duty Nursing",
...
export const medicaidAccepting = (facilities: AFHFacility[]) =>
  facilities.filter((f) => f.acceptsMedicaid);
...
export function cityStats(facilities: AFHFacility[], citySlug: string): AFHCityStats | null {
  ...
  return {
    ...
    specialtyCounts: {
      ...
      developmentalDisabilities: inCity.filter((f) =>
