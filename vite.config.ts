...
interface RouteMeta {
  ...
  /**
   * Prerender the live AFH for-sale inventory (summary table, listing cards,
   * ItemList JSON-LD) from src/data/afhListings.ts into the static HTML,
...
const ROUTE_METADATA: Record<string, RouteMeta> = {
  ...
  "/afh-club": {
    ...
    faq: [
      { q: "How many adult family homes are there in Washington?", a: "More than 6,000 statewide, according to DSHS licensing records, concentrated in King, Pierce, Snohomish, Spokane, Clark, and Thurston counties. AFH Club's directory lists every one by city, in all 39 counties. Most are licensed for six residents and most accept Medicaid." },
  ...
  "/afh-club/afh-property-classifications": {
    ...
    h1: "Is It Really an Adult Family Home? How to Read AFH Listings in Washington",
    quickAnswerQ: "What makes a house a licensed adult family home in Washington?",
    quickAnswerA: "Two separate approvals. First, the local city or county building official inspects the house against the Adult Family Home Local Building Inspection Checklist developed by the Washington Association of Building Officials (WABO) with DSHS, and signs it as passed. Second, DSHS licenses a qualified provider to operate an adult family home at that address. A house with enough bedrooms, a ramp, or grab bars has neither approval until both have happened, and a passed inspection alone is not a license. The license belongs to the provider and the address; a buyer must obtain their own through the DSHS Change of Ownership process.",
    intro: "Brokers write 'adult family home', 'AFH-ready', 'WABO-approved' and 'potential AFH' into listings for houses that range from a fully licensed, occupied care home to an ordinary four-bedroom with wide hallways. None of those phrases is a legal status. AFH Club labels every listing and closed sale by what the record actually supports rather than by the broker's description.",
    sections: [
      "Operating AFH — Licensed by DSHS and caring for residents today; the address appears in the DSHS locator. The real estate, the business, or both may convey; the buyer still relicenses through Change of Ownership.",
      "Licensed AFH — no residents — Holds a current license but has no census and no income to underwrite. The building has passed inspection; the buyer relicenses and starts from zero.",
      "Former AFH — Operated as a licensed home in the past, no license today. The inspected floor plan may have changed and the checklist has been revised; expect a new inspection before relicensing.",
      "AFH-ready (WABO) — The owner can produce a signed building inspection checklist, but the home has never been licensed. A house built to AFH code, not a care business.",
      "AFH potential — not verified — The listing describes the house as suitable for, or convertible to, an adult family home and nothing in the record supports more. A marketing description; the buyer takes on the entire conversion and licensing.",
      "Key requirements — Resident bedrooms: outside room, 80 sq ft for one resident or 120 for two, smoke alarm, escape window with a sill no higher than 44 inches and a clear opening of at least 5.7 sq ft (24 in high, 20 in wide). Exit door at least 32 in clear width; one-hand hardware. Ramps 1:12 with 3x3 ft landings and handrails both sides. Grab bars both sides of toilets; showers at least 30 by 48 in. Smoke alarms every level and every bedroom, CO alarms each required level. Bedrooms classified Type S, NS1 or NS2 by evacuation route. DSHS licensors also expect 27-inch resident bedroom doorways.",
      "Verify it yourself — Search the address in the DSHS Adult Family Home Locator or AFH Club's licensed-home directory; not listed means not licensed. Then request the current DSHS license, the signed building inspection checklist with its floor plan, permits and finals for AFH work, records of changes since inspection, recent DSHS inspection reports, and written confirmation of what is being sold and at what prices.",
    ],
    faq: [
      { q: "Does 'WABO-approved' mean the home is a licensed adult family home?", a: "No. WABO co-wrote the checklist with DSHS; the local building official performs the inspection. A passed checklist confirms the building met code at the time of inspection. Only DSHS issues the license, to a specific provider at a specific address." },
      { q: "If I buy an operating adult family home, does the license come with it?", a: "No. The license belongs to the provider and the address together. A buyer applies through the DSHS Change of Ownership process and must be approved before operating. The seller's license ends at closing." },
      { q: "How can I check a listing's claim myself?", a: "Look the address up in the DSHS Adult Family Home Locator or AFH Club's licensed-home directory. If it is not there, it is not currently licensed. Then ask the listing broker for the signed building inspection checklist and the floor plan that went with it." },
      { q: "Why does AFH Club use five labels instead of the broker's description?", a: "Because the broker's description is marketing. Each listing is labelled by what the record supports: operating, licensed with no residents, formerly licensed, passed the building inspection but never licensed, or marketed as a potential AFH with nothing verified." },
    ],
  ...
  "/afh-club/afh-property-score": {
    ...
    quickAnswerA: "The hardest things to change matter most: enough main-level bedrooms of at least 80 square feet, living that works on one level, a step-free or rampable entry, enough main-level toilets (one for every five people living in the home, counting household members, and half baths count), and more than one way out at ground level. Each resident bedroom needs an escape window with a sill no higher than 44 inches and a clear opening at least 24 by 20 inches. Residents who need help evacuating must have an exit path with no stairs, so basement and upstairs bedrooms suit only residents who can get out on their own. Zoning is rarely the obstacle, because state law makes an adult family home a permitted residential use, and HOA rules that restrict adult family homes are unenforceable under RCW 64.38.060. Septic capacity, unpermitted additions, and fire access are the more common problems.",
  ...
  "/afh-club/afh-payment-field-guide": {
    ...
    h1: "Tiers, Levels, and Classifications: A Field Guide to How Washington AFHs Get Paid",
    quickAnswerQ: "Are Washington adult family homes classified as Tier 1 through Tier 5?",
    quickAnswerA: "No. Homes are not tiered. Four separate systems get called tiers or levels: DSHS CARE classifications (A Low through E High) that set each Medicaid resident's base daily rate; CBHS supportive supervision tiers (1 through 6) for residents with qualifying behavioral health needs; owner-held specialty contracts such as ECS and SBS; and private-pay care levels each home sets for itself.",
  ...
  "/afh-club/care-classifications-a-through-e": {
    ...
    description: "How DSHS's CARE assessment places Medicaid residents into seventeen classifications from A Low to E High, what each group means, current daily rates, why classification mix matters as much as occupancy, and what AFH buyers should verify in due diligence.",
    h1: "A Through E: How CARE Classifications Set an Adult Family Home's Medicaid Income",
    quickAnswerQ: "What are the A through E classifications for Washington adult family homes?",
    quickAnswerA: "They are the five groups in DSHS's CARE assessment, which places every Medicaid long-term care client into one of seventeen residential classifications from A Low to E High. Group E is exceptional care, D is clinical complexity with significant cognitive impairment, C is clinical complexity without it, B is qualifying mood and behavior needs, and A is everyone else. The classification and the county set the daily rate the home is paid.",
    intro: "When a Medicaid client moves into an adult family home, the home does not set the price. An assessment produces a classification, and the classification sets the daily rate, so one bed can be worth very different amounts.",
    faq: [
  ...
  "/afh-club/cbhs-tiers": {
    ...
    faq: [
      ...
      { q: "Can a resident's CBHS tier change?", a: "Yes. Eligibility is reviewed at least once every 12 months, a home can submit a re-tiering request, and if the resident moves out the payment leaves with them." },
    ],
    article: { datePublished: "2026-09-18", dateModified: "2026-09-18" },
  },
  ...
  "/articles/hospice-care-washington": {
  ...
  "/afh-club/for-sale/marysville-wa": {
    ...
    quickAnswerA: "Marysville has some of the strongest AFH listing activity in Snohomish County, and current listings are shown on this page. As one of the county's fastest-growing cities, Marysville has seen steady expansion in both its residential base and its AFH inventory.",
  ...
  "/afh-club/for-sale/auburn-wa": {
    ...
    quickAnswerA: "Auburn has consistently active AFH listing activity, and current listings are shown on this page. Sitting at the boundary of King and Pierce counties, Auburn draws AFH buyers and operators looking for a central South Sound location.",
  ...
  "/afh-club/for-sale/everett-wa": {
    ...
    quickAnswerA: "Everett's current AFH listings are shown on this page. As the largest city and county seat of Snohomish County, Everett anchors much of the region's senior care infrastructure, including Providence Regional Medical Center Everett.",
  ...
  "/afh-club/for-sale/bellevue-wa": {
    ...
    quickAnswerA: "Bellevue's current AFH listings are shown on this page. As one of the Eastside's most established cities, Bellevue has a mature, high-value AFH market shaped by some of the highest household incomes in the state.",
  ...
  "/afh-club/for-sale/lakewood-wa": {
    ...
    quickAnswerA: "Lakewood's current AFH listings are shown on this page. As one of Pierce County's larger cities, Lakewood offers a genuinely varied AFH market shaped by its mix of established neighborhoods and proximity to Joint Base Lewis-McChord.",
  ...
  "/afh-club/for-sale/bonney-lake-wa": {
    ...
    quickAnswerA: "Current Bonney Lake AFH listings are shown on this page. As one of Pierce County's fastest-growing communities on the plateau east of Tacoma, Bonney Lake has seen its AFH inventory grow alongside its broader residential expansion.",
...
const buildSsgContent = (meta: RouteMeta, route = "/") => {
  ...
  if (inventory) inventory.jsonLd.forEach((obj) => ssgParts.push(jsonLdTag(obj)));
  if (faq && faq.length) {
    ssgParts.push(
      jsonLdTag({
        "@context": "https://schema.org",
